...
本题需要区分教材直接表述与依据题型作出的选项推断。教材将FSRB界定为协助实施FATF标准的自治区域组织，并明确列出其促进区域合作、协助互评估以及向成员提供技术援助等职责（P145）。因此，B所述向本区域成员提供技术援助有直接教材依据。
...
题目要求选择三项。排除A、D、E后，剩余B、C、F。C并非教材逐字表述；它是对「促进区域合作」与「向本区域成员提供技术援助」两项相邻职能的概括，属于合理推断。F中的「互评估」有教材直接依据，教材还说明FSRB通过开展评估和提出建议评价AML/CFT措施（P145）；但当前引用单元没有逐字列出「后续流程」，因此F的证据强度主要来自互评估职能和上述排除链。综合直接依据与排除结果，应选择B、C、F。
...
应区分教材直接依据和选项推断：B及F的「互评估」部分属于直接依据；C是由区域合作与技术援助两项职能共同推出；F的「后续流程」未在当前教材单元中逐字出现。另一方面，A、E的辖区外对象和D的标准制定主体均可直接排除。不能把合理推断写成教材原文，也不能因选项部分措辞缺少逐字证据而忽略完整的排除链。
