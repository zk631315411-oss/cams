(function () {
  ...
  function load() {
    ...
    var PAGE    = "data/page_maps/";

    return Promise.all([
      getJson(DERIVED + "chapters/v6_full.json").catch(function () { return { sections: [] }; }),
      getJson(CARDS  + "cards_v6_sentence.json").catch(function () { return { cards: [] }; }),
      getJson(SOURCE  + "questions.json").catch(function () { return { questions: [] }; }),
      getJson(SOURCE  + "qa.json").catch(function () { return { records: [] }; }),
      getJson(DERIVED + "qa_bindings.json").catch(function () { return { bindings: [] }; }),
      getJson(DERIVED + "question_card_map.json").catch(function () { return { mappings: {} }; }),
      getJson(DERIVED + "kg_data.json").catch(function () { return {}; }),
      getJson(DERIVED + "exam_points.json").catch(function () { return { exam_points: [] }; }),
      getJson(DERIVED + "option_evidence_map.json").catch(function () { return { items: [] }; }),
      getJson(DERIVED + "sentence_exam_point_map.json").catch(function () { return { stats: {}, paragraphs: [], sentences: [] }; }),
      getJson(PAGE    + "card_page_map_v6.json").catch(function () { return { cards: {} }; })
    ]).then(function (items) {
      return buildState({
        chapter: items[0],
        cards: items[1],
        ...
        kgData: items[6],
        examPoints: items[7],
        optionEvidence: items[8],
        sentenceExamPointMap: items[9],
        cardPageMap: items[10]
      });
    });
  }
