...
题干列出的三类企业共同面临高交易量、跨司法管辖区和客户识别方面的金融犯罪风险。B对电商平台的描述最直接：教材说明电商平台连接全球买家和卖家，买家与店主审查不足会带来金融犯罪、欺诈和监管风险；跨境经营还会使CDD受到不同司法辖区法律和数据要求影响。这里“复杂且耗费资源”是基于这些事实的推理，不是某一单元的逐字表述。D也可由数字化/远程场景推导：MSB可通过在线平台和移动应用提供服务，电商依赖互联网；远程开户验证容易被假身份或盗用身份利用，而分层本身是通过复杂交易掩盖资金来源的阶段。因此B、D成立。A把MSB、支付服务商和电商平台一概称为“都是现金密集型”，超出了教材范围；C是把监管义务误当作自动合规；E则没有教材支持其结算系统普遍不足。
...
- **A 不选（范围过度泛化）**：教材将MSB等现金密集型或高风险行业作为行业风险示例，但没有说支付服务商和电商平台“都是”现金密集型；“都是”使该项超出证据范围。
- **C 不选（概念混淆）**：受到监管只说明存在合规义务，不等于企业自动合规；选项把“有制裁风险”错误地当成“没有不合规风险”。
- **E 不选（证据不足）**：教材只说明MSB和支付服务商处理大量小额交易，需要更自动化的监控方法；没有据此规定其结算系统普遍“不够完善、无法应对高交易量”。

## 【易错提醒】

现金密集型不等于三类企业都以现金运营；本题的B、D分别依赖电商跨境KYC和数字化身份验证风险。
