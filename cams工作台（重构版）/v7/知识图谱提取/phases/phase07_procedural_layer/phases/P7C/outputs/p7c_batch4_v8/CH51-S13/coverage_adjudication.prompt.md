...
section_title: `Understanding AFC technology > Impact of privacy regulations on technology use`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "关键隐私法规：GDPR 和 GLBA",
      "title_en": "Key Privacy Regulations: GDPR and GLBA",
      "covered_units": [
        {
          "unit_id": "v7u_N003924",
          "unit_type": "fact",
    ...
    {
      "title_zh": "数据处理合规要求",
      "title_en": "Compliance Requirements for Data Handling",
      "covered_units": [
        {
          "unit_id": "v7u_N003929",
          "unit_type": "rule",
    ...
    {
      "title_zh": "隐私增强技术（PET）",
      "title_en": "Privacy-Enhancing Technologies (PET)",
      "covered_units": [
        {
          "unit_id": "v7u_N003933",
  ...
  "covered_relations": [
    {
      "source_title": "关键隐私法规：GDPR 和 GLBA",
      "target_title": "数据处理合规要求",
      "relation_type": "prepares"
    },
    {
      "source_title": "数据处理合规要求",
      "target_title": "隐私增强技术（PET）",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003924|3924] Consumer privacy regulations such as the GDPR and the Gramm-Leach-Bliley Act directly prescribe how AFC technologies collect, process, and share personally identifiable information.
ZH: 《通用数据保护条例》 和 GLBA 等隐私法规直接规定 金融犯罪防控 技术如何收集、处理与共享个人身份信息。

[v7u_N003925|3925] GDPR imposes strict rules on handling the personal data of EU citizens, emphasizing principles such as data minimization, purpose limitation, storage limitation, and the right to erasure.
ZH: 《通用数据保护条例》 对处理欧盟公民个人数据施加严格规则，强调数据最小化、目的限制等原则。

[v7u_N003926|3926] Similarly, the Gramm-Leach-Bliley Act mandates that financial institutions safeguard consumer financial information and disclose how they share such data.
ZH: GLBA 要求金融机构保护消费者金融信息并披露数据共享方式。

[v7u_N003927|3927] For AFC professionals, these regulations involve balancing effective financial crime detection with legal obligations for data privacy.
ZH: 金融犯罪防控 专业人员需在有效金融犯罪检测与数据隐私法律义务之间取得平衡。

[v7u_N003928|3928] Technologies for KYC, transaction monitoring, sanctions screening, and adverse media analysis process large volumes of sensitive data.
ZH: 了解你的客户、交易监控、制裁筛查和负面媒体分析等技术处理大量敏感数据。

[v7u_N003929|3929] Under GDPR and the Gramm-Leach-Bliley Act, data controllers, such as financial institutions, must ensure that data storage—whether in the cloud or internal databases—is secure, transparent, and compliant.
ZH: 根据 《通用数据保护条例》 和 GLBA，金融机构作为数据控制者必须确保数据存储安全、透明且合规。

[v7u_N003930|3930] Moreover, data sharing with other banks, government agencies, or law enforcement introduces complexity, as jurisdictions tightly regulate crossborder transfers of personal data.
ZH: 与其他银行、政府机构或执法部门的数据共享因跨境传输监管而变得复杂。

[v7u_N003931|3931] Organizations participating in collaborative initiatives such as real-time intelligence-sharing platforms must implement controls to prevent unauthorized access or misuse of shared data.
ZH: 参与实时情报共享平台等合作倡议的组织必须实施控制以防止未经授权的访问或滥用。

[v7u_N003932|3932] Additionally, third-party vendors providing AFC technology must comply with privacy laws, requiring thorough due diligence, contractual safeguards, and clear service-level agreements to manage data processing responsibilities.
ZH: 提供 金融犯罪防控 技术的第三方供应商必须遵守隐私法律，需进行尽职调查并签订合同保障。

[v7u_N003933|3933] To address these challenges, banks can adopt privacy-enhancing technologies (PET), such as federated learning, secure multiparty computation, or data anonymization.
ZH: 隐私增强技术（PET）包括联邦学习、安全多方计算和数据匿名化等。

[v7u_N003934|3934] These technologies enable secure data analysis and information sharing while preserving privacy and regulatory compliance, ensuring that AFC efforts remain effective without compromising personal data protection.
ZH: PET 能在保护隐私和合规的同时实现安全的数据分析与共享，确保 金融犯罪防控 有效性。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "金融机构必须基于GDPR和GLBA确保数据存储安全、透明且合规。",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S13_001",
      "reason": "基础KG仅存规则，未表达金融机构执行确保存储合规动作与标准参照的有向关系。"
    },
    {
      ...
      "proposition": "参与实时情报共享平台的组织必须实施控制以防止未授权访问或滥用。",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S13_002",
      "reason": "基础KG保存了措施要求，但未表达参与平台作为条件触发实施控制的有向关系。"
    },
    {
      ...
      "proposition": "提供AFC技术的第三方供应商必须遵守隐私法律并进行尽职调查、签订合同保障。",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S13_003",
      "reason": "基础KG保存了规则，但未表达供应商身份限定与具体尽责动作的局部链。"
    },
    {
      ...
      "proposition": "面对隐私合规挑战，银行可采用PET以实现安全分析与合规。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已通过covered_relations表达了数据处理合规要求至PET的预备关系，且本候选为概括性建议，无明确条件导向与步骤分解。"
    }
  ],
  "cards": [
    {
      ...
      "title": "金融机构必须确保数据存储安全、透明且合规",
      "flow_nodes": [
        {
          "node_id": "p1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构必须确保数据存储安全、透明且合规",
          "evidence_unit_ids": [
            "v7u_N003929"
          ],
      ...
      "flow_edges": [
        {
          ...
          "source_quote": "Under GDPR and the Gramm-Leach-Bliley Act, data controllers... must ensure that data storage... is secure, transparent, and compliant."
        }
      ],
      "source_unit_ids": [
        "v7u_N003929"
      ...
      "review_notes": "增量命题：金融机构确保数据存储合规 --REFERENCES--> GDP/GLBA标准；KG不足：基础KG只能保存规则本身，而无法表达确保动作与法规标准之间的必要参照关系；选项判断：可用于确认数据存储的具体合规义务来源；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S13_002",
      "section_id": "CH51-S13",
      "card_nature": "control",
      "title": "参与实时情报共享平台的组织必须实施控制",
      "flow_nodes": [
        {
          "node_id": "e1",
          "node_category": "entry",
      ...
      "flow_edges": [
        {
          ...
          "source": "e1",
          "target": "p2",
          "condition": "当组织参与此类平台时",
          "evidence_unit_ids": [
            "v7u_N003931"
          ],
          "derivation": "explicit_text",
          "source_quote": "Organizations participating in collaborative initiatives such as real-time intelligence-sharing platforms must implement controls to prevent unauthorized access or misuse of shared data."
        }
      ],
      "source_unit_ids": [
        "v7u_N003931"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：组织参与平台 --PRECEDES--> 实施控制（条件：参与）；KG不足：基础KG仅保存了措施义务，未表达参与平台作为触发条件与实施控制的先后关系；选项判断：可用于判断参与情报共享所需的条件性控制义务；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S13_003",
      "section_id": "CH51-S13",
      "card_nature": "execution",
      "title": "提供AFC技术的第三方供应商必须遵守隐私法律并进行尽职调查",
      "flow_nodes": [
        {
          "node_id": "p3",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "提供AFC技术的第三方供应商必须进行尽职调查、签订合同保障并遵守隐私法律",
          "evidence_unit_ids": [
            "v7u_N003932"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "relation_type": "standard_constrains_action",
          "source_quote": "Third-party vendors providing AFC technology must comply with privacy laws, requiring thorough due diligence, contractual safeguards, and clear service-level agreements..."
        }
      ],
      "source_unit_ids": [
        "v7u_N003932"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：第三方供应商尽职调查 --REFERENCES--> 隐私法律标准；KG不足：基础KG仅存规则，未表达供应商身份限定与具体尽责动作的局部有向关系；选项判断：可用于确认第三方供应商的合规要求；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
