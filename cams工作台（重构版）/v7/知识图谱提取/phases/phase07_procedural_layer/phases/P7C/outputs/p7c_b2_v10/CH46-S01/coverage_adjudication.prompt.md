...
section_title: `Transaction Monitoring and Investigation > Introduction: Transaction monitoring and investigation`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "交易监控系统简介",
      "title_en": "Introduction to Transaction Monitoring Systems",
      "covered_units": [
        {
          "unit_id": "v7u_N003219",
...
```text
[v7u_N003219|3219] Transaction monitoring (TM) systems are the technological frameworks that help financial institutions detect suspicious transaction patterns.
ZH: 交易监控系统是帮助金融机构检测可疑交易模式的技术框架

[v7u_N003220|3220] In this module, we will explore industry best practices and expectations for TM systems. You will gain skills to evaluate transaction monitoring alerts and understand the various types of investigations that might follow. This module will also cover best practices in data analysis and documentation, equipping you to conduct thorough AML investigations, and understand system tuning.
ZH: 本模块介绍交易监控系统的最佳实践、警报评估、调查类型及系统调优
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "交易监控系统是帮助金融机构检测可疑交易模式的技术框架",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯定义和一般帮助关系，无具体程序性或判断性有向结构。"
    },
    {
      ...
      "proposition": "本模块将涵盖交易监控最佳实践、警报评估、调查类型、数据分析及系统调优",
      "decision": "kg_only",
      "card_id": null,
      "reason": "学习目标概述，无具体程序性或判断性有向结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达定义和模块概述，当前section不存在证据支持的增量程序性或判断性有向结构。"
}
```
