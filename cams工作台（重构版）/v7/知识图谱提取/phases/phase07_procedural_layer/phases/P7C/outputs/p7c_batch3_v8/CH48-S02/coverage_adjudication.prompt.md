...
section_title: `Concluding Investigations and Coordinating with Law Enforcement > Case study: Failure to file report`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "德意志银行因延迟提交可疑交易报告被罚款及其影响",
      "title_en": "Deutsche Bank fined for delayed STR filing and its implications",
      "covered_units": [
        {
          "unit_id": "v7u_N003452",
          "unit_type": "case",
    ...
    {
      "title_zh": "FATF建议20的可疑交易报告要求及相关指引",
      "title_en": "FATF Recommendation 20 STR reporting requirements and related guidance",
      "covered_units": [
        {
          "unit_id": "v7u_N003459",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "德意志银行因延迟提交可疑交易报告被罚款及其影响",
      "target_title": "FATF建议20的可疑交易报告要求及相关指引",
...
```text
[v7u_N003452|3452] In March 2023, the Federal Financial Supervisory Authority of Germany (BaFin), fined Deutsche Bank AG €170,000 for failing to submit suspicious transaction reports (STR) on time. The administrative order was final and binding.
ZH: 德国联邦金融监管局因德意志银行未及时提交可疑交易报告对其处以17万欧元罚款。

[v7u_N003453|3453] Banks are required to investigate and promptly report suspicious transactions linked to money laundering or terrorist financing to the FIU.
ZH: 银行有义务调查并及时向金融情报机构报告与洗钱或恐怖融资相关的可疑交易。

[v7u_N003454|3454] BaFin discovered that Deutsche Bank delayed filing STRs, which hindered law enforcement's ability to detect and prevent crime, prolonging illicit operations.
ZH: 德国联邦金融监管局发现德意志银行延迟提交可疑交易报告，阻碍了执法部门检测和预防犯罪。

[v7u_N003455|3455] The regulator emphasized that the timely submission of STRs allows authorities to act quickly and forward information to law enforcement agencies.
ZH: 及时提交可疑交易报告使当局能够迅速行动并向执法机构传递信息。

[v7u_N003456|3456] BaFin also stated that the bank's failure to submit STRs promptly has serious implications for the integrity of the financial sector and the broader efforts to combat illicit financial activities. This delay gave criminals the advantage of time and allowed illicit funds to flow through the financial system undetected, ultimately enabling more of the illicit profits to be laundered.
ZH: 延迟提交可疑交易报告损害金融部门诚信，使犯罪分子得以利用时间差清洗非法资金。

[v7u_N003457|3457] BaFin’s enforcement action against Deutsche Bank highlights the real-world consequences of noncompliance.
ZH: 德国联邦金融监管局对德意志银行的执法行动凸显了不合规的实际后果。

[v7u_N003458|3458] Timely reporting is a matter of compliance and is critical for preventing financial crime at its source.
ZH: 及时报告既是合规要求，也是从源头预防金融犯罪的关键。

[v7u_N003459|3459] Under FATF Recommendation 20, financial institutions (FI) must investigate and report any suspicious transactions when there are reasonable grounds to suspect the funds are proceeds of criminal activity or linked to terrorist financing.
ZH: 金融行动特别工作组建议20要求金融机构在有合理理由怀疑资金来自犯罪活动或与恐怖融资有关时进行调查和报告。

[v7u_N003460|3460] This reporting is done in good faith and does not equate to criminal liability.
ZH: 善意报告不构成刑事责任。

[v7u_N003461|3461] FATF’s Interpretive Note to Recommendation 20 specifies that all suspicious transactions, including attempted transactions, should be reported regardless of the transaction amount.
ZH: FATF建议20解释性说明要求报告所有可疑交易，包括未遂交易，无论金额大小。

[v7u_N003462|3462] The Wolfsberg Group’s highlights the need for closer collaboration between government agencies and financial institutions in the STR filing process. As financial crime typologies evolve, emerging technologies and new transaction methods create additional challenges, making strong cooperation more important than ever.
ZH: 沃尔夫斯堡集团强调在可疑交易报告流程中政府机构与金融机构需加强合作。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "金融机构在有合理理由怀疑资金为犯罪活动收益或与恐怖融资有关时，必须调查并报告所有可疑交易，包括未遂交易，无论金额大小。",
      "decision": "p7c_card",
      "card_id": "p7card_CH48-S02_001",
      "reason": "该规则内部的条件→动作有向结构（合理怀疑触发调查和报告义务）及报告范围约束（所有可疑交易包括未遂不论金额）超出基础KG仅能保存整体规则事实的能力，可帮助确认报告触发条件和范围相关的判断选项。"
    },
    {
      ...
      "proposition": "银行有义务调查并及时向FIU报告与洗钱或恐怖融资相关的可疑交易。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立义务陈述，不包含条件或分支等额外有向结构，且与FATF建议20规则高度重复，基础KG可充分表达。"
    },
    {
      ...
      "proposition": "德意志银行因延迟提交STR被BaFin处以17万欧元罚款，延迟提交阻碍执法并损害金融诚信。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该案例及其因果后果已作为整体被基础KG覆盖，延迟与罚款、后果之间的因果关系无额外主体应对或判断路径增量。"
    },
    {
      ...
      "proposition": "及时提交STR使当局能够迅速行动并向执法机构传递信息。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般因果说明，无具体程序性步骤或判断结构。"
    },
    {
      ...
      "proposition": "及时报告既是合规要求，也是从源头预防金融犯罪的关键。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "概括性陈述，无有向程序结构。"
    },
    {
      ...
      "proposition": "善意报告不构成刑事责任。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "保护性条款，无程序性有向关系。"
    },
    {
      ...
      "proposition": "沃尔夫斯堡集团强调在STR申报过程中政府机构与金融机构需加强合作。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般建议，无触发、条件或步骤等有向结构。"
    }
  ],
  "cards": [
    {
      ...
      "title": "FATF建议20下的可疑交易报告义务",
      "flow_nodes": [
        {
          "node_id": "node_001",
          "node_category": "entry",
          "node_type": "E8_decision_finding",
          "label": "金融机构有合理理由怀疑资金为犯罪活动收益或与恐怖融资有关",
          "evidence_unit_ids": [
            "v7u_N003459"
          ],
        ...
        },
        {
          ...
          "node_type": "standard",
          "label": "所有可疑交易（包括未遂交易，无论金额大小）均需报告",
          "evidence_unit_ids": [
            "v7u_N003461"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "condition": "when there are reasonable grounds to suspect the funds are proceeds of criminal activity or linked to terrorist financing"
        },
        {
          "edge_id": "edge_002",
      ...
      "review_notes": "增量命题：有合理理由怀疑（条件）→ 金融机构必须调查并报告可疑交易，并受限于报告所有可疑交易包括未遂不论金额的标准。基础KG不足：基础KG可保存“FATF建议20要求金融机构在有合理理由时报告”这一整体事实，但无法表达条件触发动作的内部有向链以及报告范围对动作的约束关系。该局部结构可帮助判断在何种条件下需报告、是否包括未遂交易、是否有金额门槛等选项。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
