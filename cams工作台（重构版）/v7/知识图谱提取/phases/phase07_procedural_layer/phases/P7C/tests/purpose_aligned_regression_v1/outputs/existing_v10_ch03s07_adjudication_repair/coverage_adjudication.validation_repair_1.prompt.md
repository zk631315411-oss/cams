...
edge_count: 0
bridge_count: 0
evidence_scope: D:/守正公司工作区/cams考试/cams工作台（重构版）/v7/知识图谱提取/phases/phase07_procedural_layer/phases/P7B/section_packages/CH03-S07/task.json
expected_section_id: CH03-S07
error_count: 2

## Errors

- p7card_CH03-S07_002: invalid review_status 'approved'
- p7card_CH03-S07_003: invalid review_status 'approved'
...
```json
{
  ...
  "coverage_adjudication": [
    {
      ...
      "reason": "基础KG只能存储检测事实，无法表达金融机构交易监控系统基于结构化存款、快速分层等异常指标产生非法活动识别结论的有向结构，该结构可帮助判断检测触发条件和顺序。"
    },
    {
      "candidate_id": "cand_002",
      "original_decision": "kg_only",
      "final_decision": "kg_only",
      "reason": "仅描述区块链分析公司提供情报的孤立行为，无明确触发入口和程序性有向结构，保持kg_only。"
    },
    {
      "candidate_id": "cand_003",
      "original_decision": "kg_only",
      "final_decision": "p7c_card",
      "reason": "基础KG不能表达FIU将银行SAR与跨境活动作为输入，进行分析并产出红旗信号的主体方向与条件结果关系，该方向结构可辅助判断FIU的分析步骤和输出。"
    },
    {
      "candidate_id": "cand_005",
      "original_decision": "kg_only",
      "final_decision": "kg_only",
      "reason": "仅描述案件司法结果，无增量有向结构，基础KG可存储。"
    },
    {
      "candidate_id": "cand_006",
      "original_decision": "kg_only",
      "final_decision": "kg_only",
      "reason": "总结性评价，无具体程序性步骤和方向结构，基础KG可表达。"
    },
    {
      "candidate_id": "cand_007",
      "original_decision": "kg_only",
      "final_decision": "kg_only",
      "reason": "描述犯罪分子的资金处理方法，无机构主体的识别、判断或应对有向结构，基础KG可存储。"
    }
  ],
  "coverage_audit": [
    {
  ...
  "cards": [
    ...
    },
    {
      ...
      "title": "金融机构交易监控系统检测非法活动",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "entry",
          "node_type": "E6_change_exception",
          "label": "出现异常交易活动（结构化存款、快速分层、与已知恐怖钱包关联的资金流动）",
          "evidence_unit_ids": [
            "v7u_N000283"
          ],
          "evidence_strength": "explicit"
      ...
      "review_notes": "增量命题：异常交易活动触发金融机构交易监控系统标记并检测，从而识别非法活动。基础KG无法表达主体、方向与结果关系。"
    },
    {
      "card_id": "p7card_CH03-S07_003",
      "section_id": "CH03-S07",
      "card_nature": "risk_indicator",
      "title": "FIU综合分析SAR与跨境活动触发红旗",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "entry",
          "node_type": "E2_object_entry",
          "label": "银行可疑交易报告（SAR）与跨境金融活动信息",
          "evidence_unit_ids": [
            "v7u_N000285"
          ],
          "evidence_strength": "explicit"
      ...
      "review_status": "approved",
      "review_notes": "增量命题：FIU将银行SAR和跨境活动作为输入进行分析，产出红旗信号。基础KG不能表达主体方向与条件结果关系。"
    }
  ],
  "skip_reason": null
}
