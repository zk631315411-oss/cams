...
section_title: `Understanding AFC technology > Governance of compliance technology`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "反金融犯罪技术强有力治理的定义与范围",
      "title_en": "Definition and scope of strong governance for AFC technology",
      "covered_units": [
        {
          "unit_id": "v7u_N003873",
    ...
    {
      "title_zh": "反金融犯罪中的人工智能治理要求",
      "title_en": "AI governance requirements in AFC",
      "covered_units": [
        {
          "unit_id": "v7u_N003875",
          "unit_type": "rule",
    ...
    {
      "title_zh": "治理委员会与利益相关方参与",
      "title_en": "Governance committees and stakeholder engagement",
      "covered_units": [
        {
          "unit_id": "v7u_N003876",
          "unit_type": "fact",
    ...
    {
      "title_zh": "反金融犯罪技术评估与监控流程",
      "title_en": "AFC technology evaluation and monitoring processes",
      "covered_units": [
        {
          "unit_id": "v7u_N003881",
    ...
    {
      "title_zh": "治理中的决策质量与文件记录",
      "title_en": "Decision-making quality and documentation in governance",
      "covered_units": [
        {
          "unit_id": "v7u_N003884",
          "unit_type": "rule",
    ...
    {
      "title_zh": "治理委员会的弊端与缓解措施",
      "title_en": "Drawbacks of governance committees and mitigation",
      "covered_units": [
        {
          "unit_id": "v7u_N003889",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "反金融犯罪技术强有力治理的定义与范围",
      "target_title": "反金融犯罪中的人工智能治理要求",
      "relation_type": "contains"
    },
    {
      "source_title": "反金融犯罪技术强有力治理的定义与范围",
      "target_title": "治理委员会与利益相关方参与",
      "relation_type": "contains"
    },
    {
      "source_title": "反金融犯罪技术强有力治理的定义与范围",
      "target_title": "反金融犯罪技术评估与监控流程",
      "relation_type": "contains"
    },
    {
      "source_title": "反金融犯罪技术强有力治理的定义与范围",
      "target_title": "治理中的决策质量与文件记录",
      "relation_type": "contains"
    },
    {
      "source_title": "反金融犯罪技术强有力治理的定义与范围",
      "target_title": "治理委员会的弊端与缓解措施",
      "relation_type": "contains"
    },
    {
      "source_title": "治理委员会与利益相关方参与",
      "target_title": "反金融犯罪技术评估与监控流程",
    ...
    {
      "source_title": "反金融犯罪技术评估与监控流程",
      "target_title": "治理中的决策质量与文件记录",
      "relation_type": "prepares"
    },
    {
      "source_title": "治理中的决策质量与文件记录",
      "target_title": "治理委员会的弊端与缓解措施",
...
```text
[v7u_N003873|3873] Strong governance involves effective decision-making processes with clear accountabilities and priorities.
ZH: 强有力的治理涉及有效的决策流程，具有明确的问责制和优先级。

[v7u_N003874|3874] AFC technology governance processes apply whether selecting, developing, and implementing new solutions or overseeing an existing system.
ZH: 金融犯罪防控技术治理流程适用于选择、开发、实施新系统或监督现有系统。

[v7u_N003875|3875] The use of AI introduces additional governance requirements to ensure ethical use of AI, mitigation of bias, adherence to applicable AI regulations, and adequate documentation.
ZH: AI的使用引入了额外的治理要求，以确保道德使用、减轻偏见、遵守AI法规和充分记录。

[v7u_N003876|3876] Engaging key stakeholders is critical.
ZH: 关键利益相关方的参与至关重要。

[v7u_N003877|3877] Business sponsors, senior leadership, compliance officers, IT teams, risk management professionals, and legal advisors should all evaluate suitable technologies for deployment and operation.
ZH: 业务赞助方、高级领导、合规官、IT团队、风险管理专家和法律顾问应评估合适的技术。

[v7u_N003878|3878] Business sponsors or senior risk and compliance leaders often chair these committees.
ZH: 业务赞助方或高级风险与合规负责人通常担任这些委员会的主席。

[v7u_N003879|3879] Cross-functional participation and clear accountabilities enable transparent communication and collaboration across departments, helping align technology adoption with risk appetite and strategic goals.
ZH: 跨职能参与和明确问责制有助于透明沟通和跨部门协作，使技术采用与风险偏好和战略目标保持一致。

[v7u_N003880|3880] Governance committees proactively support effective risk management through review and decision-making.
ZH: 治理委员会通过审查和决策主动支持有效的风险管理。

[v7u_N003881|3881] Key evaluation processes include data and technology security, system integration, system effectiveness, regulatory implications, and operational risks.
ZH: 技术治理的关键评估流程包括数据与安全、系统集成、有效性、监管影响和运营风险。

[v7u_N003882|3882] Reporting from these assessments balances potential benefits against associated risks to ensure informed decision-making.
ZH: 评估报告需平衡潜在收益与相关风险，以支持知情决策。

[v7u_N003883|3883] Ongoing reporting includes key risk indicators to identify potential vulnerabilities and key performance indicators to measure efficiency and effectiveness in detecting and preventing financial crime.
ZH: 持续报告包含关键风险指标（KRI）和关键绩效指标（KPI），用于衡量金融犯罪防控效率与效果。

[v7u_N003884|3884] Committees must assess this information and decide on the right course of action for the organization.
ZH: 委员会必须评估信息并决定组织的正确行动方案。

[v7u_N003885|3885] Balanced participation and diverse perspectives enhance committee effectiveness.
ZH: 均衡参与和多元视角可提升委员会决策有效性。

[v7u_N003886|3886] Poor decisions can arise from unclear or incorrect information, potentially leading to actions that contradict strategic interests.
ZH: 信息不清晰或不正确可能导致错误决策，违背战略利益。

[v7u_N003887|3887] Implementing strong check-and-challenge processes helps mitigate this risk.
ZH: 实施强有力的质疑与挑战流程有助于缓解决策风险。

[v7u_N003888|3888] Organizations should document key decisions, including rationale, risk assessments, stakeholder input, and compliance considerations. By documenting accountability and the decision-making process, organizations are better prepared for scrutiny from internal audits and regulators.
ZH: 组织应记录关键决策及其理由、风险评估、利益相关方意见和合规考量，以备审计和监管审查。

[v7u_N003889|3889] Governance committees can have drawbacks. Bureaucratic processes may slow down decision-making, potentially delaying the adoption of innovative solutions. Excessive oversight can lead to risk aversion, stifling technological advancements.
ZH: 治理委员会可能存在官僚流程导致决策缓慢、过度规避风险等弊端。

[v7u_N003890|3890] To mitigate these challenges, organizations should include a regular, independent review of governance processes and outcomes.
ZH: 应定期独立审查治理流程和结果以缓解挑战。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "持续报告信息（KRI/KPI）→ 委员会必须评估信息并决定正确行动方案",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S09_001",
      "reason": "明确了‘持续报告’作为输入，委员会作为主体，以及带情态‘必须’的评估与决策动作，形成了有向参照链，超出基础KG可表达的孤立事实。"
    },
    {
      ...
      "proposition": "组织记录关键决策 → 组织更好地准备应对内部审计和监管审查",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S09_002",
      "reason": "原文明示记录动作产生‘更好地准备’的独立状态变化，构成过程-结果有向关系，基础KG无法表达该产出方向。"
    },
    {
      ...
      "proposition": "AI使用 → 引入治理要求，以确保道德使用、减轻偏见等",
      "decision": "kg_only",
      "card_id": null,
      "reason": "虽有‘确保’等动词，但仅为抽象目标列举，未形成具体主体动作、输入或独立产出的有向链，基础KG可保存为规则。"
    },
    {
      ...
      "proposition": "业务赞助方等利益相关方 → 应评估合适的技术",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立义务陈述，无原文明示的输入、标准或结果，无法构成有向边。"
    },
    {
      ...
      "proposition": "跨职能参与和明确问责制 → 有助于透明沟通和协作，使技术采用对齐",
      "decision": "kg_only",
      "card_id": null,
      "reason": "抽象效果与目标表述，无具体程序性节点与边，基础KG可覆盖因果关系。"
    },
    {
      ...
      "proposition": "评估报告 → 平衡收益风险 → 支持知情决策",
      "decision": "kg_only",
      "card_id": null,
      "reason": "主体不明，‘支持知情决策’为一般目的而非独立结果，无有向结构。"
    },
    {
      ...
      "proposition": "实施质疑与挑战流程 → 有助于缓解决策风险",
      "decision": "kg_only",
      "card_id": null,
      "reason": "‘有助于缓解’为效果描述，未形成明确结果节点，基础KG可处理。"
    },
    {
      ...
      "proposition": "组织 → 应定期独立审查治理流程和结果，以缓解挑战",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤独义务动作，缓解挑战为目的而非独立结果，无法形成有向边。"
    }
  ],
  "cards": [
    {
      ...
      "title": "治理委员会基于持续报告评估信息并决定行动方案",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "auxiliary",
          "node_type": "input",
          "label": "持续报告（包含关键风险指标和关键绩效指标）",
          "evidence_unit_ids": [
            "v7u_N003883"
          ],
      ...
      "review_notes": "增量命题：持续报告（n1）→ 委员会必须评估信息并决定正确行动方案（n2）；KG不足：基础KG能分别表达报告内容与委员会义务，但无法表达报告作为输入与委员会评估动作之间的定向参照关系及‘必须’情态；选项判断：可确认委员会决策必须基于信息输入，排除不参考信息的选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S09_002",
      "section_id": "CH51-S09",
      "card_nature": "control",
      "title": "记录关键决策以更好地应对审查",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "组织应当记录关键决策（包括理由、风险评估、利益相关方意见和合规考量）",
          "evidence_unit_ids": [
            "v7u_N003888"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：记录关键决策（n1）→ 组织更好地准备应对审查（n2）；KG不足：基础KG可分开表达‘应记录’和‘记录有助于应对审查’，但无法表达记录动作直接产出‘更好地准备’状态的因果有向关系；选项判断：可确认记录决策的具体目的是提升对审查的准备度，排除无关选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
