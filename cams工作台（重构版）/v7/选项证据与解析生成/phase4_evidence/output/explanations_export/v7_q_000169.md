...
考点：识别风险评估作为AFC合规框架动态调整的触发要素

核心解析：风险评估是AFC合规计划的基石，指识别、分析并理解组织面临的金融犯罪威胁与漏洞的过程（P265）。教材明确指出，「组织在业务发生重大变化时必须重新评估风险」，这些变化明确包括进入新市场或司法管辖区变更（P283）。持续评估有助于组织「应对新兴的地理风险」（P283）。题干中，企业向多个国际市场扩张，尤其涉及高风险司法管辖区，MLRO审查现有AFC框架时发现反洗钱制度漏洞，并针对这些风险更新框架以降低威胁——这个「审查环境变化→识别漏洞→评估风险→更新框架」的连续动作，最直接吻合风险评估的动态流程。扩张本身只是业务变化，而识别和判断新市场带来的洗钱风险缺口，正是风险评估的核心职能。
...
A项错误：治理安排在教材P449被定位为监督交易监控规则的选择、实施和更新的委员会机制，属于评估完成后对具体控制措施的运行管理，而非评估活动本身。题干描述的是MLRO识别漏洞并更新框架的过程，这与负责持续监督具体工具的治理委员会角色不同。场景更契合「评估与调整」而非「治理监督」。
B项错误：交易监控指在开户后对客户交易进行持续观察，以检测异常或可疑活动（P329）。题干中MLRO的动作是审查和更新AFC框架本身，属于上游的风险管理设计，而非日常运营中检测单笔交易的监控活动。如果题干问的是「发现可疑交易后该做什么」，监控才更直接对应。
C项错误：培训与意识指开展员工反洗钱/反恐怖融资培训，确保其理解法规责任（P255）。题干场景完全围绕管理层对合规框架的战略性审查和更新，未涉及员工学习或能力建设。培训可能作为后续应对措施的一部分，但题干描述的流程本身更直接匹配风险识别与评估。

易错提醒：风险评估 vs 交易监控：风险评估发生在战略规划层，决定「哪里可能有风险，需要做什么」，是框架设计的前提；交易监控发生在业务运营层，回答「当下这笔交易是否可疑」，是框架运行的结果。题干提到向高风险市场扩张时审查框架，这属于「决定做什么」的上游评估活动，而非「检验每笔交易」的下游监控行为。
