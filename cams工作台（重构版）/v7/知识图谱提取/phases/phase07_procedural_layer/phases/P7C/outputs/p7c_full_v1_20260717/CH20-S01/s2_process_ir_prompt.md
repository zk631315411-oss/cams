...
[
  {
    "candidate_id": "s1c_gap_ch20_s01_unsc_sanctions_authority",
    "unit_ids": [
      "v7u_N001478"
    ],
    "proposition": "作为联合国风险管理倡议的一部分，联合国宪章授权安理会实施各种制裁。",
    "source_quotes": [
      "As part of its risk management initiative, the UN Charter gives the UN Security Council the authority to impose various sanctions."
    ],
    "relation_cues": [
      "As part of"
    ],
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "联合国宪章授权联合国安理会实施制裁",
      "outcomes_or_paths": [
        "安理会有权施加各种制裁"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001478",
        "quote": "As part of its risk management initiative, the UN Charter gives the UN Security Council the authority to impose various sanctions."
      }
    ],
    "induction": null,
    ...
    "gap_evidence": {
      ...
      "gap_reason": "S1.1未输出任何候选，而原文中确存在以风险管理倡议为条件、以授权安理会实施制裁为中心的独立处理链，因此构成空缺。"
    }
  }
]
```
