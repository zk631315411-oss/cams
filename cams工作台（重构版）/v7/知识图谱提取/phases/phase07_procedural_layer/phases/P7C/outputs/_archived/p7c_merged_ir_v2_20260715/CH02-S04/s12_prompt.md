...
[
  {
    ...
    "proposition": "FullTechGlobal的海外贿赂指控引发英国反贿赂法域外适用关切；该法适用于任何有英国关联的公司，母公司需为子公司腐败行为负责。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "FullTechGlobal面临海外贿赂指控，且为英国母公司子公司"
      ],
      "basis_or_condition": [
        "公司有英国关联"
      ],
      "focal_handling_or_judgment": "引发英国反贿赂法域外条款的适用",
      "outcomes_or_paths": [
        "母公司可能被起诉，需要加强合规措施"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "Sophie的初步调查发现FullTechGlobal雇佣高风险中间人、通过虚增费用和壳公司掩盖非法资金流动、并向公职人员提供诱导。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "Sophie发现FullTechGlobal的负面新闻"
      ],
      "basis_or_condition": [
        "初步调查"
      ],
      "focal_handling_or_judgment": "调查揭示多种可疑行为",
      "outcomes_or_paths": [
        "雇佣中间人",
        "掩盖资金流动",
        "提供诱导"
  ...
  },
  {
    ...
    "proposition": "Sophie的后续审查和审计发现FullTechGlobal的ABC框架和内部控制存在缺陷，导致腐败活动长期未被发现。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "发现ABC框架和内控缺陷",
      "outcomes_or_paths": [
        "内控机制不足，监督不力，导致腐败长期未被发现"
      ]
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "proposition": "贿赂被确定为上游犯罪，导致通过复杂金融网络清洗非法资金。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "导致洗钱",
      "outcomes_or_paths": [
        "通过复杂金融网络清洗资金以规避监管"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "根据发现，FullTechGlobal面临严厉的财务处罚、国际监管审查以及子公司和母公司（包括高管）的潜在刑事责任。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "面临监管后果",
      "outcomes_or_paths": [
        "财务处罚",
        "国际监管审查",
        "刑事责任"
  ...
  },
  {
    ...
    "proposition": "作为金融犯罪防控经理，Sophie认识到机构需要维护合规诚信并降低贿赂腐败风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "认识到机构维护合规和降低风险的必要性",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
