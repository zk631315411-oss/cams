...
FATF通过其他司法管辖区的反洗钱/反恐怖融资主管机关开展正式审查，定期对成员司法管辖区实施相互评估（P146）。相互评估报告同时考察对FATF建议的技术合规性和一国整体反洗钱体系的有效性（P150）；在这一评估程序中，FATF使用11项直接目标对有效性进行衡量和评级（P150）。因此，「相互评估」是FATF评估国家反洗钱/反恐怖融资成效的程序，11项直接目标则是程序内部的具体有效性衡量框架。题目给出的选项中，只有D准确说出了这一评估程序。
...
- **A 错误（教材定义应用）｜概念混淆**：教材明确列出的FATF国家评估机制是相互评估，没有把「FATF评估委员会」作为成效衡量方式。A与教材所述机制名称不符。
- **B 错误（教材定义应用）｜主体错配**：B描述由受评国家自行开展内部审计后向FATF报告；教材描述的相互评估则是由其他司法管辖区的反洗钱/反恐怖融资主管机关实施正式同行审查（P146）。两者的评估主体和程序均不同。
- **C 错误（教材定义应用）｜主体错配**：巴塞尔委员会是全球银行监管标准制定者（P165），不是题干所问的FATF国家评估程序。题干主语是FATF，教材直接对应的程序是相互评估。

## 【易错提醒】

不要混淆评估程序与评估指标：相互评估是FATF审查国家反洗钱/反恐怖融资体系的程序；11项直接目标是该程序中衡量有效性的具体框架。本题选项询问的是评估程序，因此选择D。
