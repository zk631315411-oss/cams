...
section_title: `US AML/CFT regulatory landscape > China AML regulations`

section_text_with_unit_anchors:

```text
[v7u_N001914|1914] China revised its AML Law, which took effect on January 1, 2025. This revision reflects China’s commitment to aligning with international standards, particularly the FATF Recommendations, while addressing emerging risks in digital finance and cross-border crime.
ZH: 中国修订后的《反洗钱法》于2025年1月1日生效，反映与国际标准接轨并应对数字金融和跨境犯罪风险

[v7u_N001915|1915] This revised AML Law expands the scope of the previous regime, both in terms of predicate offenses and in terms of sectors covered by the law.
ZH: 修订后的《反洗钱法》扩大了上游犯罪范围和覆盖行业

[v7u_N001916|1916] In doing so, the revisions aim to provide flexibility to address evolving risks.
ZH: 修订旨在提供灵活性以应对不断变化的风险

[v7u_N001917|1917] In terms of predicate offenses, the revised law now applies to any criminal activity.
ZH: 修订后的法律将上游犯罪扩展至任何犯罪活动

[v7u_N001918|1918] Additional sectors covered by the law include law firms, real estate agencies, and dealers in precious gems.
ZH: 新增覆盖行业包括律师事务所、房地产中介和贵宝石交易商

[v7u_N001919|1919] Importantly, the revised law has extraterritorial application, extending the jurisdiction to include activities that occur outside of China, but which are deemed to pose a threat to China or its citizens.
ZH: 修订后的法律具有域外适用效力，管辖对中国或其公民构成威胁的境外活动

[v7u_N001920|1920] Under the AML Law, obliged entities must abide by enhanced compliance obligations such as implementing enhanced internal controls, conducting CDD, and reporting suspicious transactions.
ZH: 根据《反洗钱法》，义务实体必须遵守强化合规义务，包括实施强化内部控制、进行客户尽职调查和报告可疑交易

[v7u_N001921|1921] The revised law emphasizes ongoing monitoring and mandates simplified CDD for low-risk clients to balance compliance and service efficiency.
ZH: 修订后的法律强调持续监控，并允许对低风险客户采用简化客户尽职调查。

[v7u_N001922|1922] This law strengthens enforcement and escalates penalties for noncompliance, with large fines for severe violations.
ZH: 该法律加强执法力度，对违规行为提高处罚，严重违规处以高额罚款。

[v7u_N001923|1923] In conjunction with tightening oversight, the AML Law safeguards legitimate financial activities and personal privacy. The provisions restrict excessive risk measures, ensure data protection, and allow judicial redress for entities affected by unjustified account freezes.
ZH: 反洗钱法保障合法金融活动和个人隐私，限制过度风险措施。

[v7u_N001924|1924] The People’s Bank of China is the primary supervisory body under the State Council. This body oversees AML enforcement, coordinates interdepartmental efforts, and conducts financial monitoring through the Anti-Money Laundering Monitoring and Analysis Center.
ZH: 中国人民银行是国务院领导下的主要反洗钱监管机构。

[v7u_N001925|1925] Sector-specific regulators, such as the China Banking and Insurance Regulatory Commission and the China Securities Regulatory Commission, collaborate with the People’s Bank of China to enforce AML compliance in their respective industries.
ZH: 行业特定监管机构与中国人民银行合作，在其各自行业执行反洗钱合规。

[v7u_N001926|1926] Additionally, the Ministry of Public Security investigates and prosecutes money laundering and terrorist financing offenses.
ZH: 公安部负责调查和起诉洗钱及恐怖融资犯罪。
```
...
[
  {
    ...
    "proposition": "修订后的法律将上游犯罪扩展至任何犯罪活动，即法律适用于任何犯罪活动。",
    "source_quotes": [
      "In terms of predicate offenses, the revised law now applies to any criminal activity."
    ],
    "relation_cues": [
      "applies to"
    ],
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "修订后的法律适用",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001917",
        "quote": "In terms of predicate offenses, the revised law now applies to any criminal activity."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "修订后的法律具有域外适用效力，管辖对中国或其公民构成威胁的境外活动。",
    "source_quotes": [
      "Importantly, the revised law has extraterritorial application, extending the jurisdiction to include activities that occur outside of China, but which are deemed to pose a threat to China or its citizens."
    ],
    "relation_cues": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "法律域外适用",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001919",
        "quote": "Importantly, the revised law has extraterritorial application, extending the jurisdiction to include activities that occur outside of China, but which are deemed to pose a threat to China or its citizens."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "义务实体必须遵守强化合规义务，包括实施强化内部控制、进行客户尽职调查和报告可疑交易。",
    "source_quotes": [
      "Under the AML Law, obliged entities must abide by enhanced compliance obligations such as implementing enhanced internal controls, conducting CDD, and reporting suspicious transactions."
    ],
    "relation_cues": [
      "must abide by"
    ],
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "遵守强化合规义务",
      "outcomes_or_paths": [
        "实施强化内部控制",
        "进行客户尽职调查",
        "报告可疑交易"
    ...
    "evidence_spans": [
      {
        "unit_id": "v7u_N001920",
        "quote": "Under the AML Law, obliged entities must abide by enhanced compliance obligations such as implementing enhanced internal controls, conducting CDD, and reporting suspicious transactions."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "对于低风险客户，要求采用简化客户尽职调查。",
    "source_quotes": [
      "The revised law emphasizes ongoing monitoring and mandates simplified CDD for low-risk clients to balance compliance and service efficiency."
    ],
    "relation_cues": [
      "mandates simplified CDD for"
    ],
    "candidate_frame": {
      "trigger_or_context": [
        "低风险客户"
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "采用简化客户尽职调查",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001921",
        "quote": "The revised law emphasizes ongoing monitoring and mandates simplified CDD for low-risk clients to balance compliance and service efficiency."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "法律加强执法力度，对违规行为提高处罚，严重违规处以高额罚款。",
    "source_quotes": [
      "This law strengthens enforcement and escalates penalties for noncompliance, with large fines for severe violations."
    ],
    "relation_cues": [
      "noncompliance",
      "large fines for severe violations"
    ],
    "candidate_frame": {
      "trigger_or_context": [
        "违规行为"
      ...
      "focal_handling_or_judgment": "加强执法并提高处罚",
      "outcomes_or_paths": [
        "严重违规处以高额罚款"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001922",
        "quote": "This law strengthens enforcement and escalates penalties for noncompliance, with large fines for severe violations."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  ...
  {
    "candidate_id": "s1c_gap_ch24_s15_judicial_redress",
    "unit_ids": [
      "v7u_N001923"
    ],
    "proposition": "修订后的反洗钱法允许因不当冻结账户而受影响的实体寻求司法救济。",
    "source_quotes": [
      "allow judicial redress for entities affected by unjustified account freezes"
    ],
    "relation_cues": [
      "allow",
      "affected by"
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "允许司法救济",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001923",
        "quote": "allow judicial redress for entities affected by unjustified account freezes"
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只涉及义务实体需遵守的合规义务，未涵盖因不当账户冻结影响实体时允许司法救济这一独立处置链。"
    }
  }
]
```
