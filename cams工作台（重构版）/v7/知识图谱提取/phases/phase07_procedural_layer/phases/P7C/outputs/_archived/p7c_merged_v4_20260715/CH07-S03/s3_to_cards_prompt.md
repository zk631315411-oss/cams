...
```json
{
  ...
  "episodes": [
    {
      ...
      "focal_question": "银行知道或怀疑客户使用非法资金还贷时，是否不应接受该资金？",
      "title": "拒绝接受非法资金还贷",
      "card_nature": "control",
      "elements": [
        {
      ...
      "relations": [
        {
          ...
          "source_quote": "If the bank knows or suspects the customer is using illicit funds to repay the loan, the risk of default becomes a secondary risk to manage."
        },
        {
          "relation_id": "r002",
          "kind": "sequence",
    ...
    },
    {
      ...
      "focal_question": "退出超出风险容忍度且有贷款余额的客户关系时，核销贷款应如何执行？",
      "title": "退出客户关系时核销贷款需充分理由和批准",
      "card_nature": "control",
      "elements": [
        {
          "element_id": "e004",
      ...
      "relations": [
        {
          ...
          "condition": "退出超出风险容忍度且仍有贷款余额的客户关系",
          "relation_type": null,
          "qualifier": null,
          "evidence_unit_ids": [
            "v7u_N000555"
  ...
  "candidate_audit": [
    ...
    },
    {
      ...
      "reason": "候选提供退出客户关系时核销贷款需充分理由和批准的流程要求。"
    }
  ],
  "skip_reason": null
}
