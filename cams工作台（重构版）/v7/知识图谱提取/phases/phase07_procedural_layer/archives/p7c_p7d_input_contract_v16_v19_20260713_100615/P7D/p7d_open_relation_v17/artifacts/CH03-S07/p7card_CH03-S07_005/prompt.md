...
p7c_card_under_review:
{
  ...
  "title": "金融机构交易监控系统标记异常并检测非法活动",
  "flow_nodes": [
    {
      "node_id": "P1",
      "node_category": "process",
      "node_type": "P1_assessment",
      "label": "金融机构交易监控系统: 标记结构化存款、快速跨境分层和与已知恐怖相关钱包关联的异常资金活动",
      "evidence_unit_ids": [
        "v7u_N000283"
      ],
  ...
  "review_notes": "增量命题：金融机构交易监控系统标记异常 → 检测到非法活动。KG不足：基础KG可保存检测事实，但无法表达系统标记具体异常并据此得出检测结论的评判方向和局部过程。选项判断：可辅助确认金融机构在恐怖融资识别中通过交易监控系统标记异常并输出结论的具体步骤。LLM推理：无。"
}
