...
[
  {
    ...
    "proposition": "CashBayou因持有并临时转换资金而需持有MSB牌照。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "CashBayou持有买家资金并转换为卖家偏好货币"
      ],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "必须持有MSB牌照",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000768",
        "quote": "CashBayou is a thriving e-commerce platform, connecting buyers and sellers across the globe. CashBayou’s platform is structured in such a way that they hold buyers’ funds temporarily and convert them into the sellers' preferred currency before transferring them to sellers. Because of this, they are required to have an MSB license."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "Emma收到异常交易警报后调查，发现可疑交易模式引发洗钱红旗，并发现KYC不足，指出审查不足可能带来金融犯罪、欺诈和监管风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "Emma进行调查并识别出可疑交易模式和KYC不足",
      "outcomes_or_paths": [
        "发现买家使用多个账户进行高频低额交易引发洗钱红旗",
        "发现KYC治理和执行不足",
        "审查不足可能导致金融犯罪、欺诈和监管风险，甚至服务暂停"
      ]
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "CashBayou需调整尽职调查程序以符合CardGuard标准",
      "outcomes_or_paths": [
        "符合标准则继续合作",
        "不符合则终止合作"
      ]
    ...
    "evidence_spans": [
      {
        "unit_id": "v7u_N000779",
        "quote": "Later that week, Emma's team receives a letter from their card issuer partner, CardGuard. The letter states that companies using CardGuard’s services are required to align their due diligence procedures with CardGuard’s standards for referred cardholders. Failure to comply will result in the termination of CardGuard’s partnership with CashBayou."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "支付服务商 PaySecure 针对异常交易联系 CashBayou 要求信息，并要求通话了解尽职调查流程，表达担忧并强调持续合作和严格监控。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "PaySecure联系Emma要求提供一系列交易的更多信息",
        "该请求涉及部分与新房买家相关的异常交易"
      ],
      "basis_or_condition": [
        "基于交易频率要求通话了解尽职调查流程"
      ],
      "focal_handling_or_judgment": "PaySecure表达对CashBayou政策的担忧并强调持续合作和严格监控",
      "outcomes_or_paths": [
        "需要加强合作与监控以降低风险"
      ]
    },
    ...
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只承接了Emma的内部调查和发现，未承接PaySecure作为支付服务商针对异常交易主动联系要求信息、通话了解尽调并表达担忧强调持续监控这一外部合作处置链。"
    }
  }
]
```
