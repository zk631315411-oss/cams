...
<[
  {
    ...
    "proposition": "SPV的复杂和不透明结构可能被用来掩盖真实受益所有人",
    "source_quotes": [
      "complex and opaque structures to disguise the true beneficial ownership"
    ]
  },
  {
    ...
    "proposition": "金融机构在处理SPV和PIV时，必须进行强化尽职调查并确保遵守客户尽职调查规则",
    "source_quotes": [
      "Financial institutions must be vigilant in conducting enhanced due diligence (EDD) on SPVs and PIVs",
      "ensure these investments comply with CDD regulations"
    ]
  },
  {
    ...
    "proposition": "金融机构必须识别SPV/PIV的最终受益所有人并了解其真实目的，以减轻相关的潜在金融犯罪风险",
    "source_quotes": [
      "identify ultimate beneficial owners and understand the true purpose of these entities",
      "This will help mitigate any potential financial crime risks"
    ]
  }
]>
