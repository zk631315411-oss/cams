...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "可疑活动报告时限要求",
      "title_en": "SAR Timeliness Requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003491",
          "unit_type": "rule",
    ...
    {
      "title_zh": "可疑活动报告内容要求",
      "title_en": "SAR Content Requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003494",
          "unit_type": "rule",
    ...
    {
      "title_zh": "可疑活动报告保密与通风报信",
      "title_en": "SAR Confidentiality and Tipping Off",
      "covered_units": [
        {
          "unit_id": "v7u_N003495",
          "unit_type": "rule",
    ...
    {
      "title_zh": "未提交SAR的处罚",
      "title_en": "Penalties for SAR Non-Compliance",
      "covered_units": [
        {
          "unit_id": "v7u_N003509",
  ...
  "covered_relations": [
    {
      "source_title": "可疑活动报告时限要求",
      "target_title": "可疑活动报告内容要求",
      "relation_type": "parallels"
    },
    {
      "source_title": "可疑活动报告时限要求",
      "target_title": "可疑活动报告保密与通风报信",
      "relation_type": "parallels"
    },
    {
      "source_title": "可疑活动报告内容要求",
      "target_title": "可疑活动报告保密与通风报信",
      "relation_type": "parallels"
    },
    {
      "source_title": "可疑活动报告保密与通风报信",
      "target_title": "未提交SAR的处罚",
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "SAR申报规定因机构而异，但有共同要求（时限和信息访问限制）",
      "decision": "kg_only",
      "card_id": null,
      "reason": "概述性事实，无有向结构"
    },
    ...
    },
    {
      ...
      "proposition": "警报生成后，调查可以开始",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_001",
      "reason": "事件（警报生成）触发过程（调查开始），构成有向条件-动作链，超出KG事实陈述"
    },
    {
      ...
      "proposition": "活动被认定为可疑后，报告时限开始，必须在时限内提交SAR",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_002",
      "reason": "状态变化导向义务动作，形成明确的条件-义务链，超出KG规则保存"
    },
    {
      ...
      "proposition": "SAR内容需说明认定为可疑的理由，无需证明犯罪发生",
      "decision": "kg_only",
      "card_id": null,
      "reason": "内容要求，无独立有向结构，已作为标准纳入card_004"
    },
    {
      ...
      "proposition": "SAR不得在金融机构和执法机构之外共享",
      "decision": "kg_only",
      "card_id": null,
      "reason": "禁止规则，无有向链"
    },
    {
      ...
      "proposition": "金融机构内部应谨慎处理SAR，限制访问",
      "decision": "kg_only",
      "card_id": null,
      "reason": "内部处理要求，无有向链"
    },
    ...
    },
    {
      ...
      "proposition": "常见法规要求调查人员在怀疑犯罪活动时建议申报SAR，使用事实支持，并避免泄密",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_004",
      "reason": "条件（怀疑）导向义务动作（建议申报），形成有向链；避免泄密部分留给KG"
    },
    {
    ...
    },
    {
      ...
      "proposition": "一旦怀疑或知悉犯罪活动，应建议提交SAR",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_004",
      "reason": "条件-动作链，纳入组合card_004"
    },
    {
      ...
      "proposition": "美国：检测到可疑活动后30天内提交SAR，无法识别嫌疑人时可延期30天",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_003",
      "reason": "检测事件触发时限义务，且有条件延期，构成有向结构"
    },
    {
    ...
    },
    {
      ...
      "proposition": "SAR信息必须适当、完整、基于事实",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_004",
      "reason": "作为标准约束动作，纳入组合card_004"
    },
    {
      ...
      "proposition": "SAR应包含客户信息、服务、交易、怀疑理由、支持证据",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_004",
      "reason": "作为输入组成要素，纳入组合card_004"
    },
    {
      ...
      "proposition": "SAR无需提供犯罪发生的完整证据，但需有证据支持可疑判断",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S03_004",
      "reason": "作为证据标准，纳入组合card_004"
    },
    {
      ...
      "proposition": "法规禁止金融机构向除执法机构之外的任何人披露SAR",
      "decision": "kg_only",
      "card_id": null,
      "reason": "禁止规则，无有向链"
    },
  ...
  "cards": [
    {
      ...
      "flow_edges": [
        {
          "edge_id": "CH49-S03_001_edge1",
          "edge_type": "PRECEDES",
          "source": "CH49-S03_001_E1",
          "target": "CH49-S03_001_P1",
          "evidence_unit_ids": [
            "v7u_N003492"
          ],
      ...
      "review_notes": "增量命题：警报生成 --触发--> 调查开始；KG不足：基础KG可保存\"警报生成后即可开始调查\"的事实，但无法表达事件与动作之间的触发关系；选项判断：可确认或排除关于调查启动时机的选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH49-S03_002",
      "section_id": "CH49-S03",
      "card_nature": "execution",
      "title": "活动被认定为可疑触发时限开始并提交SAR",
      "flow_nodes": [
        {
          "node_id": "CH49-S03_002_E1",
          "node_category": "entry",
        ...
        {
          "node_id": "CH49-S03_002_P1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "机构必须在监管规定时限内提交SAR",
          "evidence_unit_ids": [
            "v7u_N003493"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "CH49-S03_002_edge1",
          "edge_type": "PRECEDES",
          "source": "CH49-S03_002_E1",
          "target": "CH49-S03_002_P1",
          "evidence_unit_ids": [
            "v7u_N003493"
          ],
          "derivation": "explicit_text",
          "condition": "一旦活动被认定为可疑",
          "relation_type": null
        }
      ],
      "source_unit_ids": [
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：活动被认定为可疑（状态） --触发--> 机构必须在时限内提交SAR（义务）；KG不足：基础KG可保存\"认定可疑后需在时限内提交SAR\"的整体规则，但无法表达条件到义务的有向推导关系；选项判断：可确认是否在认定可疑后才触发报告时限和提交义务；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH49-S03_003",
      "section_id": "CH49-S03",
      "card_nature": "execution",
      "title": "美国SAR提交时限及延期条件",
      "flow_nodes": [
        {
          "node_id": "CH49-S03_003_E1",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "检测到可疑活动（美国）",
          "evidence_unit_ids": [
        ...
        {
          "node_id": "CH49-S03_003_P1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "机构必须在30个日历日内提交SAR（若无法识别嫌疑人，可额外延期30个日历日）",
          "evidence_unit_ids": [
            "v7u_N003502"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "CH49-S03_003_edge1",
          "edge_type": "PRECEDES",
          "source": "CH49-S03_003_E1",
          "target": "CH49-S03_003_P1",
          "evidence_unit_ids": [
            "v7u_N003502"
          ],
          "derivation": "explicit_text",
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：检测到可疑活动 --触发--> 必须在30天内提交SAR（无法识别嫌疑人时可延期30天）；KG不足：基础KG可保存时限规则，但无法表达检测事件到提交义务的触发关系以及延期条件的适用；选项判断：可确认美国中的提交时限和延期条件；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH49-S03_004",
      "section_id": "CH49-S03",
      "card_nature": "execution",
      "title": "怀疑犯罪活动时提交SAR的内容与证据要求",
      "flow_nodes": [
        {
          "node_id": "CH49-S03_004_E1",
          "node_category": "entry",
        ...
        {
          "node_id": "CH49-S03_004_P1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "调查人员必须建议提交可疑活动报告（SAR）",
          "evidence_unit_ids": [
            "v7u_N003501",
            "v7u_N003498"
          ],
        ...
        {
          "node_id": "CH49-S03_004_AUX1",
          "node_category": "auxiliary",
          "node_type": "input",
          "label": "SAR应包含的信息：客户信息、机构服务、交易活动、怀疑理由、支持证据",
          "evidence_unit_ids": [
            "v7u_N003505"
          ],
          "evidence_strength": "explicit"
        ...
        {
          "node_id": "CH49-S03_004_AUX2",
          "node_category": "auxiliary",
          "node_type": "standard",
          "label": "信息必须适当、完整、基于事实（无需证明犯罪发生，但需有证据支持可疑理由）",
          "evidence_unit_ids": [
            "v7u_N003504",
            "v7u_N003506",
            "v7u_N003494"
      ...
      "flow_edges": [
        {
          "edge_id": "CH49-S03_004_edge1",
          "edge_type": "PRECEDES",
          "source": "CH49-S03_004_E1",
          "target": "CH49-S03_004_P1",
          "evidence_unit_ids": [
            "v7u_N003501",
            "v7u_N003498"
          ],
        ...
        {
          "edge_id": "CH49-S03_004_edge2",
          "edge_type": "REFERENCES",
          "source": "CH49-S03_004_P1",
          "target": "CH49-S03_004_AUX1",
          "evidence_unit_ids": [
            "v7u_N003505"
          ],
          "derivation": "explicit_text",
        ...
        {
          "edge_id": "CH49-S03_004_edge3",
          "edge_type": "REFERENCES",
          "source": "CH49-S03_004_P1",
          "target": "CH49-S03_004_AUX2",
          "evidence_unit_ids": [
            "v7u_N003504",
            "v7u_N003506",
            "v7u_N003494"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：怀疑或知悉犯罪活动 --触发--> 建议提交SAR，且SAR内容须包含特定信息并符合适当、完整、基于事实的标准；KG不足：基础KG可分别保存\"应建议提交SAR\"和\"SAR内容要求\"，但无法表达动作与输入的组成关系以及标准对动作的约束关系；选项判断：可确认提交SAR的触发条件、所需信息及证据标准；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
