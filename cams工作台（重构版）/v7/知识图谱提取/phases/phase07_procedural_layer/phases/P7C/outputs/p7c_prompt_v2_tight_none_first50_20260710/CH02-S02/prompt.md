...
```json
{
  ...
  "core_points": [
    {
      "core_point_id": "cp_CH02_S02_001",
      "title_zh": "制裁规避与洗钱",
      "title_en": "Sanctions evasion and money laundering",
      "anchor_unit_ids": [
        "v7u_N000112",
        "v7u_N000113",
        "v7u_N000114"
...
```text
[v7u_N000112|112] Sanctions evasion can serve as a predicate offense for money laundering, highlighting the interconnected nature of financial crimes.
ZH: 制裁规避可作为洗钱的上游犯罪，体现金融犯罪的关联性

[v7u_N000113|113] Criminals might use shell companies to mask illicit activities and circumvent sanctions restrictions.
ZH: 犯罪分子利用壳公司掩盖非法活动并规避制裁

[v7u_N000114|114] Complex financial strategies can obscure prohibited activities such as nuclear weapons development.
ZH: 复杂金融策略可掩盖核武器开发等被禁活动
```
