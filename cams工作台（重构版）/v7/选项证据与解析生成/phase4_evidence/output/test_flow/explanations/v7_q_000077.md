...
识别期货市场利用对倒交易制造虚假成交量的洗钱类型

## 【核心解析】

洗单交易指通过预先安排的交易制造虚假交易量并掩盖资金来源的行为（P66）。题干中，被告之间反复以低价买入、高价卖出同一期货合约，双方持仓量均未发生变化，交易的唯一结果是一方赚钱、另一方亏损同等金额——这正是典型的洗单交易（wash trading）模式：通过自买自卖的虚假交易，在账户之间转移资金而无需真正的市场风险或持仓变动。

教材原句："Pre-arranged trading that can create artificial trading volumes and obscure the origin of funds."

## 【错误项分析】

- **A 错误（题干对照）｜概念混淆**：空头头寸指预期价格下跌而卖出借入资产的投资策略，属于正常的市场操作方向，题干描述的是双方之间预先安排的对倒交易，与持仓方向选择无关。
- **B 错误（题干对照）｜证据不足**：教材未收录「反向翻转」这一术语，题干描述的行为本质是制造虚假成交量而非某种特定的交易方向翻转。
- **C 错误（题干对照）｜概念混淆**：买卖价差是正常市场中买方最高出价与卖方最低要价之间的差额，属于市场微观结构概念，而题干描述的是人为安排的对倒操作以达到资金转移目的，更匹配教材对洗单交易的定义而非市场价差概念。

## 【易错提醒】

洗单交易的核心特征是「无真实风险转移」——交易前后持仓不变，唯一变化是账户间资金转移。这与正常市场交易（真实买卖意愿、持仓变化）的根本区别在于交易目的是否为制造虚假成交量或转移资金而非执行投资策略。
