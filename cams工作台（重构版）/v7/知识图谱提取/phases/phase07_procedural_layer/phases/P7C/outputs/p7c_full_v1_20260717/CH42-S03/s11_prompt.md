...
section_title: `Onboarding AFC controls > • EDD:`

section_text_with_unit_anchors:

```text
[v7u_N003030|3030] EDD involves verifying source of wealth and source of funds more deeply, examining and verifying any claims through supporting documentation.
ZH: 强化尽职调查涉及更深入地核实财富来源和资金来源
```
