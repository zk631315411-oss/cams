...
section_title: `Technology for KYC > Whitelisting and adding to internal lists`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "白名单与内部列表：概念与优势",
      "title_en": "Whitelisting and Internal Lists: Concepts and Benefits",
      "covered_units": [
        {
          "unit_id": "v7u_N004253",
    ...
    {
      "title_zh": "白名单与内部列表的风险与治理",
      "title_en": "Risks and Governance of Whitelisting and Internal Lists",
      "covered_units": [
        {
          "unit_id": "v7u_N004260",
  ...
  "covered_relations": [
    {
      "source_title": "白名单与内部列表：概念与优势",
      "target_title": "白名单与内部列表的风险与治理",
...
```text
[v7u_N004252|4252] Whitelisting and adding to internal lists are key methods to reduce false positives and continuously monitor for known risks not included on third-party lists.
ZH: 白名单和内部列表可减少误报并持续监控已知风险

[v7u_N004253|4253] As part of list management, whitelisting involves maintaining an internal list of customer names or other data points not to be flagged in certain situations.
ZH: 白名单是维护内部客户名称列表，在特定情况下不触发预警

[v7u_N004254|4254] For example, an organization might whitelist a customer whose name has repeatedly triggered alerts that the organization determines to be false positives. This action is to avoid triggering repetitive reviews.
ZH: 示例：对反复触发误报的客户进行白名单处理以避免重复审查

[v7u_N004255|4255] Financial institutions create this list based on the analysis of false positive alerts caused by certain terms on other lists and frequently encountered data.
ZH: 白名单基于对其他列表中的术语和常见数据的误报分析创建

[v7u_N004256|4256] Financial institutions also maintain internal lists known as private lists or grey lists, which contain names of individuals and entities that may present financial crime risk to the organization.
ZH: 金融机构维护内部列表（私人列表或灰名单），包含可能带来金融犯罪风险的个人和实体

[v7u_N004257|4257] Organizations identify these names through their internal processes or intelligence.
ZH: 通过内部流程或情报识别内部列表中的名称

[v7u_N004258|4258] For example, this may include the names of customers the organization has exited due to fraud or other financial crimes.
ZH: 内部列表可能包含因欺诈或其他金融犯罪而被终止关系的客户名称

[v7u_N004259|4259] Using whitelisting, financial institutions can streamline their compliance efforts and enhance efficiency by reducing false positive alerts. Internal lists of individuals or entities allow organizations to focus on true hits, thereby enhancing the prevention and detection of suspicious activities. Using these lists improves customer experience, particularly with payments, and identifies risk sooner.
ZH: 白名单和内部列表可简化合规工作、提高效率、改善客户体验并及早识别风险

[v7u_N004260|4260] However, whitelisting may present critical risks, too. For example, a sanctioned entity could gain indirect access to financial services through a whitelisted intermediary, or shell companies with prior clean records could be used to layer illicit funds.
ZH: 白名单可能带来风险，例如受制裁实体通过白名单中介间接获取金融服务

[v7u_N004261|4261] The Wolfsberg Group advises financial institutions to apply a risk-based approach when implementing these lists and to ensure that they fall within their risk appetite.
ZH: 沃尔夫斯堡集团建议金融机构在实施名单时采用风险为本方法

[v7u_N004262|4262] It also recommends strong governance in creating and maintaining these lists.
ZH: 建议在创建和维护名单时实施强有力的治理

[v7u_N004263|4263] Policies and procedures should include a process for adding and removing entries to these lists, including instances where screening is no longer needed or necessary.
ZH: 政策和程序应包含添加和移除名单条目的流程

[v7u_N004264|4264] Financial institutions should periodically review the lists to ensure they are up to date and accurate.
ZH: 金融机构应定期审查名单以确保其最新和准确

[v7u_N004265|4265] They should also establish an approval process and ensure that only appropriate individuals can make changes to the lists.
ZH: 应建立审批流程并确保只有适当人员才能修改名单

[v7u_N004266|4266] Other governance measures include performing regular risk assessments or continuous monitoring to evaluate the potential risks associated with whitelisted entities and keeping a clear audit trail.
ZH: 其他治理措施包括定期风险评估、持续监控和保留审计轨迹

[v7u_N004267|4267] Financial institutions should also ensure that their practices are aligned with relevant regulatory requirements and guidelines.
ZH: 金融机构应确保其做法符合相关监管要求和指引
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "机构确定客户触发的警报为误报后，将其列入白名单，以避免重复审查。",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S13_001",
      "reason": "案例中机构基于误报判断执行白名单化，构成判断-应对有向链，基础KG只能表达为整体事实，无法表达方向性。"
    },
    {
      ...
      "proposition": "金融机构实施白名单/内部列表时，应采用风险为本方法并确保符合风险偏好。",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S13_002",
      "reason": "实施动作受到两个明确标准的约束，形成有向约束关系，基础KG只能保存整体规则，不能突出标准对动作的约束方向。"
    },
    {
      ...
      "proposition": "金融机构在创建和维护名单时应实施强有力的治理。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "简单义务陈述，无特定标准或条件约束的有向结构，基础KG可保存为治理要求。"
    },
    {
      ...
      "proposition": "政策和程序应包含添加和移除名单条目的流程。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "义务陈述无外部标准约束，基础KG可表达为流程要求。"
    },
    {
      ...
      "proposition": "金融机构应定期审查名单以确保准确。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "动作-对象关系直接，无额外条件或标准，基础KG可表达为定期审查义务。"
    },
    {
      ...
      "proposition": "应建立审批流程并限制名单修改权限。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "多个简单义务，基础KG可表达为控制要求。"
    },
    {
      ...
      "proposition": "金融机构应确保其做法符合相关监管要求和指引。",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S13_003",
      "reason": "监管要求作为外部标准约束机构做法，形成有向约束关系，基础KG只能保存整体规则，不能突出标准对做法的约束方向。"
    },
    {
      ...
      "proposition": "白名单可能导致受制裁实体通过白名单中介间接获取金融服务。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立风险场景，无机构应对或判断结构，基础KG可保存为风险指标。"
    },
    {
      ...
      "proposition": "金融机构基于误报分析创建白名单。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "解释性事实，无触发判断，基础KG可表达。"
    },
    {
      ...
      "proposition": "内部列表可能包含因欺诈终止的客户名称。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "构成说明，非主动添加流程。"
    },
    {
      ...
      "proposition": "白名单和内部列表的各种定义、优点和治理措施列举。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "定义、事实和列举无局部有向判断结构，基础KG可充分表达。"
    }
  ],
  "cards": [
    {
      ...
      "flow_nodes": [
        {
          "node_id": "E1_CH54S13_001",
          "node_category": "entry",
          "node_type": "E8_decision_finding",
          "label": "机构确定客户触发的警报为误报",
          "evidence_unit_ids": [
            "v7u_N004254"
          ],
        ...
        {
          "node_id": "P1_CH54S13_001",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "机构将客户列入白名单 (may)",
          "evidence_unit_ids": [
            "v7u_N004254"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "edge1_CH54S13_001",
          "edge_type": "PRECEDES",
          "source": "E1_CH54S13_001",
          "target": "P1_CH54S13_001",
          "evidence_unit_ids": [
            "v7u_N004254"
          ],
          "derivation": "explicit_text",
          "condition": null,
          "source_quote": "might whitelist a customer whose name has repeatedly triggered alerts that the organization determines to be false positives"
        }
      ],
      "source_unit_ids": [
        "v7u_N004254"
      ...
      "review_notes": "增量命题：机构确定客户触发的警报为误报后，将其列入白名单。KG不足：基础KG只能表达为“机构可以使用白名单处理误报”，无法表达具体的判断-应对链。选项判断：可确认机构在发现误报后采取白名单化这一具体应对措施。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH54-S13_002",
      "section_id": "CH54-S13",
      ...
      "flow_nodes": [
        {
          "node_id": "P2_CH54S13_002",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构实施白名单/内部列表 (should, risk-based)",
          "evidence_unit_ids": [
            "v7u_N004261"
          ],
          "evidence_strength": "explicit"
        ...
        {
          "node_id": "S1_CH54S13_002",
          "node_category": "auxiliary",
          "node_type": "standard",
          "label": "风险为本方法 (risk-based approach)",
          "evidence_unit_ids": [
            "v7u_N004261"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "edge2_CH54S13_002",
          "edge_type": "REFERENCES",
          "source": "P2_CH54S13_002",
          "target": "S1_CH54S13_002",
          "evidence_unit_ids": [
            "v7u_N004261"
          ],
          "derivation": "explicit_text",
          ...
          "condition": null,
          "source_quote": "apply a risk-based approach when implementing these lists"
        },
        {
          "edge_id": "edge3_CH54S13_002",
          "edge_type": "REFERENCES",
          "source": "P2_CH54S13_002",
          "target": "S2_CH54S13_002",
          "evidence_unit_ids": [
            "v7u_N004261"
          ],
          "derivation": "explicit_text",
          "relation_type": "standard_constrains_action",
          "condition": null,
          "source_quote": "ensure that they fall within their risk appetite"
        }
      ],
      "source_unit_ids": [
        "v7u_N004261"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：金融机构实施名单时应参照风险为本方法和风险偏好。KG不足：基础KG只能表达为“应采用风险为本方法并确保在风险偏好内”的规则，无法表达标准对实施动作的约束方向。选项判断：可确认实施名单时必须考虑风险偏好和风险方法。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH54-S13_003",
      "section_id": "CH54-S13",
      ...
      "flow_nodes": [
        {
          "node_id": "P3_CH54S13_003",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构应确保做法符合监管要求和指引 (should)",
          "evidence_unit_ids": [
            "v7u_N004267"
          ],
          "evidence_strength": "explicit"
        ...
        {
          "node_id": "S3_CH54S13_003",
          "node_category": "auxiliary",
          "node_type": "standard",
          "label": "相关监管要求和指引 (relevant regulatory requirements and guidelines)",
          "evidence_unit_ids": [
            "v7u_N004267"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "edge4_CH54S13_003",
          "edge_type": "REFERENCES",
          "source": "P3_CH54S13_003",
          "target": "S3_CH54S13_003",
          "evidence_unit_ids": [
            "v7u_N004267"
          ],
          "derivation": "explicit_text",
          "relation_type": "standard_constrains_action",
          "condition": null,
          "source_quote": "ensure that their practices are aligned with relevant regulatory requirements and guidelines"
        }
      ],
      "source_unit_ids": [
        "v7u_N004267"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：金融机构的做法应符合监管要求。KG不足：基础KG只能表达为“应符合监管要求”的义务，无法表达监管要求对做法的约束方向。选项判断：可确认监管要求在实践中的约束作用。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
