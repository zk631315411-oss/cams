...
section_title: `Governance and oversight > Need for AFC policies and procedures`

section_text_with_unit_anchors:

```text
[v7u_N002890|2890] Policies and procedures are essential guidelines on managing risks for an AFC compliance program.
ZH: 政策和程序是管理金融犯罪防控合规计划风险的基本指南

[v7u_N002891|2891] In general, policies translate legal and regulatory requirements as applicable to the organization.
ZH: 政策将法律法规要求转化为适用于组织的具体规定

[v7u_N002892|2892] Procedures are the step-bystep instructions on how to implement policies.
ZH: 程序是实施政策的逐步操作指南

[v7u_N002893|2893] Policies and procedures generally include requirements for oversight at senior levels.
ZH: 政策和程序通常包含高级管理层的监督要求
```
