...
<[
  {
    ...
    "proposition": "虽然运营、法律、集中度、声誉等风险通常由非金融犯罪防控团队管理，但理解这些风险与金融犯罪风险的关联是不可或缺的。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "全球组织通常以母国监管机构政策为基础标准，再根据东道国法律进行调整。",
    "source_quotes": [
      "a global organization makes the policies of its home regulator its base standard. The organization will then adjust to each host country’s laws."
    ]
  },
  {
    ...
    "proposition": "当不断演变的法规可能与业务模式和控制错位时，合规计划必须持续更新。",
    "source_quotes": [
      "Evolving regulations might become misaligned with current business models and controls.",
  ...
  },
  {
    ...
    "proposition": "如果组织违反法规、法律或道德实践，可能面临政府的行政处罚或罚款，以及受损客户等第三方的诉讼。",
    "source_quotes": [
      "Legal risk stems from potential violation of regulations, laws, and ethical practices.",
      "Governments might issue administrative penalties or fines. Third parties, such as customers who feel damaged, might file lawsuits."
    ]
  },
  {
    ...
    "proposition": "充分的金融犯罪防控措施可防范犯罪及不当关系。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "借助技术的客户尽职调查有助于管理集中度风险敞口。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "客户行为或涉及客户的外部行为可能导致集中度风险增加。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "一条新闻（甚至是假新闻）即可驱离客户和投资者，使信任迅速丧失。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "组织的声誉（无论好坏）源于其所选择的商业实践和道德。",
    "source_quotes": [
