...
[
  {
    ...
    "proposition": "当银行因洗钱担忧关闭客户账户且客户仍有贷款余额时，若银行知道或怀疑客户使用非法资金还贷，则不应接受该资金用于还贷。",
    "source_quotes": [
      "Banks often face significant challenges when attempting to close customer accounts due to money laundering concerns, while the customer still owes money on credit-related products.",
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "银行因洗钱担忧关闭客户账户，且客户仍有贷款余额"
      ],
      "basis_or_condition": [
        "银行知道或怀疑客户使用非法资金还贷"
      ],
      "focal_handling_or_judgment": "不应接受资金用于还贷",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000553",
        "quote": "Banks often face significant challenges when attempting to close customer accounts due to money laundering concerns, while the customer still owes money on credit-related products."
      },
      {
        "unit_id": "v7u_N000554",
        "quote": "If the bank knows or suspects the customer is using illicit funds to repay the loan, the risk of default becomes a secondary risk to manage. The bank should not accept funds for the purposes of loan"
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只承接了关闭账户时若怀疑非法资金还贷则不应接受资金的处理，没有承接退出超出风险容忍度的客户且仍有贷款余额时核销需要理由和批准这一独立处置链。"
    }
  }
]
```
