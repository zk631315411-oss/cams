...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "数据准备对AFC系统的重要性",
      "title_en": "Importance of Data Preparation for AFC Systems",
      "covered_units": [
        {
          "unit_id": "v7u_N004787",
          "unit_type": "fact",
    ...
    {
      "title_zh": "AFC团队应理解数据准备步骤",
      "title_en": "AFC Team Should Understand Data Preparation Steps",
      "covered_units": [
        {
          "unit_id": "v7u_N004789",
          "unit_type": "rule",
    ...
    {
      "title_zh": "数据提取：从来源收集数据",
      "title_en": "Data Extraction: Gathering Data from Sources",
      "covered_units": [
        {
          "unit_id": "v7u_N004790",
    ...
    {
      "title_zh": "数据转换：清洗和转换数据",
      "title_en": "Data Transformation: Cleaning and Converting Data",
      "covered_units": [
        {
          "unit_id": "v7u_N004793",
          "unit_type": "definition",
    ...
    {
      "title_zh": "数据加载：存储处理后的数据",
      "title_en": "Data Loading: Storing Processed Data",
      "covered_units": [
        {
          "unit_id": "v7u_N004798",
          "unit_type": "definition",
    ...
    {
      "title_zh": "用于AFC检测的数据挖掘和匹配",
      "title_en": "Data Mining and Matching for AFC Detection",
      "covered_units": [
        {
          "unit_id": "v7u_N004799",
          "unit_type": "definition",
  ...
  "covered_relations": [
    {
      "source_title": "数据准备对AFC系统的重要性",
      "target_title": "数据提取：从来源收集数据",
      "relation_type": "contains"
    },
    {
      "source_title": "数据准备对AFC系统的重要性",
      "target_title": "数据转换：清洗和转换数据",
      "relation_type": "contains"
    },
    {
      "source_title": "数据准备对AFC系统的重要性",
      "target_title": "数据加载：存储处理后的数据",
      "relation_type": "contains"
    },
    {
      "source_title": "数据准备对AFC系统的重要性",
      "target_title": "用于AFC检测的数据挖掘和匹配",
      "relation_type": "prepares"
    },
    {
      "source_title": "AFC团队应理解数据准备步骤",
      "target_title": "数据提取：从来源收集数据",
      "relation_type": "contains"
    },
    {
    ...
    {
      "source_title": "数据提取：从来源收集数据",
      "target_title": "数据转换：清洗和转换数据",
      "relation_type": "prepares"
    },
    {
      "source_title": "数据转换：清洗和转换数据",
      "target_title": "数据加载：存储处理后的数据",
      "relation_type": "prepares"
    },
    {
      "source_title": "数据加载：存储处理后的数据",
      "target_title": "用于AFC检测的数据挖掘和匹配",
      "relation_type": "prepares"
    }
  ]
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "数据准备过程包括从提取到挖掘的顺序步骤，最终检测异常。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已覆盖数据准备过程定义和步骤关系（contains, prepares），表达了先后顺序和定义，不构成超出KG的局部程序性有向结构。"
    },
    {
      ...
      "proposition": "AFC团队成员应理解数据准备的每个步骤。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这是一个孤立的行为要求，没有关联的条件、输入、标准或结果，基础KG可将其作为一般规则保存。"
    },
    {
      ...
      "proposition": "如果数据准备正确执行，将确保数据质量并支持合规性。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般好处和影响陈述，没有特定的主体动作或判断链，基础KG可表达因果。"
    },
    {
      ...
      "proposition": "数据越全面，识别可疑模式的机会越大。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般相关性陈述，不构成有向程序性结构。"
    },
    {
      ...
      "proposition": "数据转换将数据转换成适合分析的格式并创建特征。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "过程描述和列表，基础KG已覆盖。"
    },
    {
      ...
      "proposition": "数据挖掘应用算法技术于准备好的数据以检测异常。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般过程目的描述，KG已覆盖。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已充分表达本节的数据准备定义、步骤、好处和一般流程；未发现需要增量提取的局部程序性或判断性有向结构。"
}
```
