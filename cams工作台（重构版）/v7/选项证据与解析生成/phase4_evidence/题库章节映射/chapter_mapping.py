...
HERE = Path(__file__).resolve().parent  # phase4_evidence/题库章节映射/
PHASE4 = HERE.parent
BLIND_WORKFLOW_DIR = PHASE4 / "盲判流程"
if str(BLIND_WORKFLOW_DIR) not in sys.path:
    sys.path.insert(0, str(BLIND_WORKFLOW_DIR))
