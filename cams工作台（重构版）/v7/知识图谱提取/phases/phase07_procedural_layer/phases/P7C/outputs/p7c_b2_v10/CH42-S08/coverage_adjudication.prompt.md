...
section_title: `Onboarding AFC controls > KYC for a legal person`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "法人KYC：定义与组成部分",
      "title_en": "KYC for Legal Persons: Definition and Components",
      "covered_units": [
        {
          "unit_id": "v7u_N003076",
    ...
    {
      "title_zh": "法人客户身份识别程序：身份确立",
      "title_en": "CIP for Legal Persons: Identity Establishment",
      "covered_units": [
        {
          "unit_id": "v7u_N003078",
          "unit_type": "classification",
    ...
    {
      "title_zh": "法人客户尽职调查：实体评估",
      "title_en": "CDD for Legal Persons: Entity Assessment",
      "covered_units": [
        {
          "unit_id": "v7u_N003085",
          "unit_type": "classification",
    ...
    {
      "title_zh": "高风险法人强化尽职调查",
      "title_en": "EDD for High-Risk Legal Persons",
      "covered_units": [
        {
          "unit_id": "v7u_N003091",
          "unit_type": "classification",
    ...
    {
      "title_zh": "法人KYC的风险为本方法",
      "title_en": "Risk-Based Approach to KYC for Legal Persons",
      "covered_units": [
        {
          "unit_id": "v7u_N003098",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "法人KYC：定义与组成部分",
      "target_title": "法人客户身份识别程序：身份确立",
      "relation_type": "contains"
    },
    {
      "source_title": "法人KYC：定义与组成部分",
      "target_title": "法人客户尽职调查：实体评估",
      "relation_type": "contains"
    },
    {
      "source_title": "法人KYC：定义与组成部分",
      "target_title": "高风险法人强化尽职调查",
      "relation_type": "contains"
    },
    {
      "source_title": "法人KYC：定义与组成部分",
      "target_title": "法人KYC的风险为本方法",
...
```text
[v7u_N003076|3076] The KYC process for a legal person ensures that financial institutions verify corporations, partnerships, trusts, and other legal entities to prevent financial crime.
ZH: 法人了解你的客户确保金融机构核实公司、合伙企业、信托等法律实体以预防金融犯罪

[v7u_N003077|3077] KYC for legal persons consists of CIP, CDD, and EDD for high-risk entities.
ZH: 法人了解你的客户包括CIP、客户尽职调查以及对高风险实体的EDD

[v7u_N003078|3078] The CIP establishes the legal entity’s identity by collecting and verifying:
ZH: CIP通过收集和核实信息来确立法律实体的身份

[v7u_N003079|3079] Registered business name and legal entity type, such as a corporation, partnership, trust, or others.
ZH: CIP收集注册企业名称和法律实体类型（如公司、合伙企业、信托等）

[v7u_N003080|3080] Business Registration Number (BRN) and jurisdiction of incorporation.
ZH: CIP收集商业注册号（BRN）和注册司法管辖区

[v7u_N003081|3081] Tax identification number (TIN) or equivalent.
ZH: 法人客户了解你的客户需收集税务识别号或等效信息。

[v7u_N003082|3082] Principal place of business and contact information.
ZH: 法人客户了解你的客户需收集主要营业地点和联系方式。

[v7u_N003083|3083] Certified articles of incorporation, business license, or trust deeds.
ZH: 法人客户了解你的客户需收集经认证的公司章程、营业执照或信托契约。

[v7u_N003084|3084] CIP is the cornerstone of any AFC compliance program to help ensure that only legitimate legal entities gain access to financial services, thereby reducing financial crime risks including fraud, and exploitation by illicit financial networks.
ZH: 客户身份识别程序（CIP）是金融犯罪防控合规计划的基石，确保只有合法实体获得金融服务。

[v7u_N003085|3085] CDD assesses the entity’s structure, ownership, and transaction patterns, including:
ZH: 客户尽职调查（客户尽职调查）评估实体结构、所有权和交易模式。

[v7u_N003086|3086] Nature of business and industry classification.
ZH: CDD需收集业务性质和行业分类信息。

[v7u_N003087|3087] Expected transaction volumes and financial activities.
ZH: CDD需收集预期交易量和金融活动信息。

[v7u_N003088|3088] Identification and verification of beneficial owners (BO) and ultimate beneficial owners (UBO).
ZH: CDD需识别和验证受益所有人（BO）及最终受益所有人（UBO）。

[v7u_N003089|3089] Verification of directors, senior management, and authorized signatories.
ZH: CDD需验证董事、高级管理层和授权签字人。

[v7u_N003090|3090] CDD is mandatory and varies based on entity risk, jurisdictional requirements, and regulatory expectations.
ZH: 客户尽职调查（客户尽职调查）是强制性的，并根据实体风险、司法管辖区要求和监管期望而变化。

[v7u_N003091|3091] Legal persons that pose a higher financial crime risk require EDD, which includes:
ZH: 高风险法人客户需要强化尽职调查（EDD），包括以下措施。

[v7u_N003092|3092] Complex corporate structure analysis, such as multiple layers of owners, or offshore holdings.
ZH: EDD包括分析复杂的公司结构，如多层所有者或离岸持股。

[v7u_N003093|3093] Source of funds and source of wealth verification.
ZH: EDD包括验证资金来源和财富来源。

[v7u_N003094|3094] PEP and sanctions screening for beneficial owners and directors, is required for all customers.
ZH: 所有客户均需对受益所有人和董事进行政治敏感人物（政治敏感人物）和制裁筛查。

[v7u_N003095|3095] More frequent monitoring and ongoing transaction reviews.
ZH: EDD包括更频繁的监控和持续交易审查。

[v7u_N003096|3096] A holding company with opaque ownership and nominee shareholders would face greater scrutiny than a locally registered company with a clear ownership structure.
ZH: 所有权不透明的控股公司比所有权清晰的本地注册公司面临更严格的审查。

[v7u_N003097|3097] Companies in certain industries, such as MSBs, arms manufacturers, mining companies, gaming and gambling organizations, correspondent banks, and high-value asset dealers, might encounter higher financial crime risks.
ZH: 货币服务企业（货币服务企业）、武器制造商、矿业公司等行业的公司面临更高的金融犯罪风险。

[v7u_N003098|3098] Through the embedding and implementation of a risk-based approach to KYC processes, financial institutions can manage and mitigate financial crime risks more effectively, ensure adherence to regulations, and demonstrate strong overall AFC compliance to investors and customers.
ZH: 基于风险的方法（RBA）有助于金融机构有效管理金融犯罪风险并确保合规。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "CDD的强度根据实体风险、管辖区要求和监管期望而变化",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已能表达该规则依赖关系，且未明确具体动作或结果，无法构成有向程序结构。"
    },
    {
      ...
      "proposition": "高风险法人需要执行强化尽职调查（EDD）",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已能将该规则作为简单事实存储，其内部条件-动作关系不足以形成超出KG的增量结构。"
    },
    {
      ...
      "proposition": "所有客户都需要进行受益所有人和董事的PEP和制裁筛查",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG可将该义务作为全局要求保存；孤立过程缺乏辅助节点难以构图，且不构成复杂有向结构。"
    },
    {
      ...
      "proposition": "所有权不透明的控股公司面临比本地透明公司更严格的审查",
      "decision": "p7c_card",
      "card_id": "p7card_CH42-S08_001",
      "reason": "案例中所有权不透明性直接导向更严格审查的局部判断逻辑，超出基础KG的举例存储。"
    },
    {
      ...
      "proposition": "金融机构实施风险为本方法（RBA）可以更有效地管理金融犯罪风险、确保合规并展示强大合规",
      "decision": "p7c_card",
      "card_id": "p7card_CH42-S08_002",
      "reason": "实施RBA到产生效果的有向动作-结果链，超出基础KG的一般性解释。"
    }
  ],
  "cards": [
    {
      ...
      "flow_nodes": [
        {
          ...
          "label": "法人所有权结构不透明（如控股公司具有不透明所有权和名义股东）",
          "evidence_unit_ids": [
            "v7u_N003096"
          ],
      ...
      "review_notes": "增量命题：法人所有权结构不透明 → 金融机构实施更严格的审查。KG不足：基础KG可能将此案例作为普通举例存储，无法表达所有权不透明性直接导向审查增强的判断逻辑。选项判断：可确认或排除关于所有权透明度与审查强度关系的选项。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH42-S08_002",
      "section_id": "CH42-S08",
      "card_nature": "control",
      "title": "实施风险为本方法（RBA）的效果",
      "flow_nodes": [
        {
          "node_id": "n1_P2",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构将风险为本方法（RBA）嵌入和实施到KYC流程中",
          "evidence_unit_ids": [
            "v7u_N003098"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：金融机构实施RBA → 可能更有效地管理风险、确保合规、展示强大合规。KG不足：基础KG可能将RBA的好处作为一般解释，无法表达实施动作与这些具体结果之间的有向推导链。选项判断：可确认或排除关于RBA实施效果的选项。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
