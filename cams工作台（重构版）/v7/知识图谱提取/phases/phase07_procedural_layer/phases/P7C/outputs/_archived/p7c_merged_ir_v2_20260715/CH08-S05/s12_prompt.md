...
[
  {
    ...
    "proposition": "金融机构必须对SPV和PIV进行强化尽职调查，包括识别最终受益所有人并了解实体真实目的，以确保合规并减轻金融犯罪风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [
        "遵守CDD法规（如FinCEN的CDD规则）"
      ],
      "focal_handling_or_judgment": "对SPV和PIV进行强化尽职调查，包括识别最终受益所有人并了解实体真实目的",
      "outcomes_or_paths": [
        "减轻与SPV相关的潜在金融犯罪风险"
      ]
    },
