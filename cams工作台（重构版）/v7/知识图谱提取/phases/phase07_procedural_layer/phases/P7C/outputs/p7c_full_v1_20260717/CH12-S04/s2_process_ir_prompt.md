...
[
  {
    ...
    "proposition": "高风险客户（如政治敏感人物）和中介需要仔细的风险评估。",
    "source_quotes": [
      "High-risk customers, such as PEPs, and intermediaries require careful risk assessment."
    ],
    "relation_cues": [
      "require"
    ],
    ...
    "evidence_spans": [
      {
        "unit_id": "v7u_N000921",
        "quote": "High-risk customers, such as PEPs, and intermediaries require careful risk assessment."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "持续监控交易活动，并使用基于预设标准的交易监控系统标记可疑交易，可以帮助识别可能表明洗钱的异常模式或行为。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "持续监控并标记可疑交易",
      "outcomes_or_paths": [
        "识别异常模式或行为，如大额交易、快速交易模式、高频交易、涉及高风险管辖区的交易"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000923",
        "quote": "Continuous monitoring of trading activities can help identify unusual patterns or behaviors that might indicate money laundering. Robust transaction monitoring systems that flag suspicious transactions based on predefined criteria can help identify large or unusual trades, rapid trading patterns, highfrequency transactions and transactions involving high-risk jurisdictions."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "进行客户尽职调查有助于确保资金来源合法，并根据预期和历史交易模式正确细分客户。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "进行客户尽职调查（CDD）",
      "outcomes_or_paths": [
        "确保资金来源合法",
        "正确细分客户"
      ]
  ...
  },
  {
    ...
    "proposition": "资产管理公司有义务了解其业务中的洗钱风险，因其处理跨多个司法管辖区、多样且不断变化的资产类别的大量资本，交易常具匿名性，并使用复杂金融产品和第三方。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "资产管理公司处理大量资本，跨多司法管辖区，多样资产类别，匿名交易，使用复杂产品和第三方"
      ],
      "basis_or_condition": [],
  ...
  },
  {
    ...
    "proposition": "房地产投资中，应全面审查所有利益相关者（包括卖方、买方、租户、物业经理和代理人）以降低洗钱风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "全面审查所有利益相关者",
      "outcomes_or_paths": [
        "降低洗钱风险"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "通过采用强调强客户尽职调查和持续监控的风险为本方法，资产管理公司可以满足监管要求并应对新兴资产类别的洗钱风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "采用风险为本方法",
      "outcomes_or_paths": [
        "满足监管要求",
        "展示行业诚信承诺",
        "应对新兴资产类别的洗钱风险"
  ...
  },
  {
    ...
    "proposition": "资产管理公司面临复杂的客户尽职调查过程，需要了解交易涉及的所有方（包括投资基金经理、投资组合经理、另类投资基金经理等）。",
    "source_quotes": [
      "Additionally, asset managers face a complex and evolving CDD process that requires knowledge of all parties involved in the transactions. Those parties include investment fund managers, portfolio managers, and alternative investment fund managers, such as those overseeing hedge funds and private equity."
    ],
    "relation_cues": [
      "requires"
    ],
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "了解交易涉及的所有相关方",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000936",
        "quote": "Additionally, asset managers face a complex and evolving CDD process that requires knowledge of all parties involved in the transactions. Those parties include investment fund managers, portfolio managers, and alternative investment fund managers, such as those overseeing hedge funds and private equity."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选s1c_003仅承接客户尽职调查帮助确保资金来源合法和客户细分，s1c_004仅承接资产管理公司了解洗钱风险，均未承接资产管理公司在复杂的CDD过程中需要了解所有交易方这一独立要求。"
    }
  }
]
```
