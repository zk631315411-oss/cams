...
section_title: `Governance and oversight > Controls across the customer lifecycle`
...
ZH: 结构化的控制框架支持金融犯罪防控合规，帮助金融机构在客户生命周期各阶段有效识别、评估和缓解金融犯罪风险。

[v7u_N002998|2998] The customer lifecycle consists of the following controls:
ZH: 客户生命周期包括以下控制措施。

[v7u_N002999|2999] 1. Identity and verification as part of KYC/CDD at onboarding:
ZH: 开户时作为了解你的客户/客户尽职调查一部分的身份识别与验证。

[v7u_N003000|3000] Identity verification: Validate customer identity through governmentissued documents, biometric authentication, and technological onboarding solutions.
ZH: 通过政府签发的证件、生物识别认证和技术解决方案验证客户身份。

[v7u_N003001|3001] Risk profiling: Assess customer risk based on transaction behavior, industry type, and jurisdictional exposure to assign a risk rating.
ZH: 根据交易行为、行业类型和司法管辖区风险对客户进行风险评级
```
...
[
  {
    ...
    "proposition": "通过政府签发的证件、生物识别认证和技术解决方案验证客户身份。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [
        "通过政府签发的证件、生物识别认证和技术解决方案"
      ],
      "focal_handling_or_judgment": "验证客户身份",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003000",
        "quote": "Identity verification: Validate customer identity through governmentissued documents, biometric authentication, and technological onboarding solutions."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "根据交易行为、行业类型和司法管辖区风险评估客户风险并分配风险评级。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [
        "基于交易行为、行业类型和司法管辖区风险暴露"
      ],
      "focal_handling_or_judgment": "评估客户风险并分配风险评级",
      "outcomes_or_paths": [
        "分配风险评级"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003001",
        "quote": "Risk profiling: Assess customer risk based on transaction behavior, industry type, and jurisdictional exposure to assign a risk rating."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
