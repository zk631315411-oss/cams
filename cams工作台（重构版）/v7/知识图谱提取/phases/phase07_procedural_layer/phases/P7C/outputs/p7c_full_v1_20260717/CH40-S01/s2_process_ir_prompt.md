...
section_title: `Design Your AFC Program and Controls > Introduction: Design your AFC program and controls`

section_text_with_unit_anchors:

```text
[v7u_N002871|2871] An AFC program is the cornerstone of financial crime risk management, ensuring that organizations prevent, detect, mitigate, and report illicit financial activities.
ZH: 金融犯罪防控计划是金融犯罪风险管理的基石，确保组织预防、检测、减轻和报告非法金融活动。

[v7u_N002872|2872] Global standard setters and national regulatory bodies recommend or mandate risk-based AML programs.
ZH: 全球标准制定者和国家监管机构推荐或要求基于风险的反洗钱计划。

[v7u_N002873|2873] Key program components include CDD, EDD, ongoing monitoring, transaction reporting, risk assessments, and governance oversight.
ZH: 金融犯罪防控计划的关键组成部分包括客户尽职调查、EDD、持续监控、交易报告、风险评估和治理监督。

[v7u_N002874|2874] Institutions must regularly update policies to address evolving threats, regulatory changes, and emerging technologies, such as AI-driven financial crime detection.
ZH: 机构必须定期更新政策以应对不断变化的威胁、监管变化和新兴技术。

[v7u_N002875|2875] A globally aware AFC program fosters compliance, resilience, and financial integrity, safeguarding institutions against money laundering, terrorist financing, and sanctions violations.
ZH: 具有全球视野的金融犯罪防控计划促进合规、韧性和金融诚信，保护机构免受洗钱、恐怖融资和制裁违规的影响。
```
...
[
  {
    "candidate_id": "s1c_gap_ch40_s01_policy_update",
    "unit_ids": [
      "v7u_N002874"
    ],
    "proposition": "机构必须定期更新政策以应对不断变化的威胁、监管变化和新兴技术。",
    "source_quotes": [
      "Institutions must regularly update policies to address evolving threats, regulatory changes, and emerging technologies, such as AI-driven financial crime detection."
    ],
    "relation_cues": [
      "must",
      "to"
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "定期更新政策",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002874",
        "quote": "Institutions must regularly update policies to address evolving threats, regulatory changes, and emerging technologies, such as AI-driven financial crime detection."
      }
    ],
    "induction": null,
    ...
    "gap_evidence": {
      ...
      "gap_reason": "S1.1未生成任何候选，该条件处置链（机构必须定期更新政策以应对变化）未被覆盖。"
    }
  }
]
```
