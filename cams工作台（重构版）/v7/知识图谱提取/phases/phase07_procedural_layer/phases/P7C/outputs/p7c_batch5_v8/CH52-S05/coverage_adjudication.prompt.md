...
section_title: `Technology and tools used across the customer life cycle > Open-source intelligence`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "开源情报（OSINT）定义、应用、工具与关键考虑",
      "title_en": "OSINT definition, applications, tools, and key considerations",
      "covered_units": [
        {
          "unit_id": "v7u_N004004",
...
```text
[v7u_N004004|4004] Open-source intelligence (OSINT) is the collection and analysis of information from publicly available sources.
ZH: 开源情报（OSINT）是从公开来源收集和分析信息

[v7u_N004005|4005] OSINT has long been a vital tool for sectors such as law enforcement, government agencies, and financial institutions.
ZH: OSINT长期以来是执法、政府机构和金融机构的重要工具

[v7u_N004006|4006] Recently, OSINT techniques have gained popularity in the broader commercial space, particularly as companies seek to strengthen their due diligence and KYC practices.
ZH: OSINT技术近期在商业领域流行，用于加强尽职调查和了解你的客户实践

[v7u_N004007|4007] By leveraging publicly available information, organizations can assess reputational risks, detect potential red flags, and build more comprehensive client profiles—all while staying within legal and ethical boundaries. OSINT harnesses the vast amount of data available online to supplement traditional internal sources of information.
ZH: OSINT利用公开信息评估声誉风险、检测红旗信号信号并构建更全面的客户画像

[v7u_N004008|4008] Numerous OSINT tools and techniques are available today, ranging from basic to highly sophisticated.
ZH: 现有多种OSINT工具和技术，从基础到高度复杂

[v7u_N004009|4009] The most obvious and widely used tool is the search engine, which serves as the entry point to uncovering vast amounts of publicly available data. Search engines can find news articles, regulatory notices, social media activity, and archived websites that provide valuable context about individuals or organizations.
ZH: 搜索引擎是最常用OSINT工具，可发现新闻、监管通知、社交媒体和存档网站

[v7u_N004010|4010] Beyond search engines, other techniques include: social media monitoring to evaluate public profiles and connections; news and media scans to track any adverse mentions; and web scraping tools to extract structured data from websites or online databases.
ZH: 其他OSINT技术包括社交媒体监控、新闻扫描和网络爬取

[v7u_N004011|4011] OSINT draws information from sources that may be unreliable, so analysts should confirm the source of information to be able to rely on it.
ZH: 分析师必须确认OSINT信息来源的可靠性才能依赖

[v7u_N004012|4012] Importantly, OSINT relies only on information that is publicly accessible. It excludes any proprietary, confidential, or internal data and focuses solely on open sources—content that anyone can access without special credentials.
ZH: OSINT仅依赖公开可访问的信息，不包括专有或内部数据

[v7u_N004013|4013] These sources can include social media platforms, corporate websites, government databases, press releases, and online news outlets.
ZH: OSINT来源包括社交媒体、公司网站、政府数据库、新闻稿和在线新闻

[v7u_N004014|4014] Since OSINT involves analyzing data already in the public domain, it allows organizations to enhance their risk assessments and investigative capabilities without violating privacy laws.
ZH: OSINT可在不违反隐私法的情况下增强风险评估和调查能力

[v7u_N004015|4015] When used responsibly, OSINT empowers organizations to make more-informed decisions while reinforcing transparency, accountability, and regulatory compliance.
ZH: 负责任使用OSINT有助于更明智决策并加强透明度、问责和合规
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "OSINT是从公开来源收集和分析信息",
      "decision": "kg_only",
      "card_id": null,
    ...
    },
    {
      ...
      "proposition": "OSINT长期以来是执法、政府机构和金融机构的重要工具",
      "decision": "kg_only",
      "card_id": null,
    ...
    },
    {
      ...
      "proposition": "OSINT技术近期用于加强尽职调查和KYC实践",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般应用说明，无具体主体动作或判断"
    },
    {
      ...
      "proposition": "组织利用OSINT评估声誉风险、检测红旗并构建客户画像",
      "decision": "kg_only",
      "card_id": null,
      "reason": "功能描述，无独立结果或条件分支，基础KG已表达"
    },
    {
      ...
      "proposition": "存在多种OSINT工具和技术",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯分类，基础KG可充分表达"
    },
    {
      ...
      "proposition": "搜索引擎是最常用OSINT工具，可发现各类公开数据",
      "decision": "kg_only",
      "card_id": null,
      "reason": "事实描述，无程序性有向结构"
    },
    {
      ...
      "proposition": "其他OSINT技术包括社交媒体监控、新闻扫描和网络爬取",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术列表，基础KG可充分表达"
    },
    {
      ...
      "proposition": "在OSINT来源可能不可靠的条件下，分析师应当确认信息来源的可靠性",
      "decision": "p7c_card",
      "card_id": "p7card_CH52-S05_001",
      "reason": "明确了特定主体（分析师）的条件化义务动作，构成程序性有向关系，基础KG无法表达主体职责和条件触发"
    },
    {
    ...
    },
    {
      ...
      "proposition": "OSINT来源包括社交媒体、公司网站、政府数据库等",
      "decision": "kg_only",
      "card_id": null,
      "reason": "来源列表，基础KG可充分表达"
    },
    {
      ...
      "proposition": "OSINT允许组织不违反隐私法地增强风险评估和调查能力",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般因果陈述，无程序性有向结构"
    },
    {
      ...
      "proposition": "负责任使用OSINT有助于更明智决策并加强透明度、问责和合规",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般好处陈述，无明确主体动作或独立结果"
    }
  ],
  "cards": [
    {
      ...
      "flow_edges": [
        {
          ...
          "condition": "OSINT来源可能不可靠",
          "source_quote": "OSINT draws information from sources that may be unreliable, so analysts should confirm the source of information..."
        }
      ],
      "source_unit_ids": [
        "v7u_N004011"
      ...
      "review_notes": "增量命题：在OSINT来源可能不可靠的条件下（E1），分析师应当确认信息来源的可靠性（P1）；KG不足：基础KG只能将来源不可靠表述为风险指标，无法表达条件触发的主体义务动作；选项判断：可确认分析师在OSINT使用中的验证职责；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
