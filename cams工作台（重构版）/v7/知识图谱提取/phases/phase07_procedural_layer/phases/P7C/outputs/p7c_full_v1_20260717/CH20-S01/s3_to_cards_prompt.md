  ...
  "candidate_audit": [
    {
      ...
      "episode_ids": [],
      "reason": "候选描述的是《联合国宪章》作为风险管理倡议的一部分赋予安理会实施制裁的权力，属于静态的法律授权陈述，未构成业务处理、判断或行动迁移的流程。"
    }
  ],
  "skip_reason": "本节内容为介绍联合国及其下属机构在反金融犯罪领域的角色、倡议和授权，多为描述性信息，未涉及具体的业务流程、判断或行动迁移，不构成流程。"
}
```
