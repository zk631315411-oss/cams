...
[
  {
    ...
    "proposition": "FullTechGlobal案引发对英国反贿赂法域外适用的关切；该法适用于有英国关联的公司，并规定母公司对子公司腐败负责。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "客户FullTechGlobal是英国公司的子公司并面临海外贿赂指控"
      ],
      "basis_or_condition": [
        "英国反贿赂法的域外条款"
      ],
      "focal_handling_or_judgment": "判断该法适用于本案",
      "outcomes_or_paths": [
        "引发域外管辖关切，可能导致起诉"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "Sophie的调查揭示FullTechGlobal在高风险地区雇佣中间人，通过虚增费用、伪造发票和壳公司掩盖资金流动，并向官员提供贿赂。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "识别腐败行为",
      "outcomes_or_paths": [
        "揭露中间人安排、财务掩饰和贿赂行为"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "Sophie的审查发现FullTechGlobal的ABC框架和内部控制存在缺陷。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "评估内部控制有效性",
      "outcomes_or_paths": [
        "发现系统性缺陷，导致腐败活动长期未被发现"
      ]
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "认定洗钱的上游犯罪",
      "outcomes_or_paths": [
        "通过复杂金融网络洗钱"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "FullTechGlobal面临严厉罚款、国际监管审查和刑事责任。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "评估监管后果",
      "outcomes_or_paths": [
        "严重罚款、国际监管审查、刑事责任"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "Sophie认识到机构需维护合规诚信并降低贿赂风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "FullTechGlobal案带来的经验教训"
      ],
      "basis_or_condition": [
        "合规诚信要求"
      ],
      "focal_handling_or_judgment": "维护合规诚信",
      "outcomes_or_paths": [
        "降低贿赂和腐败风险"
      ]
    },
