...
<[
  {
    ...
    "proposition": "环境犯罪（作为上游犯罪）在活动前和活动中难以被检测到。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "犯罪组织可通过环境犯罪同时赚取和清洗资金。",
    "source_quotes": [
      "environmental crimes offer the opportunity to both earn and launder funds simultaneously"
    ]
  },
  {
    ...
    "proposition": "当当局调查非法活动时，他们常常受到腐败政府官员的阻碍（官员已收受贿赂以阻止或隐藏调查）。",
    "source_quotes": [
      "When authorities investigate the illicit activity, they often become hindered by corrupt government officials who have been bribed to block or hide the inquiry."
    ]
  },
  {
    ...
    "proposition": "在环境犯罪案件中，由于经常涉及跨国犯罪组织、活动难以检测且相关法规复杂，提起刑事指控困难。",
    "source_quotes": [
      "It is difficult to pursue criminal charges for the following reasons:",
