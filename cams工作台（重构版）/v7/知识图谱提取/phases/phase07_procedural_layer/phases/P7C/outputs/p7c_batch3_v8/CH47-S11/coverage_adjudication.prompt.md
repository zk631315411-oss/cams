...
section_title: `Transaction monitoring > Communication channels and tipping off`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "通过客户沟通获取信息",
      "title_en": "Obtaining information through customer outreach",
      "covered_units": [
        {
          "unit_id": "v7u_N003362",
          "unit_type": "process",
    ...
    {
      "title_zh": "客户沟通的沟通要求",
      "title_en": "Communication requirements for customer outreach",
      "covered_units": [
        {
          "unit_id": "v7u_N003365",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "通过客户沟通获取信息",
      "target_title": "客户沟通的沟通要求",
...
```text
[v7u_N003361|3361] Analysts responsible for transaction monitoring alert reviews and AML investigations might require information that is not available through internal data or publicly available sources. This information could be related to unusual customer transactions, changes in KYC data, the customer’s business invoices or operation documentation, or other relevant data.
ZH: 分析师在交易监控和反洗钱调查中可能需要内部或公开来源无法获取的信息。

[v7u_N003362|3362] Relationship managers or front line staff can obtain this information by contacting the customer, organizational partners, such as other financial institutions, or correspondent branches. Relationship managers and front line staff are best positioned to conduct customer outreach and communicate findings to analysts.
ZH: 客户经理或一线员工可通过联系客户、合作机构或代理行获取信息，并反馈给分析师。

[v7u_N003363|3363] Staff must remember to maintain confidentiality and avoid tipping off the customer.
ZH: 员工必须保持保密，避免向客户通风报信。

[v7u_N003364|3364] Before conducting outreach, the analyst should ensure that the requested information is critical for making an informed determination, and not available internally or externally. If both conditions are met, analysts should consider the best outreach methods and plan accordingly. During outreach, anyone who communicates with the customer should consider:
ZH: 分析师在开展客户沟通前应确保信息关键且无法内部或外部获取，并规划最佳沟通方式。

[v7u_N003365|3365] Confidentiality: Ensure that sensitive information is shared securely and only with authorized parties.
ZH: 确保敏感信息安全共享，仅限授权方知悉。

[v7u_N003366|3366] Clarity and precision: Be clear and precise to avoid misunderstandings or misinterpretation.
ZH: 沟通应清晰准确，避免误解。

[v7u_N003367|3367] Professionalism: Maintain a professional tone in all communications, for credibility and to reflect the organization’s standards.
ZH: 在所有沟通中保持专业语气，以体现机构标准。

[v7u_N003368|3368] How to avoid tipping off: Tipping off occurs when an investigator intentionally or unintentionally alerts the subject of an investigation that their activities are being monitored, particularly with suspicions of money laundering or financial crimes. Tipping off is prohibited under AML regulations and can have severe consequences including criminal liability, regulatory sanctions, and reputational damage.
ZH: 通风报信指调查人员有意或无意向调查对象透露监控行为，反洗钱法规禁止此举，违者可能面临刑事责任、监管制裁和声誉损害。

[v7u_N003369|3369] Compliance with regulations: Adhere to legal and regulatory guidelines, such as data protection laws, that govern communications involving sensitive information.
ZH: 遵守涉及敏感信息沟通的法律和监管指南，如数据保护法。

[v7u_N003370|3370] Documentation: Record all communications, dates, times, and the content discussed for accountability and audit purposes.
ZH: 记录所有沟通的日期、时间和内容，以备问责和审计。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "分析师需要额外信息时，客户经理联系客户等获取信息并反馈给分析师。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已充分表达了通过客户沟通获取信息的流程，无额外判断性结构。"
    },
    {
      ...
      "proposition": "员工必须保持保密，避免向客户通风报信。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立义务规则，基础KG可保存。"
    },
    {
      ...
      "proposition": "在所需信息关键且不可得的条件下，分析师应规划沟通方式，然后客户经理执行客户沟通并反馈。",
      "decision": "p7c_card",
      "card_id": "p7card_CH47-S11_001",
      "reason": "条件触发分析师计划到客户经理执行的职责链和条件判断，超出基础KG的静态规则描述。"
    },
    {
      ...
      "proposition": "客户沟通中应遵守保密、清晰、专业、合规、记录等要求。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "规则列表，基础KG已覆盖为“客户沟通的沟通要求”。"
    }
  ],
  "cards": [
    {
      ...
      "title": "客户沟通的条件触发与执行流程",
      "flow_nodes": [
        {
          "node_id": "E1",
          "node_category": "entry",
          "node_type": "E6_change_exception",
          "label": "所需信息关键且无法从内部或外部获取",
          "evidence_unit_ids": [
            "v7u_N003364"
          ],
        ...
        },
        {
          ...
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "客户经理联系客户、合作机构或代理行获取信息并传达给分析师",
          "evidence_unit_ids": [
            "v7u_N003362"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "condition": "If both conditions are met (information critical and not available internally or externally), before conducting outreach",
          "source_quote": "If both conditions are met, analysts should consider the best outreach methods and plan accordingly."
        },
        {
          "edge_id": "edge_2",
          "edge_type": "PRECEDES",
      ...
      "review_notes": "增量命题：在所需信息关键且不可得的条件下，分析师应规划沟通方式，然后由客户经理执行客户沟通并反馈给分析师（条件：信息关键且不可得；PRECEDES链）。KG不足：基础KG仅单独列出“通过客户沟通获取信息”和“客户沟通的沟通要求”，未表达条件触发分析师计划再到客户经理执行的职责序列和条件判断。选项判断：可确认沟通前需要满足的条件、分析师与客户经理的职责分工及流程顺序。LLM推理：edge_2为llm_inference，因为原文未明确说明分析师计划后立即由客户经理执行，但分析师的计划是为后续沟通做准备，且客户经理是执行沟通的主体，因此该顺序为必要功能推断。"
    }
  ],
  "skip_reason": null
}
