...
<[
  {
    ...
    "proposition": "如果银行知道或怀疑客户使用非法资金偿还贷款，银行不应接受该资金用于还贷。",
    "source_quotes": [
      "If the bank knows or suspects the customer is using illicit funds to repay the loan, ... should not accept funds for the purposes of loan"
    ]
  },
  {
    ...
    "proposition": "当银行退出超出风险容忍度的客户关系且存在贷款余额时，核销贷款是重大财务决策，通常需要广泛证明和批准。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "如果银行未能有效管理因客户仍有贷款余额而关闭账户的挑战，会损害银行声誉并削弱监管机构和客户的信任。",
    "source_quotes": [
