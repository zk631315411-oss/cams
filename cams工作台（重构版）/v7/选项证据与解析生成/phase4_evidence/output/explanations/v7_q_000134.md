...
FATF建议要求各司法辖区设立金融情报机构（FIU），用于分析可疑交易报告并支持执法调查（P149）；根据FATF标准和埃格蒙特集团原则，各国FIU还应自发或应请求相互传播金融情报（P231）。因此，如果资金流经国中有国家未设立FIU，该国就无法通过FIU正常参与这一标准的**FIU间情报交换流程**，从而增加在所有相关国家协调调查的难度。四个选项中，C最直接描述了组织机构缺位造成的跨境协作障碍。
