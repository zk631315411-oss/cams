...
section_title: `Introduction > Introduction: Components of an AFC program`

section_text_with_unit_anchors:

```text
[v7u_N002358|2358] A robust AFC program protects organizations from financial crimes, legal infractions, and reputational damage.
ZH: 稳健的金融犯罪防控计划保护机构免受金融犯罪、法律违规和声誉损害

[v7u_N002359|2359] To succeed, organizations have to identify the risks they face in doing business and manage those risks carefully.
ZH: 机构必须识别业务风险并谨慎管理这些风险

[v7u_N002360|2360] An AFC program includes risk assessment, control evaluation, identifying weaknesses, building effective controls, and ongoing testing and monitoring to meet legal and regulatory obligations.
ZH: 金融犯罪防控计划包括风险评估、控制评估、识别弱点、建立有效控制以及持续测试和监控

[v7u_N002361|2361] Studying the components of an AFC program gives learners an overview of each element and its relevance and purpose in meeting obligations. It also shows how the components work together to build a robust defense against financial crime.
ZH: 学习金融犯罪防控项目各组成部分的目的与整体防御作用
```
...
[
  {
    ...
    "proposition": "为了成功，机构必须识别业务风险并谨慎管理这些风险。",
    "source_quotes": [
      "To succeed, organizations have to identify the risks they face in doing business and manage those risks carefully."
    ],
    "relation_cues": [
      "to",
      "have to"
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "机构必须识别并管理风险",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002359",
        "quote": "To succeed, organizations have to identify the risks they face in doing business and manage those risks carefully."
      }
    ],
    "induction": null,
