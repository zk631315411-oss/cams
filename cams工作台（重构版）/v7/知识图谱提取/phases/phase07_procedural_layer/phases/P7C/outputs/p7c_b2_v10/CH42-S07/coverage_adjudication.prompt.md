...
section_title: `Onboarding AFC controls > KYC for a natural person`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "自然人KYC：定义与组成部分",
      "title_en": "KYC for Natural Person: Definition and Components",
      "covered_units": [
        {
          "unit_id": "v7u_N003054",
    ...
    {
      "title_zh": "风险为本的KYC方法及益处",
      "title_en": "Risk-Based KYC Approach and Benefits",
      "covered_units": [
        {
          "unit_id": "v7u_N003056",
          "unit_type": "fact",
    ...
    {
      "title_zh": "CIP核心要求",
      "title_en": "CIP Core Requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003057",
          "unit_type": "classification",
  ...
  "covered_relations": [
    {
      "source_title": "自然人KYC：定义与组成部分",
      "target_title": "CIP核心要求",
...
```text
[v7u_N003054|3054] The KYC process for a natural person is a critical element of AFC compliance, ensuring that financial institutions accurately verify a customer’s identity, assess risk exposure, and monitor financial activities.
ZH: 自然人了解你的客户流程是金融犯罪防控合规的关键要素，确保准确核实身份、评估风险并监控活动

[v7u_N003055|3055] The process consists of the customer identification program (CIP) and additional due diligence.
ZH: 了解你的客户流程包括客户身份识别程序（CIP）和额外尽职调查

[v7u_N003056|3056] As global regulations evolve, financial institutions benefit from adopting advanced identity verification methods, risk-based monitoring, and beneficial ownership transparency measures to strengthen compliance frameworks.
ZH: 随着全球法规演变，金融机构应采用先进身份验证、风险监控和受益所有人透明度措施以加强合规框架

[v7u_N003057|3057] CIP is the first step in KYC, requiring financial institutions to collect and verify the identity of individual customers. Core requirements for verifying a natural person’s identity include:
ZH: CIP是了解你的客户的第一步，要求收集和核实个人客户身份，核心要求包括

[v7u_N003058|3058] Full legal name, as per government-issued ID
ZH: 根据政府签发身份证件的完整法定姓名

[v7u_N003059|3059] Date of birth, confirming age and identity legitimacy
ZH: 出生日期，确认年龄和身份合法性

[v7u_N003060|3060] Nationality and residential address, confirming proof of residence
ZH: 国籍和居住地址，确认居住证明

[v7u_N003061|3061] Government-issued identification, such as a passport, national ID, or driver’s license
ZH: 自然人了解你的客户的身份证明文件包括护照、国民身份证或驾照

[v7u_N003062|3062] Tax Identification Number (TIN), Social Security Number (SSN), or equivalent
ZH: 自然人了解你的客户需收集税号、社保号或等效号码

[v7u_N003063|3063] The requirements for identifying a customer vary by jurisdiction.
ZH: 客户身份识别要求因司法管辖区而异

[v7u_N003064|3064] CIP ensures that only legitimate customers access financial services, while reducing identity fraud and financial crime risks.
ZH: 客户身份识别程序（CIP）旨在确保只有合法客户获得金融服务，减少身份欺诈和金融犯罪风险

[v7u_N003065|3065] CDD assesses the customer’s risk level, financial behavior, and expected transactions, including, but not limited to:
ZH: 客户尽职调查（客户尽职调查）评估客户风险等级、财务行为和预期交易

[v7u_N003066|3066] Employment and income information.
ZH: CDD需收集就业和收入信息

[v7u_N003067|3067] Source of funds and transaction activity.
ZH: CDD需收集资金来源和交易活动信息

[v7u_N003068|3068] Account’s purpose and expected activity.
ZH: CDD需收集账户用途和预期活动信息

[v7u_N003069|3069] CDD is mandatory for all customers, with ongoing monitoring to ensure compliance with evolving AFC regulations.
ZH: 所有客户均须执行客户尽职调查，并持续监控以确保符合不断变化的金融犯罪防控法规

[v7u_N003070|3070] EDD is typically required for high-risk customers, such as PEPs or individuals operating in high-risk jurisdictions. EDD includes, but is not limited to:
ZH: 高风险客户（如政治敏感人物）通常需要强化尽职调查（EDD）

[v7u_N003071|3071] Comprehensive source of wealth and funds verification.
ZH: EDD包括全面的财富和资金来源验证

[v7u_N003072|3072] Enhanced transaction monitoring and more frequent reviews.
ZH: EDD包括强化交易监控和更频繁的审查

[v7u_N003073|3073] Additional adverse media screening.
ZH: EDD包括额外的不良媒体筛查

[v7u_N003074|3074] More frequent sanctions screening against UN, EU, and OFAC watchlists.
ZH: EDD包括更频繁地针对联合国、欧盟和OFAC制裁名单进行筛查

[v7u_N003075|3075] By implementing dynamic, risk-based KYC controls, financial institutions enhance AFC compliance, mitigate illicit finance risks, and uphold regulatory obligations.
ZH: 实施动态、基于风险的了解你的客户控制可增强金融犯罪防控合规、降低非法金融风险并履行监管义务
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "当客户属于高风险（如PEP或高风险辖区）时，金融机构通常对其实施EDD。",
      "decision": "p7c_card",
      "card_id": "p7card_CH42-S07_001",
      "reason": "高风险条件触发金融机构执行EDD的有向动作关系，基础KG无法表达此条件-动作链。"
    },
    {
      ...
      "proposition": "金融机构必须对所有客户执行CDD并持续监控。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该规则已由基础KG作为整体规则保存，内部无进一步条件分支或独立结果，其有向结构仅为通用义务，无增量判断价值。"
    },
    {
      ...
      "proposition": "客户身份识别要求因司法管辖区而异。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅为事实陈述，无明确主体动作或判断导向，基础KG足以表达。"
    },
    {
      ...
      "proposition": "CIP第一步要求金融机构收集和验证客户身份。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "属于CIP过程定义的基础步骤，无特定条件或判断，基础KG已涵盖CIP的定义和组成。"
    }
  ],
  "cards": [
    {
      ...
      "section_id": "CH42-S07",
      "card_nature": "control",
      "title": "EDD Triggering for High-Risk Customers",
      "flow_nodes": [
        {
          "node_id": "n1_entry",
          "node_category": "entry",
          "node_type": "E6_change_exception",
          "label": "客户被识别为高风险（如PEP或高风险辖区运营）",
          "evidence_unit_ids": [
            "v7u_N003070"
          ],
      ...
      "flow_edges": [
        {
          ...
          "condition": "客户属于高风险（如PEP或高风险辖区运营）",
          "relation_type": null
        }
      ],
      "source_unit_ids": [
      ...
      "review_notes": "增量命题：客户被识别为高风险 → 金融机构通常实施EDD（条件：客户属于高风险如PEP或高风险辖区）；KG不足：基础KG只能表达EDD适用于高风险客户的事实，无法表达条件触发金融机构执行EDD的有向动作关系；选项判断：可确认或排除关于EDD适用范围的选项，高风险触发EDD而非普遍适用；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
