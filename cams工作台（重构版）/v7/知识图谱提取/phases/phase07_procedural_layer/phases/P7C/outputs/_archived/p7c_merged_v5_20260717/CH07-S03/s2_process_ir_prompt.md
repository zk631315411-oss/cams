...
[
  {
    ...
    "proposition": "若银行知道或怀疑客户使用非法资金还贷，则不应接受该资金用于还贷。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "不应接受该资金用于还贷",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只承接了银行知道或怀疑非法资金还贷时不应接受资金的规则，没有承接退出客户关系且仍有贷款余额时核销通常需要理由和批准这一独立处置链。"
    }
  }
]
```
