...
section_title: `Technology for KYC > Biometric technology`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "生物识别技术的定义和类型",
      "title_en": "Definition and Types of Biometric Technology",
      "covered_units": [
        {
          "unit_id": "v7u_N004118",
    ...
    {
      "title_zh": "生物识别技术在全客户识中的益处和应用",
      "title_en": "Benefits and Applications of Biometric Technology in KYC",
      "covered_units": [
        {
          "unit_id": "v7u_N004125",
          "unit_type": "fact",
    ...
    {
      "title_zh": "生物识别数据的风险与监管挑战",
      "title_en": "Risks and Regulatory Challenges of Biometric Data",
      "covered_units": [
        {
          "unit_id": "v7u_N004133",
  ...
  "covered_relations": [
    {
      "source_title": "生物识别技术的定义和类型",
      "target_title": "生物识别技术在全客户识中的益处和应用",
      "relation_type": "prepares"
    },
    {
      "source_title": "生物识别技术的定义和类型",
      "target_title": "生物识别数据的风险与监管挑战",
      "relation_type": "prepares"
    },
    {
      "source_title": "生物识别技术在全客户识中的益处和应用",
      "target_title": "生物识别数据的风险与监管挑战",
...
```text
[v7u_N004118|4118] Biometric technology identifies and verifies individuals based on their unique biological and behavioral characteristics, such as fingerprints, facial features, or voice.
ZH: 生物识别技术基于指纹、面部或声音等特征识别个人身份。

[v7u_N004119|4119] Organizations can extract distinguishing biometric features for biometric recognition.
ZH: 机构可提取区分性生物特征用于生物识别。

[v7u_N004120|4120] We frequently use biometric technology in daily life, such as when unlocking a phone using a fingerprint or accessing a banking app with live facial recognition.
ZH: 日常生活中常用生物识别技术，如指纹解锁手机或人脸识别登录银行应用。

[v7u_N004121|4121] Biometric data falls into two main categories: physiological and behavioral.
ZH: 生物特征数据分为生理和行为两大类

[v7u_N004122|4122] Physiological biometrics include physical, structural, and constant attributes such as fingerprints, facial features, iris patterns, and voice.
ZH: 生理生物特征包括指纹、面部特征、虹膜图案和声音等物理、结构性和恒定属性

[v7u_N004123|4123] Behavioral biometrics involves monitoring distinctive characteristics of movements, gestures, and motor skills as individuals perform tasks.
ZH: 行为生物特征通过监测个人执行任务时的独特动作、手势和运动技能来识别

[v7u_N004124|4124] Examples include unique keystroke patterns, specific motions while using devices, geolocation patterns, and behavior patterns while buying.
ZH: 行为生物特征示例包括独特的按键模式、设备使用动作、地理位置模式和购买行为模式

[v7u_N004125|4125] The KYC process increasingly uses biometric technology to enhance security, efficiency, and user experience.
ZH: 了解你的客户流程越来越多地使用生物特征技术来增强安全性、效率和用户体验

[v7u_N004126|4126] Biometric data's uniqueness makes it extremely difficult to replicate, significantly reducing identity theft and fraud risks.
ZH: 生物特征数据的独特性使其极难复制，显著降低身份盗窃和欺诈风险

[v7u_N004127|4127] Using biometrics for verification purposes, institutions can enhance process efficiency and speed compared to traditional methods.
ZH: 使用生物特征进行验证可提高流程效率和速度，优于传统方法

[v7u_N004128|4128] The technology provides higher accuracy than manual processes, reducing errors and minimizing false positives or negatives.
ZH: 生物特征技术比人工流程更准确，减少错误并最小化误报或漏报

[v7u_N004129|4129] It also improves the overall user experience due to the convenience it offers compared to remembering passwords or carrying physical documents.
ZH: 生物特征技术通过便利性改善用户体验，无需记住密码或携带实体文件

[v7u_N004130|4130] In addition to the KYC process during onboarding, biometric technology is used for customer verification when customers access their accounts or execute transactions.
ZH: 生物特征技术不仅用于开户时的了解你的客户，还用于客户访问账户或执行交易时的验证

[v7u_N004131|4131] Additional benefits of biometric technology include cost savings by reducing the need for manual controls, saving time and resources.
ZH: 生物特征技术的额外好处包括通过减少人工控制来节省成本、时间和资源

[v7u_N004132|4132] The technology also helps institutions comply with regulatory requirements by providing a robust and secure method of identity verification.
ZH: 生物特征技术通过提供稳健安全的身份验证方法，帮助机构满足监管要求

[v7u_N004133|4133] However, biometric data is extremely sensitive and personal. If compromised, it can lead to severe privacy violations and identity theft.
ZH: 生物特征数据极其敏感，一旦泄露可能导致严重的隐私侵犯和身份盗窃

[v7u_N004134|4134] In countries with strict data protection laws, such as the GDPR in the EU, institutions must follow stringent guidelines on collecting, storing, and using biometric information.
ZH: 在数据保护严格的国家（如欧盟《通用数据保护条例》），机构必须遵循生物特征信息收集、存储和使用的严格准则

[v7u_N004135|4135] Implementing and maintaining biometric technology may also involve higher costs for institutions.
ZH: 实施和维护生物特征技术可能给机构带来较高成本
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "当客户访问账户或执行交易时，机构使用生物特征技术进行客户验证",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已能表达生物特征技术在客户验证中的应用场景，无需提取特定的判断或程序性有向结构。"
    },
    {
      ...
      "proposition": "在数据保护严格的国家，机构必须遵循生物特征信息收集、存储和使用的严格准则",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该监管义务属于一般规则，基础KG可将其作为事实规则保存，未形成具体的判断链或程序性结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达当前section的内容，或不存在证据支持的增量程序性或判断性有向结构。"
}
```
