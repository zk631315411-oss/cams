...
FATF 禁止向客户披露 SAR 提交情况的核心反泄密原则

## 【核心解析】

向客户披露可疑活动报告内容构成一项被禁止的违法行为，称为「通风报信」（P353）。法规禁止金融机构向除执法机构外的任何人披露 SAR，或任何能表明已提交 SAR 的信息（P353）。本题中，选项 A 准确表达了这一核心义务——报告实体不得向客户或第三方披露 SAR 已提交或正在受调查的情况，直接对应教材中对「通风报信」的禁止性规定。

## 【错误项分析】

- **B 错误（教材直接依据）｜范围或程度偏差**：教材指出，即使在机构内部，SAR 也应谨慎处理，并非所有人都应有权访问此类信息（P352）。这意味着内部共享有严格的访问限制，而非可以随意分享「一般信息」。相比之下，A 的禁止性义务更直接吻合 FATF 对「通风报信」的核心规定。
- **C 错误（教材定义应用）｜概念混淆**：向客户披露 SAR 内容直接构成「通风报信」违法行为（P353）。以「透明度」为由告知客户与 FATF 规则完全相反。题干更支持 A 的禁止立场，而非 C 的主动告知要求。
- **D 错误（教材定义应用）｜证据不足**：教材提到，在决定提交 SAR 之前，机构可能需要进一步调研以获取更多信息（P346），但从未允许与客户讨论可疑活动。与客户讨论实质上是变相「通风报信」，与 A 的禁止义务根本冲突。

## 【易错提醒】

「通风报信」不仅禁止直接说「我们已提交了您的 SAR」，也禁止任何能暗示客户正被调查的信息。对内部人员同样有限制，不是所有员工都有权接触 SAR。
