...
section_title: `Transaction monitoring > Analysis of information`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "将收集的数据转化为可操作情报",
      "title_en": "Transforming Collected Data into Actionable Intelligence",
      "covered_units": [
        {
          "unit_id": "v7u_N003397",
          "unit_type": "rule",
    ...
    {
      "title_zh": "关系映射与网络分析",
      "title_en": "Relationship Mapping and Network Analysis",
      "covered_units": [
        {
          "unit_id": "v7u_N003399",
          "unit_type": "rule",
    ...
    {
      "title_zh": "现金与资金流分析考量",
      "title_en": "Cash and Fund Flow Analysis Considerations",
      "covered_units": [
        {
          "unit_id": "v7u_N003402",
    ...
    {
      "title_zh": "发现新网络与上报",
      "title_en": "Discovering New Networks and Escalation",
      "covered_units": [
        {
          "unit_id": "v7u_N003408",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "将收集的数据转化为可操作情报",
      "target_title": "关系映射与网络分析",
      "relation_type": "prepares"
    },
    {
      "source_title": "将收集的数据转化为可操作情报",
      "target_title": "现金与资金流分析考量",
      "relation_type": "prepares"
    },
    {
      "source_title": "关系映射与网络分析",
      "target_title": "现金与资金流分析考量",
      "relation_type": "parallels"
    },
    {
      "source_title": "关系映射与网络分析",
      "target_title": "发现新网络与上报",
      "relation_type": "prepares"
    },
    {
      "source_title": "现金与资金流分析考量",
      "target_title": "发现新网络与上报",
      "relation_type": "prepares"
    }
  ]
...
```text
[v7u_N003396|3396] Throughout the transaction monitoring alert review and AML investigation processes, analysts and investigators collect and document data from internal and external sources.
ZH: 交易监控和反洗钱调查中收集内外部数据

[v7u_N003397|3397] However, investigators must go beyond merely gathering and recording this information. They analyze the data to transform it into actionable intelligence and insights.
ZH: 调查员需分析数据以转化为可操作情报

[v7u_N003398|3398] By examining transaction histories, customer profiles, and regulatory alerts, analysts can validate suspicions and decide if further investigation, reporting, or action is warranted.
ZH: 通过审查交易历史、客户资料和监管警报验证可疑点

[v7u_N003399|3399] During the investigation, investigators must seek to understand relationships and cash and fund flows.
ZH: 调查中需理解关系及资金流向

[v7u_N003400|3400] Investigators identify and map relevant relationships between individuals and entities, such as customers, counterparties, beneficial owners, relatives and beneficiaries, and parent companies and subsidiaries.
ZH: 调查员识别并映射个人与实体之间的相关关系

[v7u_N003401|3401] Network analysis helps visualize complex relationships and transaction flows. It allows AFC professionals to represent connections graphically, identify behavioral patterns, and clarify complicated relationships associated with money laundering.
ZH: 网络分析帮助可视化复杂关系和交易流，识别洗钱行为模式。

[v7u_N003402|3402] Analyzing cash and fund flows helps assess transaction legitimacy and identify potential illicit activity. This process involves tracing the movement of funds across accounts and financial institutions. Key considerations include:
ZH: 分析现金和资金流以评估交易合法性并识别潜在非法活动。

[v7u_N003403|3403] Transaction patterns: Evaluate the frequency, volume, and timing of transactions to identify unusual spikes or deviations from expected behavior, especially large transactions to high-risk jurisdictions.
ZH: 评估交易频率、金额和时机，识别异常峰值或偏离预期行为。

[v7u_N003404|3404] Source and destination of funds: Determine where funds originate and where they are sent. Ensure that sources align with the customer’s profile and business.
ZH: 确定资金来源和去向，确保与客户资料和业务一致。

[v7u_N003405|3405] Layering transactions: Identify complex transaction layering that might obscure the fund trail.
ZH: 识别可能掩盖资金踪迹的复杂交易分层。

[v7u_N003406|3406] Integration with external information: Combine cash flow findings with external data, such as public records or sanctions lists, for context and validation.
ZH: 将现金流发现与公共记录或制裁名单等外部信息结合验证。

[v7u_N003407|3407] Visualizing cash flows and relationships can help analysts comprehend transaction dynamics and detect irregularities that may require further scrutiny.
ZH: 可视化现金流和关系有助于分析人员理解交易动态并检测异常。

[v7u_N003408|3408] During in-depth analysis, investigators might discover that the case is more complicated than expected. New information may be discovered that reveals previously unknown or overlooked networks or patterns. Identifying these connections can significantly reshape the investigation and uncover broader networks of suspicious activity.
ZH: 深入分析中可能发现新信息，揭示先前未知或忽视的网络和模式。

[v7u_N003409|3409] In such cases, analysts should promptly consult their AFC compliance team to determine how to proceed with the new information and avoid unnecessary delays. Early engagement ensures clarity and direction, strengthens the investigation, and establishes a clear path to meet regulatory timelines.
ZH: 发现新信息时应及时咨询金融犯罪防控合规团队，避免延误。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "调查员必须分析数据以转化为可操作情报",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯义务陈述且无复杂条件或分支，基础KG已能表达该规则。"
    },
    {
      ...
      "proposition": "分析员通过审查交易历史等验证可疑点并决定是否进一步行动",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性解释，审查-验证-决策链属于常见分析步骤，基础KG可覆盖作为整体知识。"
    },
    {
      ...
      "proposition": "调查员识别映射关系并使用网络分析可视化以识别行为模式",
      "decision": "kg_only",
      "card_id": null,
      "reason": "网络分析的使用和好处说明，无明确条件或应对，基础KG可表达。"
    },
    {
      ...
      "proposition": "分析现金流时考虑交易模式、资金来源、分层和外部信息以评估合法性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "并列的考量因素列表，无连贯的有向程序链，基础KG可表达。"
    },
    {
      ...
      "proposition": "深入分析中可能发现新信息重塑调查",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅描述可能性和潜在影响，未给出具体应对步骤，基础KG可表达。"
    },
    {
      ...
      "proposition": "在深入分析中发现新信息时，分析员应及时咨询合规团队以推进并建立明确路径",
      "decision": "p7c_card",
      "card_id": "p7card_CH47-S14_001",
      "reason": "明确的条件-应对链：发现新网络触发咨询义务，并产生建立路径的结果，具有程序性方向，超出基础KG的一般措施陈述。"
    }
  ],
  "cards": [
    {
      ...
      "title": "发现新网络或模式时的咨询要求",
      "flow_nodes": [
        {
          "node_id": "E1",
          "node_category": "entry",
          "node_type": "E8_decision_finding",
          "label": "深入分析中发现新信息揭示先前未知网络或模式",
          "evidence_unit_ids": [
            "v7u_N003408"
          ],
      ...
      "flow_edges": [
        {
          ...
          "condition": "在深入分析中作出此发现时",
          "source_quote": "During in-depth analysis, investigators might discover... In such cases, analysts should promptly consult..."
        },
        {
          "edge_id": "P1_to_X1",
          "edge_type": "PRODUCES",
          ...
          "derivation": "explicit_text",
          "source_quote": "Early engagement ensures... establishes a clear path to meet regulatory timelines."
        }
      ],
      "source_unit_ids": [
        "v7u_N003408",
      ...
      "review_notes": "增量命题：发现新信息（揭示先前未知网络） --触发--> 分析员咨询合规团队 --产生--> 建立明确路径以满足监管时限；KG不足：基础KG将v7u_N003409作为规定的措施整体保存，未能表达从发现到咨询到建立路径的有向链；选项判断：可确认发现新网络时应咨询合规团队的流程；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
