...
section_title: `Governance and oversight > 8. Customer offboarding and exit strategy:`

section_text_with_unit_anchors:

```text
[v7u_N003008|3008] Risk-based account closure: Based on reporting obligations, the organization might need approval to offboard customers due to suspected illicit activity or noncompliance risks.
ZH: 因涉嫌非法活动或不合规风险而终止客户关系需获得批准

[v7u_N003009|3009] Exits based on a mismatch in risk appetite should be reviewed and decided on a caseby-case basis.
ZH: 因风险偏好不匹配导致的客户退出应逐案审查决定

[v7u_N003010|3010] By implementing dynamic, risk-based measures and leveraging advanced technologies, financial institutions enhance AFC controls and align with international AFC obligations.
ZH: 动态风险措施和先进技术增强金融犯罪防控并符合国际义务
```
...
[
  {
    ...
    "proposition": "基于报告义务，因涉嫌非法活动或不合规风险，组织可能需要获得批准才能终止客户关系。",
    "source_quotes": [
      "Risk-based account closure: Based on reporting obligations, the organization might need approval to offboard customers due to suspected illicit activity or noncompliance risks."
    ],
    "relation_cues": [
      "based on",
      "might",
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "组织可能需要获得批准才能终止客户关系",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003008",
        "quote": "Risk-based account closure: Based on reporting obligations, the organization might need approval to offboard customers due to suspected illicit activity or noncompliance risks."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "因风险偏好不匹配导致的客户退出应逐案审查并决定。",
    "source_quotes": [
      "Exits based on a mismatch in risk appetite should be reviewed and decided on a caseby-case basis."
    ],
    "relation_cues": [
      "based on",
      "should"
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "应逐案审查并决定",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003009",
        "quote": "Exits based on a mismatch in risk appetite should be reviewed and decided on a caseby-case basis."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  ...
  {
    "candidate_id": "s1c_gap_ch41_s12_afc_enhance",
    "unit_ids": [
      "v7u_N003010"
    ],
    "proposition": "通过实施动态风险措施和利用先进技术，金融机构增强反金融犯罪控制并符合国际反金融犯罪义务。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "金融机构实施动态风险措施和利用先进技术",
      "outcomes_or_paths": [
        "增强反金融犯罪控制",
        "符合国际反金融犯罪义务"
      ]
    ...
    "evidence_spans": [
      {
        "unit_id": "v7u_N003010",
        "quote": "By implementing dynamic, risk-based measures and leveraging advanced technologies, financial institutions enhance AFC controls and align with international AFC obligations."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只关注基于报告义务的非法活动或不合规风险下的终止客户关系批准，以及风险偏好不匹配的逐案审查，未承接通过动态措施和技术增强金融犯罪防控并符合国际义务的框架。"
    }
  }
]
```
