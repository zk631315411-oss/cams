...
[
  {
    ...
    "proposition": "Sophie发现客户FullTechGlobal Services的负面新闻，该公司面临海外贿赂指控且是英国公司子公司，引发对《英国反贿赂法》域外条款的法律关切。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "引发对UK Bribery Act域外条款的法律关切",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "proposition": "《英国反贿赂法》适用于任何与英国有关联的公司，并规定母公司对子公司腐败行为负责。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "法律适用于该公司并追究母公司责任",
      "outcomes_or_paths": [
        "母公司对子公司腐败行为负责"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "Sophie初步调查发现FullTechGlobal在高风险司法管辖区雇佣中间人获取合同，并通过虚增费用、伪造发票和壳公司掩盖非法资金流动，还向官员提供奢华礼品和旅行安排以影响决策。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "调查发现FullTechGlobal存在雇佣中间人、掩盖财务和贿赂行为",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "proposition": "Sophie跟进调查并审查FullTechGlobal的ABC框架和内部控制，发现内部控制机制缺陷和监督不足，导致腐败行为持续发生。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "Sophie跟进调查并审查ABC框架和内部控制"
      ],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "发现内部控制缺陷和监督不足",
      "outcomes_or_paths": [
        "导致腐败持续发生"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "贿赂被识别为上游犯罪，通过复杂金融网络洗钱以逃避监管和侦查。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "贿赂作为上游犯罪导致洗钱",
      "outcomes_or_paths": [
        "通过复杂金融网络洗钱以逃避监管"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "基于调查发现，FullTechGlobal面临英国《反贿赂法》下的严厉处罚、国际监管审查以及子公司和母公司及其高管的潜在刑事责任。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "调查发现FullTechGlobal的贿赂和掩盖行为"
      ],
      "basis_or_condition": [
        "英国《反贿赂法》2010"
      ],
      "focal_handling_or_judgment": "FullTechGlobal面临法律后果",
      "outcomes_or_paths": [
        "严厉罚款",
        "增加监管审查",
        "潜在刑事责任"
  ...
  },
  {
    ...
    "proposition": "作为金融犯罪防控经理，Sophie认识到机构需要维护合规诚信，并在与全球企业交易中降低贿赂腐败风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [
        "调查发现FullTechGlobal存在腐败"
      ],
      "focal_handling_or_judgment": "机构需要维护合规诚信并降低贿赂风险",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000144",
        "quote": "As an AFC manager, she recognizes that her institution needs to maintain compliance integrity and mitigate bribery and corruption risks in its dealings with global businesses such as FullTechGlobal Services."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
