...
跨境业务须同时遵循所涉各司法管辖区AFC规定

## 【核心解析】

教材指出，跨境交易涉及特定司法管辖区时，合规人员需要参考这些辖区的金融犯罪防控（AFC）法规。例如，当跨境交易涉及美国和欧盟时，机构应同时参考两地的AFC要求（P178）。同时，跨国机构在确管辖合规时，必须使政策既符合各国法律，又维持全球AFC原则（P292）。题干描述的交易同时受美国BSA/OFAC要求和欧盟6AMLD/EBA法规约束，且客户涉及美法双重国籍。最佳措施是实施同时满足两方要求的双重合规方法，这直接匹配教材中「涉及多个司法管辖区时应同时满足各方要求」的核心规则。
...
- **A 错误（题干对照）｜题干要素不匹配**：教材表明，交易涉及美国时，外国金融机构的美国分行也须遵守BSA最低标准（P194）。题干中交易同时涉及美国和欧盟要求，题干条件更直接支持同时满足两方要求而非仅遵循欧盟法规。
- **C 错误（教材直接依据）｜范围或程度偏差**：教材在解释国际金融机构如何处理不同辖区法规差异时，提出的方案是「为集团AML政策附加特定司法管辖区的附录」，用本地化附录来记录更高标准（P194），而非简单直接地遵从最严格的制度。因此，双重合规更匹配教材中「协调各司法管辖区要求」的处理方式，而非单纯依赖单一最严格制度来简化流程。
- **D 错误（题干对照）｜题干要素不匹配**：题干明确指出「该交易受美国BSA、OFAC以及欧盟6AMLD和EBA法规的约束」，说明两方法规均适用。仅遵循美国法规与题干给定的双法域适用条件不匹配。

## 【易错提醒】

教材指出，国际金融机构的做法不是简单地遵从「最严格」的单一制度，而是通过「为集团AML政策附加特定司法管辖区的附录」来记录和遵循不同辖区的更高标准（P194）。即在集团层面维持统一框架，但在具体辖区附录中实施满足当地更高要求的措施，这与直接遵从单一最严格制度是不同的思路。
