...
section_title: `Understanding AFC technology > Using AFC technology to reduce friction in customer journeys`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "客户摩擦的来源与影响",
      "title_en": "Sources and Effects of Customer Friction",
      "covered_units": [
        {
          "unit_id": "v7u_N003809",
          "unit_type": "fact",
    ...
    {
      "title_zh": "利用AFC技术减少摩擦",
      "title_en": "Using AFC Technology to Reduce Friction",
      "covered_units": [
        {
          "unit_id": "v7u_N003815",
          "unit_type": "fact",
    ...
    {
      "title_zh": "平衡有效性与客户体验",
      "title_en": "Balancing Effectiveness and Customer Experience",
      "covered_units": [
        {
          "unit_id": "v7u_N003820",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "客户摩擦的来源与影响",
      "target_title": "利用AFC技术减少摩擦",
      "relation_type": "prepares"
    },
    {
      "source_title": "利用AFC技术减少摩擦",
      "target_title": "平衡有效性与客户体验",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003809|3809] Friction can arise when organizations excessively contact customers for information or delay processing their transactions.
ZH: 客户旅程中的摩擦源于过度联系或交易处理延迟。

[v7u_N003810|3810] Unnecessary contact often occurs when a customer holds multiple relationships within an organization.
ZH: 客户在机构内持有多种关系时，容易导致不必要的联系。

[v7u_N003811|3811] For example, a company director who has personal retail accounts and acts as a guarantor for a loan may face redundant KYC requests from three different business units.
ZH: 公司董事同时拥有个人零售账户并担任贷款担保人时，可能面临重复的了解你的客户请求。

[v7u_N003812|3812] Delays often stem from transaction processing or approvals for new products or additional accounts.
ZH: 延迟通常源于交易处理或新产品/账户审批。

[v7u_N003813|3813] These delays may result from operational backlogs or the need to update a customer’s risk profile before proceeding.
ZH: 延迟可能由操作积压或需要更新客户风险状况导致。

[v7u_N003814|3814] Excessive outreach or frustrating delays increase operational costs and may lead to customer attrition.
ZH: 过度联系或延迟会增加运营成本并导致客户流失。

[v7u_N003815|3815] AFC technology can reduce direct customer outreach by automating data collection and continuously monitoring changes in customer profiles.
ZH: 金融犯罪防控技术通过自动化数据收集和持续监控客户档案变化来减少直接联系。

[v7u_N003816|3816] Instead of relying on periodic refreshes, institutions can implement trigger-based updates using transaction patterns, third-party data, and public records.
ZH: 机构可利用交易模式、第三方数据和公共记录实施触发式更新。

[v7u_N003817|3817] Perpetual KYC tools can also minimize the need for large-scale remediation projects while maintaining up-to-date information.
ZH: 持续了解你的客户工具可减少大规模整改项目，同时保持信息最新。

[v7u_N003818|3818] Integrating customer and transactional data across technology solutions and business units helps reduce outreach. Organizations need only contact customers once for information, as they can then build a holistic customer risk profile by assembling a complete dataset.
ZH: 整合客户与交易数据可减少联系，构建整体客户风险档案。

[v7u_N003819|3819] Reducing false positives in transaction monitoring and screening decreases the need for customer inquiries. It also relieves pressure on operational resources, who may encounter delays in processing times for alerts or queries. By leveraging machine learning, organizations can enhance alert accuracy, reducing the number of investigations and customer disruptions.
ZH: 减少交易监控中的误报可降低客户查询需求并减轻运营压力。

[v7u_N003820|3820] When selecting technology, institutions must balance effectiveness with customer experience.
ZH: 选择技术时，机构必须在有效性与客户体验之间取得平衡。

[v7u_N003821|3821] Robust systems improve compliance and risk management, but overly intrusive processes can lead to negative interactions.
ZH: 稳健系统提升合规与风险管理，但过度侵入性流程可能导致负面客户体验。

[v7u_N003822|3822] The trade-off between security and convenience should align with the organization’s risk appetite, ensuring controls are proportionate to the level of risk.
ZH: 安全与便利的权衡应与机构风险偏好一致，确保控制措施与风险水平相称。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "客户摩擦源于过度联系和延迟，可导致运营成本增加和客户流失",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些单元为定义、原因解释和案例说明，基础KG已能充分表达，无程序性或判断性有向结构。"
    },
    {
      ...
      "proposition": "AFC技术可通过自动化、触发式更新、持续KYC、数据整合和减少误报等方式减少客户摩擦",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些单元描述技术过程和能力，基础KG已作为一般过程知识覆盖，未超出KG表达能力。"
    },
    {
      ...
      "proposition": "在选择技术时，机构必须平衡有效性与客户体验",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S05_001",
      "reason": "规则内部包含条件（选择技术时）和带情态的动作（必须平衡），形成有向判断结构，基础KG无法表达此条件-动作关系。"
    },
    {
      ...
      "proposition": "机构的安全与便利权衡应与风险偏好一致，并确保控制措施与风险相称",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S05_002",
      "reason": "规则内部明确了风险偏好作为标准约束权衡和控制措施的有向关系，属于增量判断结构。"
    },
    {
      ...
      "proposition": "稳健系统提升合规但过度侵入导致负面客户体验",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅为一般性对比陈述，无明确主体动作或判断方向，基础KG可承载。"
    }
  ],
  "cards": [
    {
      ...
      "flow_edges": [
        {
          ...
          "condition": "在选择技术时（when selecting technology）"
        }
      ],
      "source_unit_ids": [
        "v7u_N003820"
      ...
      "review_notes": "增量命题：机构选择技术 → 机构必须平衡有效性与客户体验；条件：在选择技术时。KG不足：基础KG只能将此整句作为规则保存，无法表达“选择技术”作为触发条件与平衡动作之间的有向关系。选项判断：可确认机构在技术选择时需执行平衡有效性与客户体验的步骤。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S05_002",
      "section_id": "CH51-S05",
      "card_nature": "assessment",
      "title": "权衡安全与便利时应与风险偏好一致并确保控制相称",
      "flow_nodes": [
        {
          "node_id": "N1",
        ...
        },
        {
          ...
          "node_category": "process",
          "node_type": "P1_assessment",
          "label": "机构应当确保安全与便利的权衡与风险偏好一致，控制措施与风险水平相称",
          "evidence_unit_ids": [
            "v7u_N003822"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：机构的安全与便利权衡应当与风险偏好对齐，并确保控制相称 → 参照 机构风险偏好。KG不足：基础KG只能将此整句作为规则保存，无法表达风险偏好作为标准约束权衡和控制措施的有向结构。选项判断：可确认机构在权衡安全与便利时须依据风险偏好，并保持控制措施相称。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
