...
section_title: `Data as an input for solutions > Case example: Handling increased alert volume`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "Magnify Bank 增强交易监控的数据整合流程",
      "title_en": "Magnify Bank's Data Integration Process for Enhanced Transaction Monitoring",
      "covered_units": [
        {
          "unit_id": "v7u_N004802",
          "unit_type": "case",
