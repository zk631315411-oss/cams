...
from pipeline.evidence_pool import load_new_question_runtime  # noqa: E402
from pipeline.run_pipeline import run_new_question_pipeline  # noqa: E402
...
class NewQuestionHandler(BaseHTTPRequestHandler):
    ...
    def _drafts_dir() -> Path:
        return _MODULE_DIR / "outputs" / "drafts"
