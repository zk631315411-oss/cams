...
section_title: `High-risk business sectors > Alternative remittance systems`

section_text_with_unit_anchors:

```text
[v7u_N001194|1194] An alternative remittance system (ARS) is a frequently used method for transferring value.
ZH: 替代性汇款系统是常用的价值转移方式

[v7u_N001195|1195] Globally, this form of money movement has existed in several forms across numerous jurisdictions, with one recurring theme involved in its transfer process: trust.
ZH: 替代性汇款系统在全球多种形式存在，信任是核心

[v7u_N001196|1196] Those operating an alternative remittance system do not hold an MSB license or equivalent.
ZH: 替代性汇款系统运营者无货币服务企业牌照

[v7u_N001197|1197] The best-known form of ARS is a hawala, an informal system involving the international transfer of value outside the legitimate banking system.
ZH: 哈瓦拉是最知名的替代性汇款系统形式

[v7u_N001198|1198] Hawala rely on collaborative parties setting up a transfer and exchange process built on trust, and often debt, to move the value of funds. This is usually done by arranging for equivalent amounts of currency to be transferred at the customer’s instruction, rather than by transferring the actual funds.
ZH: 哈瓦拉基于信任和债务安排等额货币转移，而非实际资金

[v7u_N001199|1199] Before wire transfers, ARSs were born of necessity. Physically transporting money carried a high risk of theft and loss. Merchants would meet, agree on the terms of a deal, and then arrange for payment via a trust-based system.
ZH: 替代性汇款系统源于电汇前物理运输货币的高风险

[v7u_N001200|1200] Similarly, today, hawala brokers maintain a ledger of collaborative transferors along with their available funds and currencies.
ZH: 哈瓦拉经纪人维护合作转账人及其可用资金和货币的分类账

[v7u_N001201|1201] The “remitter” provides an amount in a local currency plus fees to the broker, who relies on their network of transferors overseas to effectively forward that amount in the local currency.
ZH: 汇款人向经纪商提供本币资金及费用，经纪商利用海外转账网络完成跨境转移。

[v7u_N001202|1202] Those transferors may owe the broker a debt, which they repay to the “remitter’s” payee as a third-party payment, or they may be a collaborative partner who charges the payee a service fee.
ZH: 转账方可能欠经纪商债务，通过向收款人第三方支付偿还，或作为合作方收取服务费。

[v7u_N001203|1203] As a result, the value is transferred overseas, and the currency is converted without involving a bank or money services business (MSB).
ZH: 价值跨境转移且货币兑换不涉及银行或货币服务企业（货币服务企业）。

[v7u_N001204|1204] Hawalas are popular amongst:
ZH: 哈瓦拉系统在以下群体中流行：

[v7u_N001205|1205] Marginalized communities, such as refugees and those living in conflict zones, who lack access to, or trust in, banks.
ZH: 边缘化社区（如难民和冲突地区居民）缺乏银行渠道或信任。

[v7u_N001206|1206] Individuals who do not want a digital record of their transactions.
ZH: 不希望交易留下数字记录的个人。

[v7u_N001207|1207] As a result, terrorist financiers leverage hawalas, relying on the trust and anonymity that an ARS provides to transfer money to high-risk geographies or even “directly” to domestic terrorist groups.
ZH: 恐怖融资者利用哈瓦拉系统的信任和匿名性向高风险地区或国内恐怖组织转移资金。
```
