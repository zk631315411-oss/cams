...
section_title: `Money Laundering and Financial Crime > Common techniques for money laundering`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "常见洗钱手法概述",
      "title_en": "Overview of common money laundering techniques",
      "covered_units": [
        {
          "unit_id": "v7u_N000026",
    ...
    {
      "title_zh": "结构化、微结构化和化整为零",
      "title_en": "Structuring, microstructuring, and smurfing",
      "covered_units": [
        {
          "unit_id": "v7u_N000028",
          "unit_type": "context",
    ...
    {
      "title_zh": "数字资产洗钱",
      "title_en": "Digital asset laundering",
      "covered_units": [
        {
          "unit_id": "v7u_N000032",
          "unit_type": "context",
    ...
    {
      "title_zh": "钱骡网络",
      "title_en": "Money muling networks",
      "covered_units": [
        {
          "unit_id": "v7u_N000036",
          "unit_type": "context",
  ...
  "covered_relations": [
    {
      "source_title": "常见洗钱手法概述",
      "target_title": "结构化、微结构化和化整为零",
...
```text
[v7u_N000026|26] Money laundering techniques allow criminals to obscure proceeds from illegal activities and integrate them into the financial system. These methods exploit regulatory loopholes, trade networks, financial markets, and vulnerable members of society.
ZH: 洗钱技术利用监管漏洞、贸易网络、金融市场等将非法所得融入金融体系

[v7u_N000027|27] Some of the most common techniques criminals employ to launder money include:
ZH: 列举犯罪分子常用的洗钱技术

[v7u_N000028|28] Structuring, microstructuring, smurfing:
ZH: 洗钱技术：结构化/微结构化/化整为零

[v7u_N000029|29] Large illicit funds are split into small transactions to avoid triggering AML reporting thresholds.
ZH: 将大额非法资金拆分为小额交易以规避反洗钱报告门槛

[v7u_N000030|30] Criminals use multiple accounts, financial institutions, and intermediaries to evade monitoring.
ZH: 犯罪分子利用多个账户、金融机构和中间人逃避监控

[v7u_N000031|31] Microstructuring resembles traditional structuring but is typically used with digital asset laundering.
ZH: 微结构化类似传统结构化，但常用于数字资产洗钱

[v7u_N000032|32] Digital asset laundering:
ZH: 洗钱技术：数字资产洗钱

[v7u_N000033|33] Cryptocurrencies, NFTs, and DeFi allow pseudonymous cross-border fund transfers.
ZH: 加密货币、NFT和DeFi支持假名跨境资金转移

[v7u_N000034|34] Launderers use mixing services and privacy coins for anonymity.
ZH: 洗钱者使用混币服务和隐私币实现匿名

[v7u_N000035|35] Criminals often launder and cash out their illicit proceeds using digital asset service providers in jurisdictions with weak AML/CFT regulations.
ZH: 犯罪分子利用反洗钱/反恐怖融资监管薄弱辖区的数字资产服务商洗钱

[v7u_N000036|36] Money muling networks:
ZH: 洗钱技术：钱骡网络

[v7u_N000037|37] Mules act as intermediaries, transferring illicit funds between accounts on behalf of criminals.
ZH: 钱骡作为中间人，代表犯罪分子在账户间转移非法资金

[v7u_N000038|38] Criminals recruit individuals through job scams, social engineering, or coercion, making fund transfers more difficult to trace.
ZH: 犯罪分子通过招聘骗局、社会工程或胁迫招募个人，使资金转移更难追踪
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "洗钱技术利用监管漏洞、贸易网络、金融市场等将非法所得融入金融体系。常见技术包括结构化、数字资产洗钱、钱骡网络。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯定义、分类和一般机制概述，未包含特定主体的程序性或判断性有向结构，基础KG可充分表达。"
    },
    {
      ...
      "proposition": "犯罪分子通过结构化、微结构化和化整为零拆分大额资金成小额交易，以避免触发反洗钱报告门槛，利用多个账户和中间人逃避监控。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述犯罪分子的洗钱手法和机制，未涉及反洗钱义务主体的识别、评估、决策或应对，基础KG可保存为一般知识。"
    },
    {
      ...
      "proposition": "犯罪分子利用加密货币、NFT、DeFi进行假名跨境转移，使用混币服务和隐私币实现匿名，在监管薄弱辖区通过数字资产服务商洗钱。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述数字资产洗钱的犯罪方法，属于一般事实和机制，无机构程序性或判断性有向关系，基础KG可表达。"
    },
    {
      ...
      "proposition": "犯罪分子通过钱骡网络，利用钱骡作为中间人在账户间转移非法资金，通过招聘骗局、社会工程或胁迫招募个人，使资金更难追踪。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述钱骡网络的犯罪方法，属于一般事实和机制，无机构程序性或判断性有向关系，基础KG可表达。"
    }
  ],
  "cards": [],
  "skip_reason": "当前section内容均为犯罪分子洗钱手法的定义、分类和一般机制描述，未发现任何涉及反洗钱义务主体的程序性或判断性有向结构，无法形成对CAMS选项判断有用的局部增量关系。基础KG已能充分表达所有内容。"
}
```
