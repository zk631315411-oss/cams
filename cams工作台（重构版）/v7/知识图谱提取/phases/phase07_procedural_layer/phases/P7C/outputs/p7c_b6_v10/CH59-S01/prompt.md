...
section_title: `Governance process > Data governance committees`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "数据治理委员会的定义与角色",
      "title_en": "Definition and role of data governance committees",
      "covered_units": [
        {
          "unit_id": "v7u_N004945",
    ...
    {
      "title_zh": "监督职责",
      "title_en": "Oversight responsibilities",
      "covered_units": [
        {
          "unit_id": "v7u_N004948",
          "unit_type": "process",
    ...
    {
      "title_zh": "监管合规监控",
      "title_en": "Regulatory compliance monitoring",
      "covered_units": [
        {
          "unit_id": "v7u_N004951",
          "unit_type": "process",
    ...
    {
      "title_zh": "安全与战略角色",
      "title_en": "Security and strategic roles",
      "covered_units": [
        {
          "unit_id": "v7u_N004953",
          "unit_type": "process",
    ...
    {
      "title_zh": "委员会组成与领导",
      "title_en": "Committee composition and leadership",
      "covered_units": [
        {
          "unit_id": "v7u_N004955",
          "unit_type": "rule",
  ...
  "covered_relations": [
    ...
    {
      "source_title": "数据治理委员会的定义与角色",
      "target_title": "安全与战略角色",
      "relation_type": "contains"
    },
    {
      "source_title": "数据治理委员会的定义与角色",
      "target_title": "委员会组成与领导",
      "relation_type": "contains"
    }
  ]
}
...
```text
[v7u_N004944|4944] Data is a critical asset for decision-making, risk assessment, regulatory compliance, and customer engagement.
ZH: 数据是决策、风险评估、合规和客户参与的关键资产

[v7u_N004945|4945] While data management includes actions taken to store, organize and maintain data, data governance provides the necessary frameworks, policies, and assurance measures to control these processes effectively.
ZH: 数据治理为数据管理提供框架、政策和保障措施

[v7u_N004946|4946] Committees dedicated to data management and governance across an organization focus on accuracy, security, and compliance with industry standards. These committees are centralized bodies that establish policies, frameworks, and best practices for data handling.
ZH: 数据管理与治理委员会专注于准确性、安全性和行业标准合规

[v7u_N004947|4947] By setting clear data governance standards, they ensure consistency across business units, reducing the risk of errors, financial crime, or regulatory breaches.
ZH: 明确的数据治理标准可确保跨业务单元的一致性，降低错误、金融犯罪或违规风险

[v7u_N004948|4948] Governance committees receive regular updates on data reconciliation, data lineage, and validation and testing results as part of their oversight responsibilities.
ZH: 治理委员会定期接收数据核对、数据血缘及验证测试结果的更新

[v7u_N004949|4949] Deficiencies are subject to corrective actions under the committee’s supervision.
ZH: 缺陷在委员会监督下采取纠正措施

[v7u_N004950|4950] Regulatory compliance is a key focus, as financial institutions must adhere to strict guidelines such as the GDPR, the California Consumer Privacy Act, and Basel III.
ZH: 金融机构必须遵守《通用数据保护条例》、CCPA和巴塞尔III等严格法规

[v7u_N004951|4951] Committees monitor compliance, ensuring that the organization collects, stores, and processes data according to legal and ethical standards.
ZH: 委员会监控数据收集、存储和处理是否符合法律和道德标准

[v7u_N004952|4952] This oversight helps mitigate legal risks and protects the organization from penalties or reputational damage.
ZH: 监督有助于减轻法律风险，保护组织免受处罚或声誉损害

[v7u_N004953|4953] Committees work closely with IT and cybersecurity teams to establish security protocols for data protection, preventing breaches, cyber threats, and unauthorized access.
ZH: 委员会与IT和网络安全团队合作建立数据保护安全协议

[v7u_N004954|4954] In a more strategic role, they oversee the use of data for innovation. In this role, they help the organization achieve a competitive advantage by identifying valuable trends, improving customer risk assessments, and optimizing detection performance across internal business units.
ZH: 委员会战略性地监督数据创新，帮助组织获得竞争优势

[v7u_N004955|4955] An executive who is accountable for process and system outcomes should chair data management and governance committees.
ZH: 数据管理与治理委员会应由对流程和系统结果负责的高管担任主席

[v7u_N004956|4956] For financial crime compliance committees, the chair may be the head of monitoring or screening. For a senior committee in a large organization, it may be the group MLRO.
ZH: 金融犯罪合规委员会主席可由监控或筛查负责人或集团MLRO担任

[v7u_N004957|4957] Committee members should include representatives from the end-user community, IT teams, and the upstream source data providers.
ZH: 委员会成员应包括最终用户、IT团队和上游数据提供方的代表
```
