...
section_title: `Technology for KYC > How does technology help KYC?`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "FATF关于非面对面业务关系及技术的建议",
      "title_en": "FATF recommendations on non-face-to-face business relationships and technology",
      "covered_units": [
        {
          "unit_id": "v7u_N004035",
          "unit_type": "rule",
    ...
    {
      "title_zh": "客户开户的关键技术及其益处",
      "title_en": "Key technologies for client onboarding and their benefits",
      "covered_units": [
        {
          "unit_id": "v7u_N004036",
          "unit_type": "fact",
    ...
    {
      "title_zh": "国家身份数据库及其与金融机构的整合",
      "title_en": "National identity databases and integration with financial institutions",
      "covered_units": [
        {
          "unit_id": "v7u_N004042",
          "unit_type": "fact",
    ...
    {
      "title_zh": "KYC流程中的欺诈控制",
      "title_en": "Fraud controls within KYC processes",
      "covered_units": [
        {
          "unit_id": "v7u_N004045",
          "unit_type": "fact",
    ...
    {
      "title_zh": "使用技术进行KYC的风险",
      "title_en": "Risks of using technology for KYC",
      "covered_units": [
        {
          "unit_id": "v7u_N004046",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "FATF关于非面对面业务关系及技术的建议",
      "target_title": "客户开户的关键技术及其益处",
      "relation_type": "prepares"
    },
    {
      "source_title": "客户开户的关键技术及其益处",
      "target_title": "国家身份数据库及其与金融机构的整合",
      "relation_type": "parallels"
    },
    {
      "source_title": "客户开户的关键技术及其益处",
      "target_title": "KYC流程中的欺诈控制",
      "relation_type": "prepares"
    },
    {
      "source_title": "客户开户的关键技术及其益处",
      "target_title": "使用技术进行KYC的风险",
...
```text
[v7u_N004034|4034] In recent years, international bodies such as FATF and various local regulators have encouraged financial institutions to incorporate more technological solutions to mitigate financial crime risks.
ZH: FATF及监管机构鼓励金融机构采用技术缓解金融犯罪风险

[v7u_N004035|4035] The updated FATF recommendations clarify that non-face-to-face business relationships, such as those involving digital onboarding and transactions, are considered higherrisk situations only when organizations have not implemented appropriate risk mitigation measures, which can include AI.
ZH: 非面对面业务关系仅在未采取适当风险缓解措施时被视为高风险

[v7u_N004036|4036] Many organizations incorporate technologies into their client onboarding procedures, such as electronic identity verification, biometric authentication, and optical character recognition.
ZH: 客户开户程序中采用电子身份验证、生物识别和OCR等技术

[v7u_N004037|4037] Technology improves process efficiency in several ways, but the ultimate goal is to prevent financial crime while enhancing the overall customer experience by reducing the time required to open an account.
ZH: 技术旨在提高效率、预防金融犯罪并改善客户体验

[v7u_N004038|4038] Improved technologies such as biometric authentication provide more accurate results and reduce errors and fraud in the onboarding process.
ZH: 生物识别等改进技术提高准确性并减少错误和欺诈

[v7u_N004039|4039] Machine learning can analyze large datasets to detect inconsistencies and anomalies, helping to identify potential errors and enhance risk identification.
ZH: 机器学习可分析大数据集以检测不一致和异常，增强风险识别

[v7u_N004040|4040] Technology also enables real-time data processing and verification, providing immediate feedback and improving decision-making. This leads to cost savings for financial institutions and allows effective resource allocation.
ZH: 技术实现实时数据处理和验证，带来成本节约和有效资源配置

[v7u_N004041|4041] Optical character recognition (OCR) technology also reduces errors in the onboarding process. This technology converts scanned documents into editable and searchable data, ensuring accurate data extraction and reducing manual errors. OCR is often AI-enabled, which allows it to recognize complex fonts and document layouts.
ZH: OCR技术将扫描文档转换为可编辑数据，减少人工错误，常由AI驱动以识别复杂字体和布局。

[v7u_N004042|4042] National identity databases also provide benefits to organizations.
ZH: 国家身份数据库为机构带来益处。

[v7u_N004043|4043] Countries such as Estonia, India, Spain, and Singapore have national e-identity processes for their citizens, while countries such as the US and Canada offer similar systems at the state or province level.
ZH: 爱沙尼亚、印度、西班牙、新加坡等国有国家电子身份系统，美国、加拿大有州或省级系统。

[v7u_N004044|4044] This integration of government information with financial institution processes allows a quicker turnaround time in identity verification processes and therefore enhances onboarding efficiency.
ZH: 政府信息与金融机构流程整合可加快身份验证，提升开户效率。

[v7u_N004045|4045] Often, KYC controls incorporate fraud controls to ensure legitimacy of documents.
ZH: 了解你的客户控制措施常纳入欺诈控制以确保文件真实性。

[v7u_N004046|4046] However, using technology to improve KYC can also pose risk to an organization.
ZH: 使用技术改进了解你的客户也可能给机构带来风险。

[v7u_N004047|4047] Depending on the type of digital identity it uses and the relevant control to ensure information accuracy, the organization may need to conduct additional checks to avoid synthetic identity and impersonation.
ZH: 根据数字身份类型，机构可能需要额外检查以避免合成身份和冒充。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "当机构未实施适当的风险缓解措施时，非面对面业务关系被视为高风险",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S01_001",
      "reason": "形成条件导向的风险分类判断有向结构，超出基础KG表达能力"
    },
    {
      ...
      "proposition": "根据使用的数字身份类型及相关控制，机构可能需要额外检查以避免合成身份和冒充",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S01_002",
      "reason": "形成特定条件约束执行动作的有向结构"
    },
    {
      ...
      "proposition": "监管机构鼓励金融机构采用技术缓解金融犯罪风险",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅为一般性鼓励陈述，无具体程序或判断链"
    },
    {
      ...
      "proposition": "机构在客户开户程序中采用电子身份验证、生物识别和OCR等技术",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性技术采用事实，无特定条件或判断导向"
    },
    {
      ...
      "proposition": "技术旨在提高效率、预防金融犯罪并改善客户体验",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术目的陈述，无具体主体动作或判断关系"
    },
    {
      ...
      "proposition": "生物识别技术提高准确性并减少错误和欺诈",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术效果的一般性说明"
    },
    {
      ...
      "proposition": "机器学习分析大数据集以检测不一致和异常，增强风险识别",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术能力的一般性说明，未构成特定判断链"
    },
    {
      ...
      "proposition": "技术实现实时数据处理和验证，带来成本节约和有效资源配置",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术效果的一般性说明"
    },
    ...
    },
    {
      ...
      "proposition": "国家身份数据库为机构带来益处",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性益处陈述，无具体有向关系"
    },
    {
      ...
      "proposition": "一些国家拥有国家电子身份系统，其他国家有州级系统",
      "decision": "kg_only",
      "card_id": null,
      "reason": "举例说明，仅为事实列出"
    },
    {
      ...
      "proposition": "政府信息与金融机构流程整合加快身份验证，提升开户效率",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性机制因果关系，无特定条件或判断"
    },
    {
      ...
      "proposition": "KYC控制措施常纳入欺诈控制以确保文件真实性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性控制措施事实，无特定有向执行链"
    },
    {
      ...
      "proposition": "使用技术改进KYC也可能给机构带来风险",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立风险指标，无后续应对或判断结构"
    }
  ],
  "cards": [
    {
      ...
      "title": "非面对面业务关系风险分类条件",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "entry",
          "node_type": "E6_change_exception",
          "label": "组织未实施适当的风险缓解措施",
          "evidence_unit_ids": [
            "v7u_N004035"
          ],
      ...
      "review_notes": "增量命题：组织未实施适当风险缓解措施 → 机构判定非面对面业务关系为高风险（条件：未实施适当风险缓解措施）；KG不足：基础KG只能表达该规则整体陈述，无法表达条件导向特定分类判断的有向结构；选项判断：可确认或排除关于非面对面业务风险分类条件的选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH54-S01_002",
      "section_id": "CH54-S01",
      "card_nature": "execution",
      "title": "基于数字身份类型的额外检查条件",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "auxiliary",
          "node_type": "standard",
          "label": "数字身份类型及信息准确性相关控制",
          "evidence_unit_ids": [
            "v7u_N004047"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "condition": "取决于所使用的数字身份类型及其信息准确性控制",
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：机构额外检查参照数字身份类型及相关控制（条件：取决于所使用的类型）；KG不足：基础KG只能表达存在这种风险缓解措施，无法表达具体条件约束动作的有向关系；选项判断：可确认或排除关于何时需要额外检查的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
