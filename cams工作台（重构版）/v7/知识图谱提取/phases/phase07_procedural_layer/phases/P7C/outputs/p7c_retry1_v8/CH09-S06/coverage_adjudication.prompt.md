...
section_title: `Corporate and investment banking risks > Capital markets risks`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "资本市场洗钱风险概述",
      "title_en": "Capital markets money laundering risks overview",
      "covered_units": [
        {
          "unit_id": "v7u_N000749",
          "unit_type": "fact",
    ...
    {
      "title_zh": "商品交易洗钱风险",
      "title_en": "Commodity trading money laundering risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000751",
    ...
    {
      "title_zh": "外汇交易洗钱风险",
      "title_en": "Foreign exchange money laundering risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000755",
          "unit_type": "fact",
    ...
    {
      "title_zh": "证券洗钱风险",
      "title_en": "Securities money laundering risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000757",
          "unit_type": "definition",
    ...
    {
      "title_zh": "衍生品洗钱风险",
      "title_en": "Derivatives money laundering risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000759",
          "unit_type": "definition",
  ...
  "covered_relations": [
    {
      "source_title": "资本市场洗钱风险概述",
      "target_title": "商品交易洗钱风险",
      "relation_type": "contains"
    },
    {
      "source_title": "资本市场洗钱风险概述",
      "target_title": "外汇交易洗钱风险",
      "relation_type": "contains"
    },
    {
      "source_title": "资本市场洗钱风险概述",
...
```text
[v7u_N000749|749] Capital markets present significant risks for money laundering due to their complexity, liquidity, and the volume of transactions.
ZH: 资本市场因复杂性、流动性和交易量呈现显著洗钱风险

[v7u_N000750|750] The common products provided in capital markets include commodity trading, foreign currency exchange, securities, and derivatives.
ZH: 资本市场常见产品包括商品交易、外汇兑换、证券和衍生品

[v7u_N000751|751] Commodity trading involves the buying and selling of raw materials such as oil, gold, and agricultural products.
ZH: 商品交易涉及石油、黄金和农产品等原材料的买卖

[v7u_N000752|752] Money launderers can exploit commodity trading by purchasing commodities with illicit funds and then selling them to generate clean money.
ZH: 洗钱者可通过购买商品再出售以清洗非法资金

[v7u_N000753|753] The value and liquidity of commodities fluctuate almost daily, which makes it difficult to ascertain an average or expected sales price and as a result, makes them attractive for laundering purposes.
ZH: 商品价值与流动性频繁波动，难以确定平均售价，因而对洗钱具有吸引力

[v7u_N000754|754] The foreign exchange market is the largest financial market in the world, with a daily trading volume exceeding US$6 trillion as of 2024.
ZH: 外汇市场是全球最大金融市场，2024年日交易量超6万亿美元

[v7u_N000755|755] Money launderers use foreign currency exchange (FX) to move money across borders, often taking advantage of fluctuating exchange rates to obscure the origins of illicit funds.
ZH: 洗钱者利用外汇兑换跨境转移资金，借助汇率波动掩盖非法资金来源

[v7u_N000756|756] Products such as FX forwards and options add layers of complexity, allowing launderers to structure transactions in ways that evade detection.
ZH: 外汇远期和期权等衍生品增加复杂性，使洗钱者能构造交易逃避检测

[v7u_N000757|757] Securities include stocks, bonds, and other financial instruments that represent ownership or debt.
ZH: 证券包括股票、债券及其他代表所有权或债权的金融工具

[v7u_N000758|758] Money launderers can use securities by purchasing them with illicit funds, holding them for a period, and then selling them to generate clean money.
ZH: 洗钱者可用非法资金购买证券，持有后出售以产生清洁资金

[v7u_N000759|759] Derivatives are financial contracts whose value is derived from an underlying asset, such as stocks, bonds, commodities, or currencies.
ZH: 衍生品是价值源自股票、债券、商品或货币等基础资产的金融合约

[v7u_N000760|760] Examples include futures, options, and swaps.
ZH: 衍生品示例包括期货、期权和掉期

[v7u_N000761|761] Derivatives can be used for speculative purposes or to hedge risks, but their complexity and the potential for leveraging make them susceptible to money laundering schemes.
ZH: 衍生品可用于投机或对冲，但其复杂性和杠杆效应易被用于洗钱。

[v7u_N000762|762] Launderers can use derivatives to create convoluted transactions that are difficult to trace.
ZH: 洗钱者利用衍生品制造难以追踪的复杂交易。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "资本市场因复杂性、流动性和交易量呈现洗钱风险，常见产品包括商品交易、外汇兑换、证券和衍生品。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该单元仅描述一般事实和产品分类，未涉及特定主体的识别、评估或应对的程序性有向结构，基础KG可以充分表达。"
    },
    {
      ...
      "proposition": "商品交易涉及原材料买卖，洗钱者可通过购买商品再出售清洗资金，利用价格波动性增加隐蔽性。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该单元仅描述定义、一般洗钱手法和风险原因，没有程序步骤、条件判断或机构应对，基础KG可接管。"
    },
    {
      ...
      "proposition": "外汇市场规模巨大，洗钱者利用外汇和衍生品跨境转移资金并借助汇率波动和产品复杂性逃避检测。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅提供背景事实和一般风险指标，无主体动作、条件导向或判断链，基础KG足以表达。"
    },
    {
      ...
      "proposition": "证券包括股票、债券等，洗钱者可通过购买、持有后出售方式清洗资金。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅限于定义和一般洗钱方法的描述，缺乏具体识别或应对的程序性结构，属于基础KG范围。"
    },
    {
      ...
      "proposition": "衍生品是价值基于基础资产的金融合约，易被用于洗钱，洗钱者利用其制造难以追踪的复杂交易。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅包含定义、示例和一般风险叙述，未出现任何程序性义务或判断性分支，应由基础KG承载。"
    }
  ],
  "cards": [],
  "skip_reason": "当前section仅包含资本市场各产品洗钱风险的定义、背景和一般手法描述，未发现需要提取的程序性义务、条件判断、主体识别/应对或结果导向的增量有向结构，所有内容可由基础KG充分表达。"
}
```
