...
section_title: `Technology for Ongoing Monitoring and Investigations > Introduction: Technology for ongoing monitoring and investigations`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "AFC监控与调查技术概述",
      "title_en": "Overview of Technology for AFC Monitoring and Investigations",
      "covered_units": [
        {
          "unit_id": "v7u_N004285",
          "unit_type": "fact",
...
```text
[v7u_N004285|4285] This module covers the critical role technology plays in AFC monitoring and investigations due to the large volume of customers and transactions that organizations need to monitor.
ZH: 技术在海量客户和交易监控中发挥关键作用，支持金融犯罪防控监测与调查。

[v7u_N004286|4286] Real-time and batch payment screening help prevent sanctions evasion and detect financial crime.
ZH: 实时和批量支付筛查有助于防止制裁规避和检测金融犯罪。

[v7u_N004287|4287] Over time, this technology has evolved from rules-based systems to contextual monitoring, integrating network analysis and AI to view transactions in a broader context.
ZH: 监控技术从基于规则的系统演变为情境监控，整合网络分析和AI以在更广背景下审视交易。

[v7u_N004288|4288] This module also illustrates how effective transaction monitoring requires scenario development, calibration, ongoing testing and tuning, and governance.
ZH: 有效的交易监控需要情景开发、校准、持续测试调优和治理。

[v7u_N004289|4289] AFC investigations require technology solutions for network analysis, case management, blockchain tracing, and reporting.
ZH: 金融犯罪防控调查需要网络分析、案件管理、区块链追踪和报告等技术解决方案。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "技术在海量客户和交易监控中发挥关键作用，支持金融犯罪防控监测与调查。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅陈述技术的一般作用和支持关系，未涉及特定主体、条件、动作或判断的有向结构，基础KG已能充分表达。"
    },
    {
      ...
      "proposition": "实时和批量支付筛查有助于防止制裁规避和检测金融犯罪。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "表达筛查技术的一般贡献和效果，属于普通因果关系，无具体程序性主体、条件或决策链，基础KG可覆盖。"
    },
    {
      ...
      "proposition": "监控技术从基于规则的系统演变为情境监控，整合网络分析和AI以在更广背景下审视交易。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述技术演变和功能组成，无明确的触发条件、主体动作或判断分支，属于事实性概述，基础KG已足够。"
    },
    {
      ...
      "proposition": "有效的交易监控需要情景开发、校准、持续测试调优和治理。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "列出有效监控所需的要素，未指定主体、条件或执行顺序，属于组成清单和一般要求，基础KG可表达。"
    },
    {
      ...
      "proposition": "金融犯罪防控调查需要网络分析、案件管理、区块链追踪和报告等技术解决方案。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "列举调查所需技术方案，无具体程序性条件、判断或应对链，仅为领域知识，基础KG已覆盖。"
    }
  ],
  "cards": [],
  "skip_reason": "当前section为介绍性内容，各单元仅陈述技术的一般作用、演变、需求组成等事实，缺乏超出基础KG表达能力的局部程序性或判断性有向结构（如明确主体在条件、标准约束下的动作、判断或分支），因此无P7C增量卡片。"
}
```
