...
[
  {
    ...
    "proposition": "CashBayou因持有并转换客户资金而需持有MSB牌照。",
    "source_quotes": [
      "CashBayou’s platform is structured in such a way that they hold buyers’ funds temporarily and convert them into the sellers' preferred currency before transferring them to sellers. Because of this, they are required to have an MSB license."
    ],
    "relation_cues": [
      "because of",
      "required"
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "CashBayou持有买家资金并转换为卖家货币"
      ],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "需持有MSB牌照",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000768",
        "quote": "CashBayou’s platform is structured in such a way that they hold buyers’ funds temporarily and convert them into the sellers' preferred currency before transferring them to sellers. Because of this, they are required to have an MSB license."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "Emma在收到异常交易警报后展开调查，发现高频低额交易模式引发洗钱红旗，并意识到KYC治理不足。",
    "source_quotes": [
      "On her second day on the job, she receives an alert about unusual transaction patterns. She quickly gathers her team to investigate.",
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "调查异常交易模式",
      "outcomes_or_paths": [
        "发现高频低额交易模式，引发洗钱红旗",
        "意识到KYC治理不足"
      ]
    ...
    "evidence_spans": [
      {
        "unit_id": "v7u_N000770",
        "quote": "On her second day on the job, she receives an alert about unusual transaction patterns. She quickly gathers her team to investigate."
      },
      {
        "unit_id": "v7u_N000771",
  ...
  },
  {
    ...
    "proposition": "对买家和店主审查不足可能使平台面临金融犯罪、欺诈和监管风险，可能导致服务暂停。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "识别审查不足的风险",
      "outcomes_or_paths": [
        "平台面临金融犯罪、欺诈和监管风险",
        "可能导致服务暂停"
      ]
  ...
  },
  {
    ...
    "proposition": "PaySecure要求CashBayou提供交易信息并了解尽职调查流程，在会议中表达对政策的担忧并强调合作监控。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "PaySecure对CashBayou提出合规要求并表达担忧",
      "outcomes_or_paths": [
        "强调持续合作和严格监控"
      ]
    },
  ...
  },
  {
    ...
    "proposition": "CardGuard要求CashBayou调整尽职调查程序以符合其标准，否则终止合作。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [
        "CashBayou的尽职调查程序需符合CardGuard标准"
      ],
      "focal_handling_or_judgment": "CardGuard提出合规要求并威胁终止合作",
      "outcomes_or_paths": [
        "如果不符合则终止合作"
      ]
    },
