...
section_title: `Technology for AFC Compliance > Key takeaways`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "通过审查和技术升级加强AFC合规",
      "title_en": "Enhance AFC Compliance through Review and Technology Upgrade",
      "covered_units": [
        {
          "unit_id": "v7u_N003725",
          "unit_type": "rule",
...
```text
[v7u_N003725|3725] Enhance your AFC compliance program by conducting a comprehensive review and upgrading existing technology.
ZH: 通过全面审查和升级现有技术来增强金融犯罪防控合规计划
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "机构：通过全面审查和升级现有技术来增强金融犯罪防控合规计划",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题为一条孤立建议，包含手段（审查、技术升级）与目标（增强合规计划）的因果关系，未明确特定主体职责、条件分支、判断标准或独立结果，基础KG已能将其作为prescribes_measure事实保存，无超出定义、分类、事实之外的有向程序性结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达：文本仅提出通过审查和技术升级增强AFC合规计划的建议，不包含条件化判断、主体职责交接或独立决策链路，无P7C增量结构。"
}
```
