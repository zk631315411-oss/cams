...
> **解析被推迟（DEFERRED）**
>
> 选项C的正确性无法从提供的教材材料中得到支撑。核心 gap：选项C描述的行为「新客户倾向于尽量减少直接交流，主要依赖间接沟通方式」在现有教材单元中未作为金融犯罪红旗信号出现。尝试匹配单元 v7u_N003661（P364），该单元仅说明客户尽职调查后出现红旗信号可拒绝客户，未定义具体红旗行为，无法桥接至「回避直接交流」；v7u_N002700（P272）为风险敞口案例，与交流方式无关。不存在任何单元将「减少直接交流」列为获取客户数据时的危险信号，证据整体偏弱，无法弥合，硬写解析将导致证据歪曲。
>
> 该题需人工撰写解析。
