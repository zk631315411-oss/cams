...
教材分别支持两类有利于提高反洗钱计划质量的做法：第一，独立审计对第一、二道防线进行交叉检查（P256）；第二，通过提升员工能力、突出薄弱环节开展培训与持续改进（P314）。但v7原文没有把这两段表述逐字定义为题干所说的“effective challenge”或“continuous cross-training”，因此D应理解为四个选项中与教材质量控制和能力建设最接近的组合，而不是教材对题干术语的逐字复述。其逻辑是：独立检查发现控制缺陷，持续培训和改进帮助组织补足能力缺口。相比之下，A只说基本培训，B可能削弱合规职能的独立挑战，C让审计人员直接提供处方式指导，均不如D完整覆盖“检查+能力建设”两方面。
