...
FATF建议明确要求「各辖区应设立金融情报机构（FIU）以分析可疑交易报告并支持执法调查」（P149）。FIU是跨境资金追踪情报交换的核心节点——当资金流经的国家中有一个或多个国家未设立FIU时，该节点缺失，无法完成「FIU应自发或应请求相互传播金融情报」的标准协作流程（P231）。题干问的是「组织挑战」，即体制层面而非个案层面的障碍,FIU的制度性缺位直接导致在所有相关国家同步开展调查难以实现。选项C描述的正是这种因某国缺少FIU而造成的调查困境。
...
- **A 错误（题干对照）｜范围或程度偏差**：选项A指沟通方式和语言不统一。教材提及公私合作（PPP）中缺乏明确沟通渠道会阻碍成功（P235），但这属于合作机制内的操作细节，并非跨境洗钱调查中最根本的组织障碍。相比之下，缺少FIU直接导致情报交换链路断裂，比沟通方式不统一更致命。
- **B 错误（题干对照）｜范围或程度偏差**：选项B指因外国FIU等待第三方查询结果导致延误。教材中提到延迟确为跨境合作中的现实问题，但FATF标准已为FIU间的信息交换设立了通道（P231），FIU等待第三方结果属于具体个案流程中的信息获取环节，不如C项所揭示的「某国根本没有FIU」那样构成制度性障碍。
- **D 错误（题干对照）｜主体或阶段错配**：选项D指高级政客对当地FIU的影响力干扰调查。埃格蒙特集团确有促进FIU运作自主性的目标（P167），政客干预是FIU独立性不足时的风险。但题干中「组织挑战」更直接地与FIU是否存在这一制度前提相关——若无FIU，连被干预的主体都不存在，C项描述的情况比D项的干预问题更基础。

## 【易错提醒】

跨境合作中沟通不畅或第三方响应延迟（选项A、B）是操作层面的摩擦，FIU的制度性缺位（选项C）是结构层面的障碍——前者是「有但不好用」，后者是「根本没有」。教材对FIU设置的要求（P149）表明，各国设立FIU是国际合作的前提条件。区分这两类障碍，要看问题出在「合作流程内」还是「合作前提上」。
