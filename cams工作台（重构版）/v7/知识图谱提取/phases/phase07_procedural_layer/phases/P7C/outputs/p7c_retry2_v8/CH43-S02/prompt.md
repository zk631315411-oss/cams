...
section_title: `Additional onboarding controls for high-risk scenarios > Function of quality control`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "质量控制与质量保证：定义与区别",
      "title_en": "Quality Control and Quality Assurance: Definitions and Distinction",
      "covered_units": [
        {
          "unit_id": "v7u_N003114",
    ...
    {
      "title_zh": "金融犯罪防控合规中质量控制的主动目标",
      "title_en": "Primary Objectives of Quality Control in AFC Compliance",
      "covered_units": [
        {
          "unit_id": "v7u_N003122",
          "unit_type": "fact",
    ...
    {
      "title_zh": "提升质量控制有效性的措施",
      "title_en": "Measures to Enhance QC Effectiveness",
      "covered_units": [
        {
          "unit_id": "v7u_N003127",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "质量控制与质量保证：定义与区别",
      "target_title": "金融犯罪防控合规中质量控制的主动目标",
      "relation_type": "prepares"
    },
    {
      "source_title": "金融犯罪防控合规中质量控制的主动目标",
      "target_title": "提升质量控制有效性的措施",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003114|3114] Quality control (QC) is a critical function within an AFC compliance framework. It ensures accuracy, consistency, and regulatory adherence in KYC, CDD, and transaction monitoring outputs. By detecting errors, inconsistencies, and potential non-compliance, QC strengthens the risk-based approach required by regulators.
ZH: 质量控制是金融犯罪防控合规框架中的关键职能，确保了解你的客户、客户尽职调查和交易监控的准确性和合规性

[v7u_N003115|3115] QC might be confused with quality assurance (QA).
ZH: 质量控制可能与质量保证混淆

[v7u_N003116|3116] Although QA and QC both enhance compliance efficiency, they serve different purposes.
ZH: 质量保证和质量控制目的不同，但都提升合规效率

[v7u_N003117|3117] The purpose of QA is to ensure that policies and procedures are properly executed and that processes are continuously improved.
ZH: 质量保证的目的是确保政策和程序得到正确执行并持续改进

[v7u_N003118|3118] QC ensures that outputs meet the required standards.
ZH: 质量控制的目的是确保输出符合要求标准

[v7u_N003119|3119] For example, examining PEP files (the output) to ensure all requisite data points are accurately captured would be part of the QC function.
ZH: 质量控制示例：检查政治敏感人物档案以确保数据准确

[v7u_N003120|3120] Examining the PEP due diligence process, the underlying procedures, and the actions (the process) would be part of the QA function.
ZH: 质量保证示例：审查政治敏感人物尽职调查流程和程序

[v7u_N003121|3121] The primary objectives of QC in AFC compliance include:
ZH: 金融犯罪防控合规中质量控制的主要目标

[v7u_N003122|3122] Error detection and correction by identifying incomplete, incorrect, or outdated KYC records.
ZH: 通过识别不完整、不正确或过时的了解你的客户记录来检测和纠正错误

[v7u_N003123|3123] Adherence to regulations by ensuring compliance with global and jurisdictional AFC requirements.
ZH: 确保遵守全球及司法辖区的金融犯罪防控要求

[v7u_N003124|3124] Output standardization by enforcing uniform KYC, risk assessment, and documentation standards.
ZH: 通过强制执行统一的了解你的客户、风险评估和文档标准实现输出标准化

[v7u_N003125|3125] Training and continuous improvement by enhancing staff competency and highlighting any weaknesses.
ZH: 通过提升员工能力和突出薄弱环节进行培训与持续改进

[v7u_N003126|3126] To enhance QC effectiveness, financial institutions should:
ZH: 金融机构提升质量控制有效性的措施

[v7u_N003127|3127] Conduct regular KYC reviews by systematically auditing customer files and risk assessments.
ZH: 通过系统审计客户档案和风险评估进行定期了解你的客户审查

[v7u_N003128|3128] Consider automation by utilizing the latest tools and technologies, such as AI, to flag inconsistencies and missing data.
ZH: 考虑利用人工智能等最新工具和技术实现自动化，标记不一致和缺失数据

[v7u_N003129|3129] Establish independent QC teams to ensure unbiased oversight of outputs.
ZH: 建立独立的质量控制团队以确保对输出的无偏见监督

[v7u_N003130|3130] Enhance internal reporting by tracking QC trends, common deficiencies, and corrective actions.
ZH: 通过跟踪质量控制趋势、常见缺陷和纠正措施来加强内部报告

[v7u_N003131|3131] By implementing structured QC mechanisms, financial institutions reduce compliance risks, improve regulatory adherence, and strengthen financial crime prevention efforts.
ZH: 结构化质量控制机制降低合规风险、改善监管遵守并加强金融犯罪预防
```
