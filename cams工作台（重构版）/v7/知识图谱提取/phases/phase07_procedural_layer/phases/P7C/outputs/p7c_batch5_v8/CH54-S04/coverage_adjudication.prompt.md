...
section_title: `Technology for KYC > Digital onboarding technology`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "数字身份验证技术的优势",
      "title_en": "Advantages of Digital Identity Verification Technologies",
      "covered_units": [
        {
          "unit_id": "v7u_N004083",
          "unit_type": "fact",
    ...
    {
      "title_zh": "数字准入方法与技术",
      "title_en": "Digital Onboarding Methods and Technologies",
      "covered_units": [
        {
          "unit_id": "v7u_N004089",
          "unit_type": "process",
    ...
    {
      "title_zh": "AI驱动的威胁与缓解控制",
      "title_en": "AI-Enabled Threats and Mitigation Controls",
      "covered_units": [
        {
          "unit_id": "v7u_N004096",
          "unit_type": "fact",
    ...
    {
      "title_zh": "FATF关于数字身份用于客户尽职调查的指引",
      "title_en": "FATF Guidance on Digital Identity for CDD",
      "covered_units": [
        {
          "unit_id": "v7u_N004098",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "数字身份验证技术的优势",
      "target_title": "数字准入方法与技术",
      "relation_type": "prepares"
    },
    {
      "source_title": "数字准入方法与技术",
      "target_title": "AI驱动的威胁与缓解控制",
      "relation_type": "contrasts"
    },
    {
      "source_title": "AI驱动的威胁与缓解控制",
      "target_title": "FATF关于数字身份用于客户尽职调查的指引",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N004081|4081] Online and mobile identity verification technologies have become essential for customer onboarding in financial institutions. They use modern technologies for collecting, verifying, and presenting data.
ZH: 在线和移动身份验证技术对金融机构客户准入至关重要

[v7u_N004082|4082] FATF emphasizes several advantages for implementing the technologies:
ZH: FATF强调实施数字身份技术的多项优势

[v7u_N004083|4083] Improved risk management: These technologies help financial institutions identify, understand, and manage risks more effectively.
ZH: 数字身份技术帮助金融机构更有效地识别、理解和管理风险

[v7u_N004084|4084] Faster data processing: They process and analyze large sets of data more quickly and accurately.
ZH: 数字身份技术更快更准确地处理和分析大量数据

[v7u_N004085|4085] Improved efficiency: They enhance the efficiency of onboarding practices.
ZH: 数字身份技术提升客户准入流程的效率

[v7u_N004086|4086] Greater auditability: They achieve greater auditability, accountability, and governance.
ZH: 数字身份技术实现更强的可审计性、问责性和治理能力

[v7u_N004087|4087] Reduced cost: They reduce costs, allowing resources to focus on more complex financial crime areas.
ZH: 数字身份技术降低成本，使资源聚焦于更复杂的金融犯罪领域

[v7u_N004088|4088] Versatile data handling: They collect, verify, and present data efficiently.
ZH: 数字身份技术高效收集、验证和呈现数据

[v7u_N004089|4089] During the onboarding process, organizations can authenticate documents more quickly and accurately by having customers upload scans or photos of required documents, such as identification cards or passports, for verification.
ZH: 客户上传证件扫描件或照片供验证，实现快速准确的文档认证

[v7u_N004090|4090] AI tools can automatically verify the authenticity of these documents by cross-referencing them with trusted databases.
ZH: AI工具通过与可信数据库交叉验证，自动核实文档真实性

[v7u_N004091|4091] Machine learning algorithms can assess the risk profile of new customers in real time.
ZH: 机器学习算法可实时评估新客户的风险画像

[v7u_N004092|4092] Financial institutions use methods such as biometrics to verify customers, including facial and voice recognition and liveness checks.
ZH: 金融机构使用面部识别、语音识别和活体检测等生物识别技术验证客户

[v7u_N004093|4093] AI chatbots further improve customer experience by providing instant answers to frequent questions and guiding customers through the onboarding process.
ZH: AI聊天机器人通过即时回答常见问题并引导客户完成准入流程，改善客户体验

[v7u_N004094|4094] Integrated live chat or video call support from human agents is also available when needed.
ZH: 必要时可提供人工客服的实时聊天或视频通话支持

[v7u_N004095|4095] Various onboarding technologies can work together to significantly enhance the onboarding process.
ZH: 多种准入技术协同工作，显著提升客户准入流程

[v7u_N004096|4096] Criminals continue to use AI to outwit and overcome an organization’s controls. The use of deepfakes and synthetic identities has increased with the advent of AI tools that can create such identities at scale. It is almost impossible to verify identity documents with the naked eye, given the sophistication and criminal use of AI.
ZH: 犯罪分子利用AI（如深度伪造和合成身份）绕过机构控制，肉眼难以验证身份文件

[v7u_N004097|4097] Organizations have therefore deployed additional checks to reliably verify and authenticate documents.
ZH: 机构部署额外检查措施以可靠地验证和认证文件

[v7u_N004098|4098] Also, FATF has issued guidelines to help organizations determine the suitability of digital identities for CDD. In its Guidance on Digital Identity, published in March of 2020, FATF covers principles of a digital identify framework and how digital identities can be used for customer onboarding and due diligence in line with FATF's Recommendation 10.
ZH: FATF发布《数字身份指引》，涵盖数字身份框架原则及如何用于客户尽职调查
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "数字身份技术带来多种优势（改进风险管理、更快数据处理、提高效率、增强审计性、降低成本、多功能数据处理）",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些是技术的效果或功能，属于一般事实或因果陈述，基础KG已能充分表达作为技术优势，无具体主体条件判断或程序性有向结构。"
    },
    {
      ...
      "proposition": "在入职过程中，组织通过客户上传文件进行快速准确的文档认证",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述常规文档认证步骤，无判断分支或触发反应的结构，基础KG可作为过程描述存储。"
    },
    {
      ...
      "proposition": "AI工具通过与可信数据库交叉验证自动核实文档真实性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述AI工具的自动化验证能力，无特定条件导向的应对或判断链，基础KG可表达为事实。"
    },
    {
      ...
      "proposition": "机器学习算法实时评估新客户的风险画像",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述ML算法的评估功能，未涉及具体条件分支或决策后果，基础KG可表达为事实。"
    },
    {
      ...
      "proposition": "金融机构使用生物识别技术（如面部识别、语音识别、活体检测）验证客户",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述使用生物识别进行客户验证的方法，无有向判断或应对结构，基础KG可表达为实践事实。"
    },
    {
      ...
      "proposition": "AI聊天机器人通过即时回答和引导改善客户入职体验",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述聊天机器人功能，无程序性或判断性结构，基础KG可存储。"
    },
    {
      ...
      "proposition": "必要时提供人工实时聊天或视频通话支持",
      "decision": "kg_only",
      "card_id": null,
      "reason": "可选支持功能，无特定条件导向的主体动作或判断链，基础KG可存储。"
    },
    {
      ...
      "proposition": "多种入职技术协同工作显著提升入职流程",
      "decision": "kg_only",
      "card_id": null,
      "reason": "总结性陈述，无具体有向结构，基础KG可表达为一般事实。"
    },
    {
      ...
      "proposition": "犯罪分子使用AI绕过控制导致肉眼验证不可靠，组织因此部署额外检查以可靠验证文件",
      "decision": "p7c_card",
      "card_id": "p7card_CH54-S04_001",
      "reason": "明确的事件触发应对链：AI威胁 -> 部署额外检查，构成有向的应对结构，超出基础KG的孤立事实存储。"
    },
    {
      ...
      "proposition": "FATF发布数字身份指引，帮助组织确定数字身份用于CDD的适合性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅陈述指引发布及其目的，未描述组织实际依据指引进行判断的动作，无具体有向结构，基础KG可存储指引内容。"
    }
  ],
  "cards": [
    {
      ...
      "section_id": "CH54-S04",
      "card_nature": "control",
      "title": "AI威胁触发组织部署额外文件验证检查",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "犯罪分子利用AI（深度伪造和合成身份）绕过控制，肉眼难以验证身份文件",
          "evidence_unit_ids": [
            "v7u_N004096"
          ],
      ...
      "flow_edges": [
        {
          ...
          "source_quote": "Organizations have therefore deployed additional checks to reliably verify and authenticate documents."
        }
      ],
      "source_unit_ids": [
        "v7u_N004096",
      ...
      "review_notes": "增量命题：犯罪分子利用AI绕过控制（事件）→ 组织部署额外检查（应对）；KG不足：基础KG可分别存储AI威胁与额外检查措施，但无法表达事件触发的有向应对链；选项判断：可确认或排除关于应对措施触发原因的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
