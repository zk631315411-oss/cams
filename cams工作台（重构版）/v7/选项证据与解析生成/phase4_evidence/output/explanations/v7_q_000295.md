...
BCBS指南支持银行和监管机构实施FATF的AML/CFT建议（P166）。在客户识别和接纳的具体内容上，教材直接要求**识别和核实受益所有人以及董事、高级管理层和授权签字人**（P311），这与B逐项对应。教材还明确规定CDD是**强制性的**，并应根据**实体风险、司法管辖区要求和监管期望变化**（P304），因此C对应风险差异化的CDD。这里B、C不是仅凭“BCBS支持FATF”作泛化推断，而是由具体CDD单元直接支撑；BCBS背景单元负责说明适用对象，CDD单元负责说明选项内容。
