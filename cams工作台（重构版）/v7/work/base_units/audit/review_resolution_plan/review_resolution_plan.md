...
Generated at: 2026-07-03T00:38:46
Input: `D:\守正公司工作区\cams考试\cams工作台（重构版）\v7\work\base_units\draft\v2_fullbook\v7_units_draft.v2_fullbook_all.prefreeze_qa.json`
...
- cross_block_join_candidate: 139
...
- inspect_neighbor_blocks_or_pdf_join: 147
...
### v7u_tmp_pilot_v2fb_understanding-afc-technology_o000_l020_N000038
...
- page: 375 / pdf 380
- heading: Understanding AFC technology / AFC technology overview
- knowledge_en: Incomplete sentence fragment
- en_quote: This article provides a good reminder that organizations need to
- risk_flags: ["antecedent_requires_prior_context", "block_may_continue_next", "derived_from_fullbook_llm_grouping", "incomplete_sentence", "source_sentence_may_continue_next_block", "source_text_lacks_terminal_punctuation", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b002961` P375: While many of these control functions are highly dependent on technology tools, organizations that have rushed to implement the latest technologies without appropriate risk assessment and understanding have had to suffer consequences. As cited in the Moneylaundering.com article, "Regtech Failures Plaguing European Banks," Carolin Gardner, the European Banking Authority’s head of AML, states, “One of the challenges, b...
  - current `v7en_b002962` P375: This article goes on to discuss how “unthinking” reliance on new technologies accounted for over half of the more than 250 cases in which financial services companies were found to have breached anti-money laundering rules in the EU in 2024. This article provides a good reminder that organizations need to
  - next `v7en_b002963` P376: follow the risk assessment fundamentals and sound technology implementation principles to gain advantages from innovative technology.

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o000_l020_N000039
...
- page: 376 / pdf 381
- heading: Understanding AFC technology / AFC technology overview
- knowledge_en: Follow risk assessment fundamentals and sound technology principles for innovative technology advantages
- en_quote: follow the risk assessment fundamentals and sound technology implementation principles to gain advantages from innovative technology.
- risk_flags: ["derived_from_fullbook_llm_grouping", "heading_context_reused_across_page", "paragraph_continues_across_page_candidate", "previous_block_may_continue_here", "source_sentence_may_continue_from_previous_block", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b002962` P375: This article goes on to discuss how “unthinking” reliance on new technologies accounted for over half of the more than 250 cases in which financial services companies were found to have breached anti-money laundering rules in the EU in 2024. This article provides a good reminder that organizations need to
  - current `v7en_b002963` P376: follow the risk assessment fundamentals and sound technology implementation principles to gain advantages from innovative technology.
  - next `v7en_b002964` P376: ## Global AFC innovation

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o020_l020_N000022

- action: inspect_neighbor_blocks_or_pdf_join
- rationale: source sentence appears split across adjacent blocks
- chapter: Understanding AFC technology
- page: 381 / pdf 386
- heading: Understanding AFC technology / Adopting a risk-based approach when choosing AFC technology
- knowledge_en: Incomplete sentence fragment
- en_quote: Before committing to a full system
- risk_flags: ["block_may_continue_next", "derived_from_fullbook_llm_grouping", "incomplete_sentence", "source_sentence_may_continue_next_block", "source_text_lacks_terminal_punctuation", "zh_subspan_unavailable"]
  ...
  - prev `v7en_b002999` P381: If the organization has limited experience in selecting AFC technology, engaging strategic advisory firms may further enhance decision-making. Experts in financial crime compliance and technology may provide independent evaluations, recommend best-fit solutions, and ensure alignment with evolving regulatory requirements. Their advice may also help the organization navigate complex implementation challenges, potential...
  - current `v7en_b003000` P381: A risk-based approach influences which technology is most fit for purpose. For instance, not all monitoring and screening functions benefit equally from new technologies. While AI-driven transaction monitoring and machine learning-based name screening may enhance efficiency and effectiveness, investigative and analytical tasks may consume the most resources and be good candidates for automation. Before committing to ...
  - next `v7en_b003001` P382: replacement, organizations may consider augmentation. For example, they might consider enhancing existing systems with new capabilities, thereby reducing immediate cost and disruption while still improving effectiveness.

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o020_l020_N000023
...
- page: 382 / pdf 387
- heading: Understanding AFC technology / Adopting a risk-based approach when choosing AFC technology
- knowledge_en: Example of augmentation as an alternative to replacement
- en_quote: replacement, organizations may consider augmentation. For example, they might consider enhancing existing systems with new capabilities, thereby reducing immediate cost and disruption while still improving effectiveness.
- risk_flags: ["derived_from_fullbook_llm_grouping", "heading_context_reused_across_page", "paragraph_continues_across_page_candidate", "previous_block_may_continue_here", "source_sentence_may_continue_from_previous_block", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b003000` P381: A risk-based approach influences which technology is most fit for purpose. For instance, not all monitoring and screening functions benefit equally from new technologies. While AI-driven transaction monitoring and machine learning-based name screening may enhance efficiency and effectiveness, investigative and analytical tasks may consume the most resources and be good candidates for automation. Before committing to ...
  - current `v7en_b003001` P382: replacement, organizations may consider augmentation. For example, they might consider enhancing existing systems with new capabilities, thereby reducing immediate cost and disruption while still improving effectiveness.
  - next `v7en_b003002` P382: Selecting AFC technology should also align with business strategy. For instance, an organizational strategy to move data processing to the cloud influences AFC system options. A well-considered AFC technology strategy leverages similar requirements across AFC dimensions. For example, consider entity resolution, which refers to the process of confirming whether multiple records are referring to the same data item, suc...

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o040_l020_N000007

- action: inspect_neighbor_blocks_or_pdf_join
- rationale: source sentence appears split across adjacent blocks
- chapter: Understanding AFC technology
- page: 383 / pdf 388
- heading: Understanding AFC technology / AFC tools, choices, and considerations
- knowledge_en: incomplete sentence about AI benefits
- en_quote: Next-generation technologies, such as machine learning and other forms of AI, can enhance detection capabilities, streamline operations, and reduce
- risk_flags: ["block_may_continue_next", "derived_from_fullbook_llm_grouping", "incomplete_sentence", "source_sentence_may_continue_next_block", "source_text_lacks_terminal_punctuation", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b003013` P383: Cost considerations include internal operating expenses related to system maintenance and output management costs resulting from false positives. Inefficient systems drive up costs by producing excessive alerts, increasing manual workload, and introducing additional risk through delayed processing.
  - current `v7en_b003014` P383: Next-generation technologies, such as machine learning and other forms of AI, can enhance detection capabilities, streamline operations, and reduce
  - next `v7en_b003015` P384: false positives. Institutions should evaluate whether to integrate these advancements into existing systems or replace outdated systems entirely. Implementation complexity, data quality, and broader organizational readiness are critical success factors to consider when deciding whether to migrate to new technology stacks.

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o040_l020_N000008
...
- page: 384 / pdf 389
- heading: Understanding AFC technology / AFC tools, choices, and considerations
- knowledge_en: fragment: false positives
- en_quote: false positives.
- risk_flags: ["derived_from_fullbook_llm_grouping", "heading_context_reused_across_page", "paragraph_continues_across_page_candidate", "previous_block_may_continue_here", "source_sentence_may_continue_from_previous_block", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b003014` P383: Next-generation technologies, such as machine learning and other forms of AI, can enhance detection capabilities, streamline operations, and reduce
  - current `v7en_b003015` P384: false positives. Institutions should evaluate whether to integrate these advancements into existing systems or replace outdated systems entirely. Implementation complexity, data quality, and broader organizational readiness are critical success factors to consider when deciding whether to migrate to new technology stacks.
  - next `v7en_b003016` P384: Many organizations delay upgrades due to limited resources or expertise. Engaging an advisory firm may provide insight into best practices, market trends, and vendor selection. External partners help strategize, assess existing technologies, and implement solutions that align with risk profiles and operational needs.

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o080_l020_N000012

- action: inspect_neighbor_blocks_or_pdf_join
- rationale: source sentence appears split across adjacent blocks
- chapter: Understanding AFC technology
- page: 392 / pdf 397
- heading: Understanding AFC technology / Impact of privacy regulations on technology use
- knowledge_en: Incomplete sentence about PET capabilities
- en_quote: These technologies enable secure data analysis and information sharing while preserving privacy and regulatory
- risk_flags: ["antecedent_requires_prior_context", "block_may_continue_next", "derived_from_fullbook_llm_grouping", "incomplete_sentence", "source_sentence_may_continue_next_block", "source_text_lacks_terminal_punctuation", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b003065` P392: Additionally, third-party vendors providing AFC technology must comply with privacy laws, requiring thorough due diligence, contractual safeguards, and clear service-level agreements to manage data processing responsibilities.
  - current `v7en_b003066` P392: To address these challenges, banks can adopt privacy-enhancing technologies (PET), such as federated learning, secure multiparty computation, or data anonymization. These technologies enable secure data analysis and information sharing while preserving privacy and regulatory
  - next `v7en_b003067` P393: compliance, ensuring that AFC efforts remain effective without compromising personal data protection.

### v7u_tmp_pilot_v2fb_understanding-afc-technology_o080_l020_N000013
...
- page: 393 / pdf 398
- heading: Understanding AFC technology / Impact of privacy regulations on technology use
- knowledge_en: fragment continuing from previous block
- en_quote: compliance, ensuring that AFC efforts remain effective without compromising personal data protection.
- risk_flags: ["derived_from_fullbook_llm_grouping", "heading_context_reused_across_page", "paragraph_continues_across_page_candidate", "previous_block_may_continue_here", "source_sentence_may_continue_from_previous_block", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b003066` P392: To address these challenges, banks can adopt privacy-enhancing technologies (PET), such as federated learning, secure multiparty computation, or data anonymization. These technologies enable secure data analysis and information sharing while preserving privacy and regulatory
  - current `v7en_b003067` P393: compliance, ensuring that AFC efforts remain effective without compromising personal data protection.
  - next `v7en_b003068` P393: ## Privacy-enhancing technology

### v7u_tmp_pilot_v2fb_us-aml-cft-regulatory-landscape_o020_l020_N000002

- action: inspect_neighbor_blocks_or_pdf_join
- rationale: source sentence appears split across adjacent blocks
- chapter: US AML/CFT regulatory landscape
- page: 185 / pdf 190
- heading: US AML/CFT regulatory landscape / The Anti-Money Laundering Act of 2020
- knowledge_en: Incomplete conditional statement about regulator action
- en_quote: If a financial institution is found in violation of US laws and regulations related to financial crime, these regulators can
- risk_flags: ["block_may_continue_next", "derived_from_fullbook_llm_grouping", "source_sentence_may_continue_next_block", "source_text_lacks_terminal_punctuation", "zh_subspan_unavailable"]
  ...
  - prev `v7en_b001488` P185: The SEC oversees all aspects of the securities industry, ensuring investor protection, fair, orderly, and efficient markets, and capital formation. The president, with the Senate’s advice and consent, appoints up to five commissioners to lead the agency.
  - current `v7en_b001489` P185: By overseeing banking operations, managing systemic risks, insuring deposits, and regulating securities, these regulators collectively foster a resilient and well-functioning financial industry. If a financial institution is found in violation of US laws and regulations related to financial crime, these regulators can
  - next `v7en_b001490` P186: impose civil monetary penalties, forfeiture of proceeds, limitations on future business activities, and criminal charges against the bank or its officers.

### v7u_tmp_pilot_v2fb_us-aml-cft-regulatory-landscape_o020_l020_N000003
...
- page: 186 / pdf 191
- heading: US AML/CFT regulatory landscape / The Anti-Money Laundering Act of 2020
- knowledge_en: fragment listing penalties
- en_quote: impose civil monetary penalties, forfeiture of proceeds, limitations on future business activities, and criminal charges against the bank or its officers.
- risk_flags: ["derived_from_fullbook_llm_grouping", "heading_context_reused_across_page", "paragraph_continues_across_page_candidate", "previous_block_may_continue_here", "source_sentence_may_continue_from_previous_block", "zh_subspan_unavailable"]

  Neighbor context:

  - prev `v7en_b001489` P185: By overseeing banking operations, managing systemic risks, insuring deposits, and regulating securities, these regulators collectively foster a resilient and well-functioning financial industry. If a financial institution is found in violation of US laws and regulations related to financial crime, these regulators can
  - current `v7en_b001490` P186: impose civil monetary penalties, forfeiture of proceeds, limitations on future business activities, and criminal charges against the bank or its officers.
  - next `v7en_b001491` P186: ## Case study: US regulatory enforcement actions
