...
section_title: `Second LOD's AFC role and its interaction with the front office > Establishing a culture of compliance`

section_text_with_unit_anchors:

```text
[v7u_N002600|2600] A strong culture of compliance is critical to the development and ongoing administration of an effective AFC program.
ZH: 强大的合规文化对于有效金融犯罪防控项目的建立和持续管理至关重要。

[v7u_N002601|2601] The ultimate responsibility for the compliance program belongs to the board of directors.
ZH: 董事会对合规计划承担最终责任

[v7u_N002602|2602] A culture of compliance determines how seriously an institution takes its obligations regarding AFC compliance.
ZH: 合规文化定义：机构对待金融犯罪防控义务的严肃程度

[v7u_N002603|2603] Organizations must determine whether the organization put forth sufficient effort to mitigate compliance risks through its processes, staff, technology, training, communication, and independent testing.
ZH: 机构必须评估其通过流程、人员、技术等缓解合规风险的努力是否充分

[v7u_N002604|2604] The Financial Crimes Enforcement Network (FinCEN), part of the US Department of Treasury, provided guidelines to establish and identify a culture of compliance.
ZH: 美国FinCEN发布了建立和识别合规文化的指引

[v7u_N002605|2605] Leadership must actively support and understand compliance efforts, including the filing of suspicious activity reports.
ZH: 领导层必须积极支持并理解合规工作，包括提交可疑活动报告

[v7u_N002606|2606] Leadership should consistently remind staff that compliance requirements should be prioritized over commercial interests.
ZH: 领导层应持续提醒员工合规要求优先于商业利益

[v7u_N002607|2607] Leadership should initiate this perspective in hopes that it will spread throughout the organization.
ZH: 领导层应倡导合规视角并期望其在整个组织内传播

[v7u_N002608|2608] This is called the “tone from the top.”
ZH: 这被称为“高层基调”

[v7u_N002609|2609] Compliance staff should be empowered to implement the organization’s AFC policies and share information across job functions.
ZH: 合规人员应被授权实施金融犯罪防控政策并跨职能共享信息

[v7u_N002610|2610] In a culture of compliance, accountable parties escalate, receive, and respond to compliance concerns effectively.
ZH: 合规文化中，责任方有效上报、接收和回应合规关切

[v7u_N002611|2611] A culture of compliance displays the core pillars of an AFC program. It ensures that the AFC functions have sufficient staff, appropriate and approved processes, proper training, and the necessary tools to work effectively. These actions show management’s support for compliance functions.
ZH: 合规文化体现金融犯罪防控项目的核心支柱：充足人员、流程、培训与工具

[v7u_N002612|2612] A culture of compliance has a strong and independent testing function. It also has management that responds quickly to findings of risk with meaningful change. These traits show that an organization prioritizes compliance.
ZH: 合规文化的特征：强大的独立测试职能及管理层对风险发现快速响应
```
...
[
  {
    "candidate_id": "s1c_gap_ch35_s03_sufficient_effort_determination",
    "unit_ids": [
      "v7u_N002603"
    ],
    "proposition": "机构必须判断其是否通过流程、人员、技术、培训、沟通和独立测试投入了足够努力来缓解合规风险。",
    "source_quotes": [
      "Organizations must determine whether the organization put forth sufficient effort to mitigate compliance risks through its processes, staff, technology, training, communication, and independent testing."
    ],
    "relation_cues": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [
        "通过其流程、人员、技术、培训、沟通和独立测试"
      ],
      "focal_handling_or_judgment": "判断机构是否投入了足够努力来缓解合规风险",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002603",
        "quote": "Organizations must determine whether the organization put forth sufficient effort to mitigate compliance risks through its processes, staff, technology, training, communication, and independent testing."
      }
    ],
    "induction": null,
    ...
    "gap_evidence": {
      ...
      "gap_reason": "S1.1未生成任何候选。该单元的核心判断（机构必须通过流程、人员等方面评估缓解合规风险的努力是否充分）未被任何已有候选承接，故作为缺口补充。"
    }
  }
]
```
