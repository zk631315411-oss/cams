...
section_title: `Concluding an investigation and suspicious activity reporting > Key takeaways`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "提交可疑活动报告的要求",
      "title_en": "SAR submission requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003556",
          "unit_type": "fact",
...
```text
[v7u_N003555|3555] When submitting a SAR:
ZH: 提交 SAR 时的关键要点列表引导。

[v7u_N003556|3556] Provide clear communication, evidence-based analysis, and strict compliance protocols to support investigations.
ZH: 提供清晰的沟通、基于证据的分析和严格的合规协议以支持调查。

[v7u_N003557|3557] Use headings, bullet points, and logical sequencing to simplify complex details.
ZH: 使用标题、要点和逻辑顺序简化复杂细节。

[v7u_N003558|3558] Write in plain English and highlight contradictions, such as stated goals versus transactions, to justify concerns.
ZH: 使用简明英语，突出矛盾（如陈述目标与交易不符）以证明担忧合理。

[v7u_N003559|3559] Submit reports promptly and avoid tipping off.
ZH: 及时提交报告并避免通风报信。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "提交SAR时，金融机构应提供清晰沟通、基于证据的分析和严格合规协议，以支持调查。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "属于一般规则性义务陈述，基础KG可保存为SAR内容要求，无明确的条件分支、特定主体判断或独立结果。"
    },
    {
      ...
      "proposition": "提交SAR时，应使用标题、要点和逻辑顺序简化复杂细节。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "写作格式建议，无程序性判断或方向性结构。"
    },
    {
      ...
      "proposition": "提交SAR时，应使用简明英语并突出矛盾以证明担忧合理。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "写作建议中的说明技巧，未形成条件判断或应对链条。"
    },
    {
      ...
      "proposition": "提交SAR时，应及时提交报告并避免通风报信。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "及时的提交义务和保密要求，属于一般规则，无增量有向结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达，当前section为SAR提交的写作要点总结，全部命题均为一般性义务或建议，无满足P7C增量的程序性或判断性有向结构。"
}
```
