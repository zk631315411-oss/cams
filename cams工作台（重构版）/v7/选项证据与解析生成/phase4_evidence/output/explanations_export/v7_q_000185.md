...
考点：识别内部人员因利益冲突而漠视风险评级的内幕活动指标

核心解析：关系经理可能因维护客户关系而忽视警示信号（P71），且薪酬结构带来的利益冲突会导致其不从反金融犯罪角度认定高风险（P71）。这两点构成了内部人员不当干预风险控制的典型指标。题干中客户经理主张推翻模型给出的高风险评级，正是利用职权漠视风险信号、试图维护客户关系的行为，与教材描述的内部人利益冲突直接吻合，因此可作为潜在内幕活动的指标。
...
B项错误：分享风险管理框架信息可能涉及保密纪律，但题干聚焦「内幕活动」（insider activity），教材将内部人风险的核心定位在利用职权掩盖风险信号或谋取私利，而非常规的信息披露。相比之下，A更直接地体现了内部人因利益驱动篡改风险判断的教材场景。
C项错误：未按时处理警报属于内控或绩效问题，教材未将其列为内幕活动指标。相比之下，A描述的是主动推翻风险评级的行为，更吻合教材中内部人因利益冲突忽视警示信号的特征。
D项错误：未记录护照信息开户违反了客户身份识别程序，属于合规或疏忽问题，教材未指向其作为内幕活动指标。题干更支持A这种内部人刻意干预风险判定、掩盖客户真实风险的行为。
