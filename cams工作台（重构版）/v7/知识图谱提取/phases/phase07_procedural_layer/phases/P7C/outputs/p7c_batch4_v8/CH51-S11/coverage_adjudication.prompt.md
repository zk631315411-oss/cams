...
section_title: `Understanding AFC technology > Integrating new AFC tools with existing systems and data`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "现有系统与数据质量的初步评估",
      "title_en": "Initial Assessment of Existing Systems and Data Quality",
      "covered_units": [
        {
          "unit_id": "v7u_N003902",
          "unit_type": "process",
    ...
    {
      "title_zh": "四大关键考量：可扩展性、灵活架构、集成与协作",
      "title_en": "Four Key Considerations: Scalability, Flexible Architecture, Integration, Collaboration",
      "covered_units": [
        {
          "unit_id": "v7u_N003904",
    ...
    {
      "title_zh": "AFC工具的长期可持续性与未来适应性",
      "title_en": "Long-term Sustainability and Future-proofing of AFC Tools",
      "covered_units": [
        {
          "unit_id": "v7u_N003911",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "现有系统与数据质量的初步评估",
      "target_title": "四大关键考量：可扩展性、灵活架构、集成与协作",
      "relation_type": "prepares"
    },
    {
      "source_title": "四大关键考量：可扩展性、灵活架构、集成与协作",
      "target_title": "AFC工具的长期可持续性与未来适应性",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003902|3902] When choosing and implementing a new AFC tool, organizations should first conduct a thorough assessment of existing systems, data quality, and integration challenges. A critical step is determining whether legacy databases and platforms are outdated and if they can be effectively migrated into the new system.
ZH: 选择实施新金融犯罪防控工具前需评估现有系统、数据质量和集成挑战

[v7u_N003903|3903] Poorly structured or inconsistent data can severely impact the effectiveness of next-generation technologies such as machine learning, contextual monitoring, and other forms of AI.
ZH: 结构不良或不一致的数据严重影响机器学习等下一代金融犯罪防控技术效果

[v7u_N003904|3904] There are four key considerations for evaluating new AFC technology: scalability, flexible architecture, integration, and collaboration.
ZH: 评估新金融犯罪防控技术的四个关键考量：可扩展性、灵活架构、集成与协作

[v7u_N003905|3905] Scalability: A robust AFC solution should accommodate organic growth, acquisitions, and new products or services. Scalability is essential to ensure compliance capabilities evolve alongside the organization’s expansion, minimizing the need for costly system replacements or frequent upgrades.
ZH: 可扩展性要求金融犯罪防控方案能适应有机增长、并购及新产品服务

[v7u_N003906|3906] Flexible architecture: Legacy system designs often create integration roadblocks. A flexible architecture emphasizes seamless connectivity across data platforms and application layers to build a unified compliance ecosystem.
ZH: 灵活架构强调跨数据平台和应用层的无缝连接，构建统一合规生态

[v7u_N003907|3907] For example, it is advisable to avoid separate data stores for each new system and to share customer segmentation and resolution tools across applications whenever possible.
ZH: 灵活架构示例：避免为每个新系统建立独立数据存储，共享客户细分工具

[v7u_N003908|3908] Prioritizing architecture that reduces data silos and system duplication enhances efficiency and performance.
ZH: 优先采用减少数据孤岛和系统重复的架构可提升效率与性能

[v7u_N003909|3909] Integration: A well-integrated AFC solution should streamline workflows and ensure interoperability across tools and datasets. New technologies should focus on efficient data sharing and automation, enabling organizations to respond swiftly to regulatory changes and emerging risks.
ZH: 良好集成的金融犯罪防控方案应简化工作流，确保工具与数据集互操作

[v7u_N003910|3910] Collaboration: A significant compliance risk arises when organizations make IT-driven architecture decisions without AFC input. Technology choices that do not fully support regulatory needs can constrain AFC professionals and lead to inefficiencies and potential compliance gaps. Close collaboration between AFC, IT, and business units is essential to ensure systems align with both regulatory and operational requirements.
ZH: 金融犯罪防控、IT与业务部门需紧密协作，避免IT主导决策导致合规风险

[v7u_N003911|3911] Additionally, organizations should consider the long-term sustainability of the AFC tool, ensuring it is built on adaptable frameworks that support evolving compliance landscapes. Prompt attention to data integrity, system compatibility, and governance processes will help institutions implement an AFC tool that not only meets current regulatory standards but also enables future technological advancements.
ZH: 机构应考虑金融犯罪防控工具的长期可持续性，确保其适应不断变化的合规环境
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "在选择和实施新AFC工具时，机构应首先进行彻底评估，确定现有系统、数据质量、集成挑战及遗留系统过时性和可迁移性",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S11_001",
      "reason": "明确的条件触发顺序和义务，基础KG仅描述过程而缺少方向性"
    },
    {
      ...
      "proposition": "结构不良或不一致的数据严重影响机器学习等下一代AFC技术的效果",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般原因-结果机制，由基础KG承接"
    },
    {
      ...
      "proposition": "在架构集成时，应避免为每个新系统建立独立数据存储，并尽可能共享客户细分和工具",
      "decision": "kg_only",
      "card_id": null,
      "reason": "最佳实践示例，无特定触发条件，基础KG可保存为一般建议"
    },
    {
      ...
      "proposition": "当组织进行IT驱动架构决策而没有AFC输入时，会产生重大合规风险",
      "decision": "kg_only",
      "card_id": null,
      "reason": "风险指标和因果解释，由基础KG承接"
    },
    {
      ...
      "proposition": "机构应考虑AFC工具的长期可持续性，确保其建立在适应性框架上",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般义务陈述，基础KG可表达"
    }
  ],
  "cards": [
    {
      ...
      "title": "AFC工具实施前的初步评估步骤",
      "flow_nodes": [
        {
          "node_id": "E1_CH51S11_001",
          "node_category": "entry",
        ...
        {
          "node_id": "P1_CH51S11_001",
          "node_category": "process",
          "node_type": "P1_assessment",
          "label": "机构应进行彻底评估，确定现有系统、数据质量、集成挑战及遗留系统过时性和可迁移性",
          "evidence_unit_ids": [
            "v7u_N003902"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          "edge_id": "e_CH51S11_001",
          "edge_type": "PRECEDES",
          "source": "E1_CH51S11_001",
          "target": "P1_CH51S11_001",
          "evidence_unit_ids": [
            "v7u_N003902"
          ],
          "derivation": "explicit_text",
          "source_quote": "When choosing and implementing a new AFC tool, organizations should first conduct a thorough assessment..."
        }
      ],
      "source_unit_ids": [
        "v7u_N003902"
      ...
      "review_notes": "增量命题：在组织选择并实施新AFC工具时 → 机构应进行彻底评估（包括确定遗留系统状态）；KG不足：基础KG可能仅描述评估过程，但缺少条件触发关系和顺序；选项判断：可确认评估是实施前的首要步骤，帮助判断顺序；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
