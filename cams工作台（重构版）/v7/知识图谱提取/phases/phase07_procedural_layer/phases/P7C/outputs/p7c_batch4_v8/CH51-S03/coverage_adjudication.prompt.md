...
section_title: `Understanding AFC technology > Technology implementation considerations`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "实施反金融犯罪技术时的关键考量因素",
      "title_en": "Key considerations when implementing AFC technology",
      "covered_units": [
        {
          "unit_id": "v7u_N003777",
          "unit_type": "fact",
    ...
    {
      "title_zh": "自建与外购决策及其选择因素",
      "title_en": "Build versus buy decision and selection factors",
      "covered_units": [
        {
          "unit_id": "v7u_N003782",
          "unit_type": "classification",
    ...
    {
      "title_zh": "供应商风险管理实践",
      "title_en": "Vendor risk management practices",
      "covered_units": [
        {
          "unit_id": "v7u_N003784",
          "unit_type": "fact",
    ...
    {
      "title_zh": "外包选项与责任保留",
      "title_en": "Outsourcing options and retaining accountability",
      "covered_units": [
        {
          "unit_id": "v7u_N003788",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "实施反金融犯罪技术时的关键考量因素",
      "target_title": "自建与外购决策及其选择因素",
      "relation_type": "prepares"
    },
    {
      "source_title": "自建与外购决策及其选择因素",
      "target_title": "供应商风险管理实践",
      "relation_type": "prepares"
    },
    {
      "source_title": "供应商风险管理实践",
      "target_title": "外包选项与责任保留",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003774|3774] Financial crime technology, such as machine learning and other forms of AI, enhances risk prevention and detection.
ZH: 机器学习等金融犯罪技术可增强风险预防和检测能力

[v7u_N003775|3775] However, implementing these technologies requires strategic decisions related to building versus buying, addressing vendor challenges, and retaining responsibility to ensure effectiveness and sustainability, regardless of outsourcing.
ZH: 实施技术需就自建与采购、供应商挑战及责任保留做出战略决策

[v7u_N003776|3776] Adopting financial crime technology involves strategic, operational, and compliance considerations that impact effectiveness, cost, and sustainability. These considerations include:
ZH: 采用金融犯罪技术涉及战略、运营和合规考量，影响效果、成本和可持续性

[v7u_N003777|3777] Regulatory compliance and adaptability: Align with evolving financial crime regulations.
ZH: 监管合规与适应性：需与不断演变的金融犯罪法规保持一致

[v7u_N003778|3778] Data privacy and security: Comply with privacy laws, such as the GDPR and the Gramm-Leach-Bliley Act, and ensure secure data storage, encryption, and access controls to mitigate cybersecurity risks.
ZH: 数据隐私与安全：需遵守《通用数据保护条例》等隐私法律，确保数据加密和访问控制

[v7u_N003779|3779] Integration with existing systems: Ensure compatibility with legacy technology and core banking systems.
ZH: 与现有系统集成：确保与遗留技术和核心银行系统兼容

[v7u_N003780|3780] Total cost of ownership: Assess ongoing maintenance, licensing, compliance updates, and staffing needs to determine long-term viability. Consider whether to use cloud-based systems or host in-house servers, which may be more secure but involve substantial cost.
ZH: 总拥有成本：评估维护、许可、合规更新及人员需求，考虑云部署或本地服务器

[v7u_N003781|3781] Time and effort to implement: Estimate the amount of time and effort needed to implement new technology in terms of engagement and focus from multiple teams within the organization, such as AFC compliance, operations, and technology.
ZH: 估算实施新技术所需的时间和精力，涉及多个团队协作。

[v7u_N003782|3782] Financial institutions then have a choice to build AFC technology solutions inhouse or buy them from a third party or a combination of the two approaches. Buying from a third party includes off-the-shelf solutions and customized solutions that the vendor tailors to the organization’s needs.
ZH: 金融机构可选择自建、外购或混合方式获取金融犯罪防控技术。

[v7u_N003783|3783] Some key pros and cons are as follows.
ZH: 引出关于自建与外购优缺点的讨论。

[v7u_N003784|3784] Developing contingency plans if the vendor fails to meet expectations, considering the cost and complexity of transitioning vendors.
ZH: 制定供应商未达预期时的应急计划，考虑转换成本与复杂性。

[v7u_N003785|3785] Establishing a cadence of audits and reviews to ensure the technology meets regulatory requirements and remains effective.
ZH: 建立定期审计与审查机制，确保技术符合监管要求并保持有效性。

[v7u_N003786|3786] Assessing the vendor's success within peer groups and in the same or similar regulatory regimes.
ZH: 评估供应商在同业及相似监管环境中的成功表现。

[v7u_N003787|3787] Typically, organizations choose their vendors and their approach to building, buying, or a combination of the two, based on their size and ability to build complex software solutions in-house. Implementing and maintaining financial crime technology requires assessing build or buy options, regulations, vendor risks, integration, scalability, and cost.
ZH: 机构根据规模和自建能力选择供应商及技术方案，需评估构建或购买选项、法规、供应商风险、集成、可扩展性和成本。

[v7u_N003788|3788] Other options include outsourcing to vendors, such as managed service providers, who can execute specific controls for and on behalf of the organization using their own or the organization’s technology suite.
ZH: 其他选项包括外包给托管服务提供商等供应商，由其代表机构执行特定控制。
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "如果供应商未达预期，金融机构应制定应急计划，并考虑转换成本与复杂性。",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S03_001",
      "reason": "KG可保存“制定应急计划”为一般措施，但无法表达“供应商失败”这一条件触发制定计划的有向依赖关系，该条件-动作链有助于判断选项中的前提与应对顺序。"
    },
    {
      ...
      "proposition": "组织基于规模和自建复杂软件解决方案的能力选择供应商及技术方案（自建/购买/组合）。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该依赖关系为一般性的“基于”选择，基础KG可通过事实或关系表达组织规模、能力与方案选择之间的联系，不构成程序性条件触发或判断分支。"
    },
    {
      ...
      "proposition": "如果供应商系统失败或未达预期，风险仍由外包机构承担。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该规则是简单条件-后果的法律责任归属陈述，基础KG可直接作为一条整体规则保存，无需提取其内部条件-结果的有向结构。"
    },
    {
      ...
      "proposition": "如果供应商未能达到监管标准，机构将被追究责任。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "与上一条类似，为直接条件-后果规则，基础KG足以表达，P7C增量不显著。"
    }
  ],
  "cards": [
    {
      ...
      "flow_nodes": [
        {
          ...
          "label": "供应商未达预期 (vendor fails to meet expectations)",
          "evidence_unit_ids": [
            "v7u_N003784"
          ],
        ...
        },
        {
          ...
          "label": "金融机构应当制定应急计划 (developing contingency plans)，并考虑供应商转换的成本和复杂性",
          "evidence_unit_ids": [
            "v7u_N003784"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "source": "E6_001",
          "target": "P2_001",
          "condition": "如果供应商未达预期 (if the vendor fails to meet expectations)",
          "evidence_unit_ids": [
            "v7u_N003784"
          ],
      ...
      "review_notes": "增量命题：供应商未达预期 --条件触发--> 金融机构制定应急计划。KG不足：基础KG可保存“机构应制定应急计划”作为一项措施，但无法表达该措施由特定条件（供应商失败）触发的有向依赖关系。选项判断：可帮助确认在供应商出现问题时，机构应采取的具体应对动作及先后顺序。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
