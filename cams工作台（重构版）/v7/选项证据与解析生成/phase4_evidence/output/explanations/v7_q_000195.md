...
教材把扩散融资与核、化学、生物武器及其运载工具和相关材料的转让、出口联系起来（P269），并要求通过定向金融制裁预防和阻断大规模杀伤性武器扩散融资（P147）。题干四个选项中，只有B同时包含「利用金融系统转移资金」和「获取大规模杀伤性武器或其部件」两个要素，完整连接了**融资活动与WMD扩散目的**。A是关键基础设施攻击，C是跨国犯罪活动扩张，D是为意识形态暴力筹资，均缺少这一组合。因此答案为B。
