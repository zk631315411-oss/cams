...
EWRA 的核心在于识别固有风险并评估控制措施

## 【核心解析】

全机构风险评估（EWRA）定义为识别固有风险、评估控制措施并确定剩余风险的过程（P285）。其第一步就是确定固有风险，第二步评估控制有效性，然后才计算剩余风险（P268）。题干要求选出基于风险的方法管理洗钱风险的有效方式，C选项直接对应此框架：先关注产品和服务带来的固有风险，再关注为降低潜在洗钱风险所采取的控制措施，吻合EWRA的定义与流程。

## 【错误项分析】

- **A 错误（教材定义应用）｜范围或程度偏差**：EWRA考虑的是客户、地域、产品和渠道的整体风险（P268），并非仅限新客户。A选项缩小了评估范围，与EWRA要求覆盖全机构固有风险的特征相比，匹配度不足。
- **B 错误（教材定义应用）｜范围或程度偏差**：B选项只涉及降低高风险客户、产品和地区的洗钱风险，属于风险应对环节的局部动作。而EWRA的有效方法必须始于固有风险的识别与控制评估（P285），B缺失了前半段核心步骤，不如C选项完整对应教材框架。
- **D 错误（教材定义应用）｜证据不足**：教材中EWRA需由机构根据自身情况定制（P268），并未要求或优先采用第三方供应商框架。题目未提供任何关于合规或行业标准强制使用某类框架的信息，D选项缺乏教材依据。

## 【易错提醒】

EWRA识别全机构的固有风险与控制，而CRA（客户风险评估）针对单个客户分配风险评级并决定CDD层级（P285）。题干问的是企业范围的风险评估，考察的是EWRA，而不是CRA。
