...
section_title: `Technology for AFC Compliance > Introduction: Technology for AFC compliance`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "金融犯罪防控技术的定义与关键功能",
      "title_en": "AFC Technology Definition and Key Functions",
      "covered_units": [
        {
          "unit_id": "v7u_N003707",
...
```text
[v7u_N003707|3707] This module shows how AFC technology, a subset of regulatory technology (also known as RegTech), enhances financial institutions' ability to prevent and detect illicit activities.
ZH: 金融犯罪防控技术是监管科技（RegTech）的子集，用于增强金融机构预防和检测非法活动的能力。

[v7u_N003708|3708] This technology supports key functions such as customer onboarding, sanctions screening, and suspicious activity monitoring.
ZH: 金融犯罪防控技术支持客户准入、制裁筛查和可疑活动监控等关键功能。

[v7u_N003709|3709] This module also covers the importance of ensuring AFC technology complies with privacy laws, such as the GDPR, AFC regulatory frameworks, such as the US AML Act of 2020, and global standards, such as FATF Recommendations and guidance notes.
ZH: 金融犯罪防控技术须遵守隐私法律（如《通用数据保护条例》）、金融犯罪防控监管框架（如美国2020年反洗钱法）及FATF建议等全球标准。

[v7u_N003710|3710] As financial crimes grow more sophisticated and the regulatory landscape evolves, institutions should keep pace by strategically implementing innovative solutions to enhance compliance, risk management, and operational efficiency while ensuring robust governance, scalability, and security.
ZH: 机构应通过战略性实施创新解决方案来加强合规、风险管理和运营效率。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "AFC技术是RegTech的子集，用于增强金融机构预防和检测非法活动的能力。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅提供定义和一般功能描述，基础KG可充分表达定义和分类关系，无主体动作、条件分支或判断性有向结构。"
    },
    {
      ...
      "proposition": "AFC技术支持客户入职、制裁筛查和可疑活动监控等关键功能。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "列举技术支持的功能，为基础KG可处理的分类/列表关系，无程序性主体、动作或判断链。"
    },
    {
      ...
      "proposition": "确保AFC技术遵守隐私法律、AFC监管框架和全球标准（如GDPR、US AML Act、FATF建议）很重要。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "陈述合规重要性和需遵守的标准，无明确执行主体、具体动作或条件化判断，仅属规范性知识，基础KG可保存。"
    },
    {
      ...
      "proposition": "机构应通过战略性实施创新解决方案来加强合规、风险管理和运营效率，同时确保稳健治理、可扩展性和安全性。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性建议，有主体（机构）和情态（应），但动作（实施创新解决方案）和目的（加强合规等）均抽象，无具体条件、分支或独立结果，基础KG可表达该建议事实。"
    }
  ],
  "cards": [],
