...
[
  ...
  },
  {
    ...
    "proposition": "Hiroshi首先自我评估组织面临的金融犯罪风险，询问是否暴露于腐败、欺诈、洗钱或制裁风险，并开始列出相关法律法规，包括客户尽职调查和其他反洗钱标准。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "自我询问组织是否暴露于腐败、欺诈、洗钱或制裁风险，并列出打击这些风险的法律法规",
      "outcomes_or_paths": [
        "列出客户尽职调查和其他反洗钱标准"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001670",
        "quote": "To begin, Hiroshi must understand the financial crime risks his organization will face. He asks himself if his organization is exposed to corruption, fraud, money laundering, or sanctions risks. He also begins listing the laws and regulations that combat these risks, including CDD and other AML standards."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只承接在特定情况下考虑特定司法管辖区法规的动作，未承接初始自我评估风险暴露并列出相关法律法规这一独立动作。"
    }
  },
  {
    ...
    "proposition": "Hiroshi在研究中还考虑新兴合规议题，如环境、社会和治理框架以及人工智能在金融犯罪防控中的应用。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "考虑新兴合规议题，如ESG框架和AI在AFC工作中的应用",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001678",
        "quote": "Hiroshi's research does not stop there. He also considers emerging compliance topics such as the environmental, social, and governance framework and the use of AI in AFC efforts."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选未承接考虑ESG和AI等新兴合规议题这一研究扩展动作。"
    }
  }
]
```
