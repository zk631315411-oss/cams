...
section_title: `Concluding an investigation and suspicious activity reporting > Reasons and consequences for not filing a SAR`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "可疑交易报告决策流程及记录要求",
      "title_en": "SAR decision-making process and documentation requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003577",
          "unit_type": "rule",
    ...
    {
      "title_zh": "未提交或虚假提交可疑交易报告的后果",
      "title_en": "Consequences of not filing or falsely filing a SAR",
      "covered_units": [
        {
          "unit_id": "v7u_N003580",
    ...
    {
      "title_zh": "不提交可疑交易报告的原因",
      "title_en": "Reasons for not filing a SAR",
      "covered_units": [
        {
          "unit_id": "v7u_N003581",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "可疑交易报告决策流程及记录要求",
      "target_title": "不提交可疑交易报告的原因",
      "relation_type": "contains"
    },
    {
      "source_title": "可疑交易报告决策流程及记录要求",
      "target_title": "未提交或虚假提交可疑交易报告的后果",
      "relation_type": "contains"
    },
    {
      "source_title": "不提交可疑交易报告的原因",
      "target_title": "未提交或虚假提交可疑交易报告的后果",
...
```text
[v7u_N003576|3576] Financial institutions use several methods to detect unusual activity, including transaction monitoring alerts, negative media reports, and manual methods, such as information-sharing requests, warrants, and subpoenas.
ZH: 检测异常活动的方法包括交易监控警报、负面媒体报道及手动方式

[v7u_N003577|3577] When they detect unusual activity, they must examine the case facts and decide whether to file a suspicious activity report (SAR).
ZH: 发现异常活动后必须审查案件事实并决定是否提交可疑交易报告

[v7u_N003578|3578] If a SAR is filed, they must then decide how to handle the customer’s accounts.
ZH: 提交可疑交易报告后必须决定如何处理客户账户

[v7u_N003579|3579] Documenting the rationale for the decision to not file a SAR is just as important as documenting the decision to file a SAR.
ZH: 记录不提交可疑交易报告的理由与记录提交同等重要

[v7u_N003580|3580] Failure to file a SAR in the presence of suspicious activity can lead to severe fines and penalties for institutions and individuals.
ZH: 未提交可疑交易报告可能导致机构和个人遭受严重罚款和处罚

[v7u_N003581|3581] For several reasons, a financial institution might decide not to file a SAR after reviewing an alert. For example, there might be insufficient evidence to support a suspicious activity claim.
ZH: 金融机构在审查预警后可能因证据不足而决定不提交可疑活动报告

[v7u_N003582|3582] Financial institutions routinely receive subpoenas and other legal orders related to civil and criminal matters. A request for information typically triggers a customer review, but does not automatically result in a SAR, because there might not be enough supporting information.
ZH: 传票等法律令状会触发客户审查，但不自动导致提交SAR

[v7u_N003583|3583] When making a risk-based decision on whether to file a SAR, a financial institution should analyze facts of the case and compare them with regulatory guidelines. If the analysis reveals suspicious activity, the financial institution next determines if it meets regulatory guidelines for filing a SAR. The findings and reasons for the decision to file or not file should be thoroughly documented.
ZH: 基于风险的方法决定是否提交SAR：分析事实、对照监管指南并记录决策

[v7u_N003584|3584] Falsely filing a SAR, or knowingly providing inaccurate information in a SAR, is the same as not complying with regulations.
ZH: 虚假提交SAR或故意提供不准确信息等同于不合规

[v7u_N003585|3585] In most jurisdictions, anyone who willfully violates SAR filing regulations is subject to a criminal fine, prison sentence, or both.
ZH: 故意违反SAR申报规定可能面临刑事罚款、监禁或两者并罚

[v7u_N003586|3586] As an example, GWFS Equities Inc. (GWFS), a US-based registered broker-dealer, was penalized when it violated federal regulations regarding SAR filing. GWFS failed to report required information about the suspicious activity and criminals involved in a cybercrime attack on customer accounts. GWFS was fined US$1.5 million and required to implement remedial actions on its processes and procedures.
ZH: GWFS Equities Inc.因未按规定报告网络犯罪相关可疑活动被罚款150万美元
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "检测到异常活动后，金融机构应分析案件事实并与监管指南比较，依据是否显示可疑及是否满足指南，分支决定提交或不提交SAR。",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S08_001",
      "reason": "基础KG只能将整个流程作为规则保存，无法表达内部分支判断逻辑（条件不同的两条路径），该有向结构对选项判断有用。"
    },
    {
      ...
      "proposition": "金融机构收到传票或法律令状后，进行客户审查，若支持信息不足，则决定不提交SAR。",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S08_002",
      "reason": "基础KG只能表达'法律令状不自动导致SAR'的静态事实，未表达触发审查及审查后信息不足导致不提交判断的有向过程。"
    },
    {
      ...
      "proposition": "GWFS未报告网络犯罪攻击中的可疑活动必要信息，导致被罚款150万美元并被要求实施补救措施。",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S08_003",
      "reason": "案例中的补救要求超出了基础KG一般性违规罚款后果的表达，形成了'违规→罚款+补救义务'的有向增量结构。"
    },
    {
      ...
      "proposition": "提交SAR后，金融机构必须决定如何处理客户账户。",
      "decision": "p7c_card",
      "card_id": "p7card_CH49-S08_004",
      "reason": "基础KG可能将整句作为规则保存，未明确表达'提交SAR'事件触发'决定账户处理'动作的有向顺序。"
    },
    {
      ...
      "proposition": "未提交或虚假提交SAR可能导致机构和个人罚款、刑事处罚等严重后果。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些单元仅陈述孤立后果或定义，基础KG已能充分表达，无程序性或判断性有向结构。"
    },
    {
      ...
      "proposition": "记录不提交SAR的理由与记录提交同等重要。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "记录要求是孤立义务陈述，基础KG已能表达该规则，无特定有向结构。"
    },
    {
      ...
      "proposition": "检测异常活动的方法包括交易监控警报、负面媒体报道以及手动方式（如信息共享请求、搜查令和传票）。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "列举检测方法，属于基础KG可表达的事实列表，无有向关系。"
    }
  ],
  "cards": [
    {
      ...
      "title": "基于风险的可疑活动报告决策流程",
      "flow_nodes": [
        {
          "node_id": "E1_detection",
          "node_category": "entry",
        ...
        },
        {
          ...
          "label": "金融机构判断是否显示可疑活动以及是否满足监管指南以决定提交或不提交SAR",
          "evidence_unit_ids": [
            "v7u_N003583",
            "v7u_N003581"
          ],
      ...
      "flow_edges": [
        ...
        },
        {
          ...
          "source": "P2_decision",
          "target": "X2_not_file",
          "condition": "分析未显示可疑活动或不满足监管指南（例如证据不足）",
          "evidence_unit_ids": [
            "v7u_N003583",
            "v7u_N003581"
          ],
      ...
      "review_notes": "增量命题：检测到异常活动后，金融机构分析事实并与监管指南比较，根据是否显示可疑及是否满足指南，分支决定提交或不提交SAR；KG不足：基础KG只能将流程作为整体规则保存，无法表达内部分支判断逻辑（两条互斥路径）；选项判断：可确认或排除关于决策分支条件（如显示可疑但未满足指南时是否提交）等选项；LLM推理：边edge_P2_X1和edge_P2_X2，原文未直接给出if-then，但通过“determines if it meets... decision to file or not file”联合v7u_N003581证据不足不提交，推断出两条互斥分支，标记为llm_inference。"
    },
    {
      "card_id": "p7card_CH49-S08_002",
      "section_id": "CH49-S08",
      "card_nature": "execution",
      "title": "法律令状触发客户审查与不提交SAR",
      "flow_nodes": [
        {
          "node_id": "E1_legal_order",
          "node_category": "entry",
      ...
      "flow_edges": [
        {
          "edge_id": "edge_E1_P1",
          "edge_type": "PRECEDES",
          "source": "E1_legal_order",
          "target": "P1_review",
          "evidence_unit_ids": [
            "v7u_N003582"
          ],
          "derivation": "explicit_text",
          "source_quote": "A request for information typically triggers a customer review"
        },
        {
          "edge_id": "edge_P1_X1",
          "edge_type": "PRODUCES",
          ...
          "derivation": "explicit_text",
          "source_quote": "does not automatically result in a SAR, because there might not be enough supporting information"
        }
      ],
      "source_unit_ids": [
        "v7u_N003582"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：收到法律令状触发客户审查，审查后若信息不足则决定不提交SAR；KG不足：基础KG只能表达'法律令状不自动导致SAR'这一事实，无法表达触发审查动作以及审查后信息不足导致不提交判断的有向结构；选项判断：可确认或排除关于法律令状是否必然触发SAR、信息不足是否是不提交的直接原因等选项；LLM推理：无，边均为explicit_text。"
    },
    {
      "card_id": "p7card_CH49-S08_003",
      "section_id": "CH49-S08",
      "card_nature": "risk_indicator",
      "title": "GWFS违规未报告案例的处罚与补救要求",
      "flow_nodes": [
        {
          "node_id": "E1_violation",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "GWFS未报告网络犯罪攻击中的可疑活动必要信息",
          "evidence_unit_ids": [
            "v7u_N003586"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：GWFS违规未报告导致罚款和补救义务；KG不足：基础KG只表达一般性违规罚款后果，未包含具体补救要求的有向结构；选项判断：可确认或排除关于补救措施是否为违规的必然要求等选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH49-S08_004",
      "section_id": "CH49-S08",
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "source_quote": "If a SAR is filed, they must then decide how to handle the customer’s accounts."
        }
      ],
      "source_unit_ids": [
        "v7u_N003578"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：提交SAR事件触发决定账户处理；KG不足：基础KG可能只表达'提交SAR后需决定账户处理'的规则，但未表达事件触发的有向顺序；选项判断：可确认或排除关于提交SAR后是否必须立即决定账户处理等选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
