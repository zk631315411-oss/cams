...
p7c_card_under_review:
{
  ...
  "title": "金融机构交易监控系统检测并标记异常活动",
  "flow_nodes": [
    {
      "node_id": "p_001",
      "node_category": "process",
      "node_type": "P1_assessment",
      "label": "金融机构: 通过交易监控系统检测到非法活动",
      "evidence_unit_ids": [
        "v7u_N000283"
      ],
    ...
    },
    {
      ...
      "label": "标记: 结构化存款、快速跨辖区分层、与已知恐怖相关钱包关联的异常资金流动",
      "evidence_unit_ids": [
        "v7u_N000283"
      ],
      "evidence_strength": "explicit"
  ...
  "review_notes": "增量命题：金融机构通过交易监控系统检测非法活动 → 标记具体异常交易；KG不足：基础KG仅能记录检测事实，无法表达标记作为检测产出的有向关系；选项判断：可确认金融机构的识别顺序和标记依据。LLM推理：无。"
}
