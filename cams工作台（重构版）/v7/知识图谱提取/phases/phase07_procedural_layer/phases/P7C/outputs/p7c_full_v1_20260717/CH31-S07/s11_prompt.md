...
section_title: `Cooperation between authorities > Key takeaways`

section_text_with_unit_anchors:

```text
[v7u_N002275|2275] Cooperation between FIUs and law enforcement results in law enforcement action.
ZH: 金融情报机构与执法机构合作可促成执法行动

[v7u_N002276|2276] Addressing money laundering requires cooperation and information sharing both domestically and internationally.
ZH: 打击洗钱需要国内与国际合作及信息共享

[v7u_N002277|2277] International bodies such as Eurojust and Europol have an important role in coordinating such activity.
ZH: Eurojust和Europol等国际机构在协调此类活动中发挥重要作用
```
