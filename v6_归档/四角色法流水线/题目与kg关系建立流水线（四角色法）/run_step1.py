...
DATA = BASE.parent / "cams工作台" / "data"
KG_DIR = DATA / "agentic_search_eval_v2" / "kg"
SAVE_DIR = BASE / "output" / "step1_ai_responses"
EVIDENCE_FILES = {
    "ch2": DATA / "cards_ch2.json",
    "v6-sentence": DATA / "cards_v6_sentence.json",
    "v6-except-ch2": DATA / "cards_v6_except_ch2_sentence.json",
    "ch2-plus-v6-except": DATA / "cards_ch2_plus_v6_except_ch2_sentence.json",
}
