...
section_title: `Corporate and investment banking risks > Fundraising risks`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "首次公开募股洗钱风险",
      "title_en": "IPO Money Laundering Risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000700",
    ...
    {
      "title_zh": "赞助和捐赠风险",
      "title_en": "Sponsorship and Donation Risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000702",
          "unit_type": "definition",
    ...
    {
      "title_zh": "债务和债券发行洗钱风险",
      "title_en": "Debt and Bond Issuance Money Laundering Risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000705",
          "unit_type": "definition",
    ...
    {
      "title_zh": "众筹洗钱风险",
      "title_en": "Crowdfunding Money Laundering Risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000707",
          "unit_type": "definition",
...
```text
[v7u_N000699|699] Fundraising activities are necessary for corporate growth and development, providing companies with the required capital to expand and compete in the marketplace. However, they can also attract money launderers.
ZH: 筹资活动虽必要，但可能吸引洗钱者

[v7u_N000700|700] An initial public offering (IPO) involves offering shares of a private corporation to the public in a new stock issuance, allowing the company to raise capital.
ZH: 首次公开募股（IPO）是公司向公众发行股票以筹集资本

[v7u_N000701|701] IPOs are heavily regulated, but the initial influx of capital can potentially mask illicit funds if not properly scrutinized and verified.
ZH: IPO募集的初始资金若审查不严可能掩盖非法资金

[v7u_N000702|702] Sponsorships involve companies funding events, activities, or organizations in exchange for advertising and brand exposure.
ZH: 赞助是企业为换取广告和品牌曝光而资助活动或组织

[v7u_N000703|703] While sponsorships are usually transparent, they can be exploited by money launderers who use the guise of legitimate business relationships to move illicit funds.
ZH: 洗钱者可能利用赞助的合法商业关系转移非法资金

[v7u_N000704|704] Sponsorships and donations are also higher risk for bribery and corruption if they are made to an organization with the aim of benefiting or influencing a decision-maker.
ZH: 赞助和捐赠若旨在影响决策者则存在贿赂和腐败风险

[v7u_N000705|705] Bond issuance is a method for companies to raise funds by issuing debt securities to investors, who then receive periodic interest payments.
ZH: 债券发行是公司通过向投资者发行债务证券筹集资金的方式

[v7u_N000706|706] This method can also be manipulated to launder money by disguising the origin of funds through complex financial transactions.
ZH: 债券发行可能通过复杂金融交易掩饰资金来源以洗钱

[v7u_N000707|707] Crowdfunding platforms allow individuals and businesses to solicit small contributions from a large number of people, typically via the internet.
ZH: 众筹平台允许个人和企业通过互联网向大量人群募集小额资金

[v7u_N000708|708] The decentralized and less regulated nature of crowdfunding can make it an attractive avenue for money laundering, as it is often challenging to trace the sources of numerous small donations.
ZH: 众筹的去中心化和监管较少的特点可能被用于洗钱

[v7u_N000709|709] Debt issuance, such as the issuance of notes or bonds, is another common fundraising activity. When a firm is requested to issue debt by an investor or a representative of an investor, it is essential to consider not only the credit risk, but also other financial-crime risks involved, including:
ZH: 债务发行（如票据或债券）是常见筹资活动，需考虑金融犯罪风险

[v7u_N000710|710] Lack of transparency: Debt instruments can be structured in complex ways, making it difficult to identify the UBOs of the funds.
ZH: 债务工具结构复杂，难以识别资金的最终受益所有人

[v7u_N000711|711] High-value transactions: The large sums of money involved can provide efficient means for laundering significant amounts of illicit funds quickly.
ZH: 债务发行涉及大额资金，可快速清洗大量非法资金

[v7u_N000712|712] Cross-border transactions: Debt issuance often involves international investors, adding an additional layer of complexity and potential regulatory arbitrage.
ZH: 债务发行常涉及跨境交易，增加复杂性和监管套利风险
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "当公司被投资者要求发行债务时，公司必须考虑金融犯罪风险，具体包括透明度不足、大额交易及跨境交易等风险。",
      "decision": "p7c_card",
      "card_id": "p7card_CH09-S03_001",
      "reason": "原文明确规定了条件（投资者要求发行债务）→主体（公司）→动作（必须考虑金融犯罪风险）的有向关系，并明示需参照的具体风险因素。基础KG仅将各风险因素保存为孤立事实，无法表达此条件触发的程序性义务及动作与风险间的参照结构，属于P7C增量。"
    }
  ],
  "cards": [
    {
      ...
      "flow_nodes": [
        ...
        },
        {
          ...
          "node_type": "input",
          "label": "透明度不足：债务工具结构复杂，难以识别资金UBO",
          "evidence_unit_ids": [
            "v7u_N000710"
          ],
          "evidence_strength": "explicit"
        ...
        },
        {
          ...
          "node_category": "auxiliary",
          "node_type": "input",
          "label": "跨境交易：常涉及国际投资者，增加复杂性和监管套利风险",
          "evidence_unit_ids": [
            "v7u_N000712"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "condition": "when a firm is requested to issue debt by an investor or a representative of an investor"
        },
        {
          "edge_id": "edge_02",
      ...
      "review_notes": "增量命题：当公司被投资者要求发行债务时 → 公司必须考虑金融犯罪风险，并参照透明度不足、大额交易、跨境交易等具体风险因素。KG不足：基础KG仅能保存各风险指标为孤立事实，无法表达‘条件触发 → 主体动作’这一程序性关系，也无法表达动作与风险指标的参照结构。选项判断：可确认公司在特定条件下负有考虑上述金融犯罪风险的义务，可能用于排除‘无条件考虑’或‘不考虑特定风险’的选项。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
