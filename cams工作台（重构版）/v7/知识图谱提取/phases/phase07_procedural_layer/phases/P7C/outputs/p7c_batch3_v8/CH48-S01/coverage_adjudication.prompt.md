...
section_title: `Concluding Investigations and Coordinating with Law Enforcement > Introduction: Concluding investigations and coordinating with law enforcement`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "结束调查与执法协调简介",
      "title_en": "Concluding Investigations and Law Enforcement Coordination Introduction",
      "covered_units": [
        {
          "unit_id": "v7u_N003448",
          "unit_type": "fact",
...
```text
[v7u_N003448|3448] Concluding investigations and liaising with law enforcement are critical tasks in combating financial crime.
ZH: 结束调查并与执法部门协调是打击金融犯罪的关键任务。

[v7u_N003449|3449] In this module, you will learn how to finalize investigations by preparing clear, comprehensive SARs and understanding the nuances in communicating with the FIU and law enforcement agencies.
ZH: 本模块介绍如何通过准备清晰全面的可疑活动报告以及与金融情报机构和执法机构沟通来结束调查。

[v7u_N003450|3450] Reporting suspicious activity helps maintain compliance with AFC regulations and enhances the effectiveness of a financial institution’s AFC efforts.
ZH: 报告可疑活动有助于遵守金融犯罪防控法规并提升金融机构的金融犯罪防控效果。

[v7u_N003451|3451] By applying these practices, you will help ensure that your organization becomes a proactive partner in detecting, preventing, and disrupting financial crimes.
ZH: 应用这些实践有助于组织成为检测、预防和打击金融犯罪的主动合作伙伴。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "结束调查和与执法部门协调是打击金融犯罪的关键任务。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题为定义性陈述，无明确主体、条件、判断或应对的有向结构，基础KG可充分表达。"
    },
    {
      ...
      "proposition": "学习者将学习如何通过准备SARs和与FIU/执法机构沟通来结束调查。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题为模块教学目标描述，未展示具体业务程序或判断性关系，基础KG可充分表达。"
    },
    {
      ...
      "proposition": "报告可疑活动有助于维持AFC合规并增强AFC努力的有效性。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题为普通因果/帮助关系，无特定条件、主体判断或独立的程序性结果，由基础KG承接一般知识。"
    },
    {
      ...
      "proposition": "应用这些实践有助于确保组织成为检测、预防和打击金融犯罪的主动合作伙伴。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题为一般性教学目标与因果陈述，未形成局部程序性或判断性有向结构，基础KG可充分表达。"
    }
  ],
  "cards": [],
