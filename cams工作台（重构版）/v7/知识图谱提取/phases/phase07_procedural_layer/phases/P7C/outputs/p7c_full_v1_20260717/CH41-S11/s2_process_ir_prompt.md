...
section_title: `Governance and oversight > 7. Periodic review and ongoing due diligence:`

section_text_with_unit_anchors:

```text
[v7u_N003004|3004] Scheduled KYC refreshes: Conduct mandatory data updates based on risk levels and evolving regulatory expectations.
ZH: 根据风险水平和监管要求进行定期了解你的客户更新

[v7u_N003005|3005] Continuous risk assessments: Adjust customer profiles and transaction limits based on information or behavioral shifts.
ZH: 根据信息或行为变化持续调整客户画像和交易限额

[v7u_N003006|3006] Ongoing risk monitoring: Apply continuous surveillance and deeper transaction scrutiny to mitigate exposure.
ZH: 应用持续监控和更深入的交易审查以降低风险敞口

[v7u_N003007|3007] Dynamic risk management: Sophisticated processes, such as perpetual KYC, involve continuously monitoring data to identify changes and trigger a KYC refresh.
ZH: 持续了解你的客户等高级流程通过持续监控数据变化触发了解你的客户更新
```
...
[
  {
    ...
    "proposition": "根据风险水平和监管要求进行定期了解你的客户更新",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "进行强制数据更新",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003004",
        "quote": "Scheduled KYC refreshes: Conduct mandatory data updates based on risk levels and evolving regulatory expectations."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "根据信息或行为变化持续调整客户画像和交易限额",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "调整客户画像和交易限额",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003005",
        "quote": "Continuous risk assessments: Adjust customer profiles and transaction limits based on information or behavioral shifts."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "应用持续监控和更深入的交易审查以降低风险敞口",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "应用持续监控和更深入的交易审查",
      "outcomes_or_paths": [
        "降低风险敞口"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003006",
        "quote": "Ongoing risk monitoring: Apply continuous surveillance and deeper transaction scrutiny to mitigate exposure."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "持续了解你的客户等高级流程通过持续监控数据变化触发了解你的客户更新",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "触发KYC更新",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003007",
        "quote": "Dynamic risk management: Sophisticated processes, such as perpetual KYC, involve continuously monitoring data to identify changes and trigger a KYC refresh."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
