...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "采用智能交易监控解决方案",
      "title_en": "Adopting intelligent transaction monitoring solutions",
      "covered_units": [
        {
          "unit_id": "v7u_N003256",
          "unit_type": "fact",
    ...
    {
      "title_zh": "用于检测隐藏关联的网络分析",
      "title_en": "Network analysis for detecting hidden connections",
      "covered_units": [
        {
          "unit_id": "v7u_N003258",
    ...
    {
      "title_zh": "AI驱动的交易监控",
      "title_en": "AI-powered transaction monitoring",
      "covered_units": [
        {
          "unit_id": "v7u_N003265",
          "unit_type": "fact",
    ...
    {
      "title_zh": "金融犯罪防控专业人员的技术发展",
      "title_en": "AFC professional development in technology",
      "covered_units": [
        {
          "unit_id": "v7u_N003266",
          "unit_type": "rule",
    ...
    {
      "title_zh": "AI风险与缓解控制",
      "title_en": "AI risks and mitigation controls",
      "covered_units": [
        {
          "unit_id": "v7u_N003268",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "采用智能交易监控解决方案",
      "target_title": "用于检测隐藏关联的网络分析",
      "relation_type": "contains"
    },
    {
      "source_title": "采用智能交易监控解决方案",
      "target_title": "AI驱动的交易监控",
      "relation_type": "contains"
    },
    {
      "source_title": "用于检测隐藏关联的网络分析",
      "target_title": "AI驱动的交易监控",
      "relation_type": "parallels"
    },
    {
      "source_title": "AI驱动的交易监控",
      "target_title": "AI风险与缓解控制",
      "relation_type": "prepares"
    },
    {
      "source_title": "金融犯罪防控专业人员的技术发展",
      "target_title": "AI风险与缓解控制",
      "relation_type": "prepares"
    }
  ]
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "机构实施智能监控解决方案以生成有用警报并减少误报，智能上下文分析基于规则检查交易。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅描述机构一般行为与技术工作原理，无特定条件、分支、交接或决策链，属于基础KG可表达的事实与案例。"
    },
    {
      ...
      "proposition": "网络分析工具自动检测隐藏关联，节省人工追踪时间。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术功能、优势与一般后果说明，不构成主体决策或应对链，基础KG已覆盖定义、解释与后果。"
    },
    {
      ...
      "proposition": "AI技术发展改进交易监控，帮助识别可疑模式。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术发展背景与一般功能描述，无具体触发、应对或独立结果，基础KG已覆盖。"
    },
    {
      ...
      "proposition": "AFC专业人员应当保持对AI等进展的了解，积极监控技术发展有助于增强检测。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性职业义务与好处陈述，内部主体-动作关系简单无分支，基础KG已作为规则（prescribes_measure）覆盖。"
    },
    {
      ...
      "proposition": "实施AI存在风险，必须进行测试、确保可解释等，以支持有效风险管理。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "风险告知与强制性标准规则，均为基础KG已覆盖的规则或事实，缺乏内部条件化有向结构。"
    }
  ],
  "cards": [],
  "skip_reason": "当前section全部内容为基础KG能够充分表达的定义、事实、规则、案例和一般知识关系。未发现超出基础KG表达能力的局部程序性或判断性有向结构（如条件分支、触发应对、交接链），因此无P7C增量卡片。"
}
```
