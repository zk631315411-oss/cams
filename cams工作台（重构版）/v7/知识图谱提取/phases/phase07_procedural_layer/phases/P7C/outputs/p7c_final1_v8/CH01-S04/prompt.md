...
section_title: `Money Laundering and Financial Crime > What is financial crime?`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "金融犯罪的定义、类型及其影响",
      "title_en": "Definition and types of financial crime, and its repercussions",
      "covered_units": [
        {
          "unit_id": "v7u_N000013",
...
```text
[v7u_N000013|13] Financial crime encompasses a variety of illegal activities that exploit financial systems for personal or organizational gain, often undermining the integrity of economies and markets.
ZH: 金融犯罪的定义：利用金融系统谋取个人或组织利益的非法活动

[v7u_N000014|14] Types of financial crime include money laundering, where illicit funds are disguised to appear legitimate; fraud, which involves deceitful practices to gain financial advantage; tax evasion, the illegal avoidance of tax obligations; sanctions evasion, where legal restrictions are circumvented; and bribery and corruption, involving unethical exchanges for favorable or preferential treatment.
ZH: 金融犯罪类型包括洗钱、欺诈、逃税、制裁规避、贿赂和腐败

[v7u_N000015|15] These crimes have serious repercussions, emphasizing the need for robust regulatory measures and compliance efforts to protect financial systems and promote transparency.
ZH: 金融犯罪后果严重，需加强监管和合规以保护金融体系
```
