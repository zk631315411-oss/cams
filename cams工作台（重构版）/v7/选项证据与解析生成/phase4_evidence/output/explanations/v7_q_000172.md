...
稳定币、代币和NFT等数字资产因假名性、跨境可达性和监管监督不足，为洗钱和恐怖融资创造了新机会（P112）。假名交易并不表示区块链上没有交易记录，而是指链上地址未必直接揭示其背后的真实身份；教材因此指出，许多数字资产交易的假名性质会增加所有权和身份验证的难度（P435），并说明即使区块链具有透明性，追踪所有权仍可能具有挑战性（P111）。D项以假名交易中的身份隐藏和全球转移为前提，落脚于难以追踪实际所有人，最直接对应上述风险链条。D项中的「大笔资金」不是本题引用单元单独证明的数量结论，但不改变其中心判断与教材的对应关系。
