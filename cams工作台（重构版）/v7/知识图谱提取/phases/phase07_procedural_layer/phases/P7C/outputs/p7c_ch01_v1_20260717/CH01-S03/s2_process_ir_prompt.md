...
section_title: `Money Laundering and Financial Crime > Key takeaways`

section_text_with_unit_anchors:

```text
[v7u_N000009|9] Increases in revenue beyond initial KYC projections might indicate risk.
ZH: 收入超出初始了解你的客户预测可能表明风险

[v7u_N000010|10] Common predicate crimes, such as drug trafficking and fraud, generate illegal funds that are subject to laundering.
ZH: 常见上游犯罪如贩毒和欺诈产生非法资金，需洗钱

[v7u_N000011|11] Indicators of suspicious activity include financial transactions from high-risk jurisdictions and unusual revenue patterns that deviate from expectations.
ZH: 可疑活动指标包括来自高风险司法管辖区的交易和异常收入模式

[v7u_N000012|12] Collaboration with specialist teams helps uncover criminal activity.
ZH: 与专业团队合作有助于发现犯罪活动
```
...
[
  {
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "可能表明风险",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000009",
        "quote": "Increases in revenue beyond initial KYC projections might indicate risk."
      }
    ],
    "induction": null,
  ...
  {
    "candidate_id": "s1c_gap_ch01_s03_collaboration_uncovers_crime",
    "unit_ids": [
      "v7u_N000012"
    ],
    "proposition": "与专业团队合作有助于发现犯罪活动。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "与专业团队合作以发现犯罪活动",
      "outcomes_or_paths": [
        "有助于发现犯罪活动"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N000012",
        "quote": "Collaboration with specialist teams helps uncover criminal activity."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选只承接了收入超出初始KYC预测可能表明风险的判断，未承接与专业团队合作有助于发现犯罪活动这一独立调查合作链。"
    }
  }
]
```
