...
```json
{
  ...
  "covered_relations": [
    {
      "source_title": "离岸金融中心的定义与特征",
      "target_title": "离岸金融中心的风险与红旗信号",
      "relation_type": "prepares"
    },
    {
      "source_title": "离岸金融中心的风险与红旗信号",
      "target_title": "离岸金融中心风险缓释：强化尽职调查与交易监控",
      "relation_type": "prepares"
    }
  ]
}
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "离岸金融中心的定义与特征",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已覆盖定义与一般特征。"
    },
    {
      ...
      "proposition": "离岸金融中心存在被用于非法目的的风险",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已表达风险陈述。"
    },
    {
      ...
      "proposition": "离岸金融中心相关的红旗信号列表",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已将这些作为孤立风险指标覆盖。"
    },
    {
      ...
      "proposition": "判断红旗信号：若无明确商业目的或合理解释，则通常为非法活动迹象，否则可能合法。",
      "decision": "p7c_card",
      "card_id": "p7card_CH08-S04_001",
      "reason": "包含条件导向的分类判断，超出基础KG对孤立红旗信号的表达。"
    },
    {
      ...
      "proposition": "复杂所有权掩盖UBO、透明性缺失等风险解释",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已覆盖风险解释。"
    },
    ...
    },
    {
      ...
      "proposition": "犯罪分子利用round tripping手法",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已覆盖为案例。"
    },
    {
      ...
      "proposition": "机构应实施强化尽职调查和交易监控以检测可疑活动",
      "decision": "kg_only",
      "card_id": null,
      "reason": "基础KG已将此作为风险缓解措施保存，无超出KG的程序性有向结构。"
    }
  ],
  "cards": [
    {
      ...
      "flow_nodes": [
        ...
        },
        {
          ...
          "label": "机构判断红旗信号是否具备明确的商业目的或合理解释",
          "evidence_unit_ids": [
            "v7u_N000635"
          ],
          "evidence_strength": "explicit"
      ...
      "review_notes": "增量命题：机构判断红旗是否具备明确商业目的或合理解释，若具备则可能为合法商业实践，若不具备则通常为非法活动迹象；KG不足：基础KG只能表达孤立红旗信号，无法表达基于条件解释的分类判断逻辑；选项判断：可确认或排除有关红旗信号判断路径的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
