...
section_title: `Corporate and investment banking risks > Mergers and acquisitions risks`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "并购中的洗钱风险",
      "title_en": "Money Laundering Risks in Mergers and Acquisitions",
      "covered_units": [
        {
          "unit_id": "v7u_N000714",
    ...
    {
      "title_zh": "降低并购洗钱风险的尽职调查程序",
      "title_en": "Due Diligence Procedures to Mitigate M&A Money Laundering Risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000720",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "并购中的洗钱风险",
      "target_title": "降低并购洗钱风险的尽职调查程序",
...
```text
[v7u_N000713|713] Mergers and acquisitions (M&A) involve various transactions for the consolidation of companies or assets.
ZH: 并购涉及公司或资产合并的各种交易

[v7u_N000714|714] The complexity and scale of M&A activities provide numerous opportunities for disguising the origin of illegal proceeds.
ZH: 并购活动的复杂性和规模为掩饰非法所得来源提供了机会

[v7u_N000715|715] Money launderers might acquire companies with clean financial records, allowing them to blend dirty money with legitimate business operations. By purchasing a legitimate company, they can mask the illicit origin of funds through the company's revenue stream, making it challenging for regulators to detect suspicious activities. Additionally, the intricate structures of M&A deals can obscure the true ownership of assets, further complicating efforts to trace laundered money.
ZH: 洗钱者通过收购合法公司，将非法资金混入合法业务收入中

[v7u_N000716|716] Investment banks might inadvertently facilitate money laundering by acquiring companies that have previously engaged in laundering activities, evaded sanctions, committed fraud, or violated laws such as the US Foreign Corrupt Practices Act or the UK Bribery Act.
ZH: 投行可能因收购曾洗钱、逃避制裁或欺诈的公司而助长洗钱

[v7u_N000717|717] The use of shell companies and complex ownership structures can obscure the true beneficiaries of the transaction, making it difficult to identify potential money laundering risks.
ZH: 壳公司和复杂所有权结构可掩盖交易的真实受益人

[v7u_N000718|718] Additionally, M&A activities often involve multiple jurisdictions and crossborder transactions, each with varying levels of regulatory oversight and enforcement, increasing the challenge of conducting thorough due diligence.
ZH: 并购涉及多个司法管辖区和跨境交易，增加了尽职调查难度

[v7u_N000719|719] To mitigate these risks, investment banks should implement specialized due diligence procedures, which could include the following:
ZH: 投行应实施专门的尽职调查程序以降低并购风险

[v7u_N000720|720] Enhanced CDD to conduct comprehensive background checks on all parties involved in the transaction to identify potential red flags.
ZH: 强化客户尽职调查，对所有交易方进行背景审查以识别红旗信号信号

[v7u_N000721|721] Transaction monitoring to continuously monitor transactions related to an M&A deal to detect any unusual or suspicious activities.
ZH: 对并购交易进行持续交易监控以发现异常或可疑活动

[v7u_N000722|722] Beneficial ownership verification to identify and verify the ultimate beneficial owners of the companies involved to ensure transparency and accountability.
ZH: 识别并核实并购交易中涉及公司的最终受益所有人

[v7u_N000723|723] Jurisdictional risk assessment to evaluate the regulatory environment and potential risks associated with the jurisdictions involved in the transaction.
ZH: 评估交易涉及司法管辖区的监管环境和潜在风险

[v7u_N000724|724] Legal and compliance reviews to ensure adherence to relevant laws and regulations, including by the companies being subject to an acquisition.
ZH: 确保并购交易遵守相关法律法规，包括被收购公司的合规审查
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "并购活动因其复杂性、被收购公司可能涉及犯罪、壳公司、跨管辖区等因素，带来洗钱风险，投行可能因此助长洗钱。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些属于定义、风险指标和一般机制，基础KG可充分表达，无程序性条件、分支或独立结果。"
    },
    {
      ...
      "proposition": "为缓解风险，投行应实施专门尽职调查程序，包括强化CDD、交易监控、受益所有人验证、管辖区风险评估、法律合规审查。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这些是通用规则和措施列举，基础KG已能按整体事实保存，内部无程序性条件、判断或独立结果，不构成增量有向结构。"
    }
  ],
  "cards": [],
