...
section_title: `Transaction monitoring scenario calibration testing > Ongoing testing and tuning for rules-based systems`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "基于规则的交易监控系统持续测试与调优",
      "title_en": "Ongoing testing and tuning for rules-based transaction monitoring systems",
      "covered_units": [
        {
          "unit_id": "v7u_N004463",
          "unit_type": "rule",
    ...
    {
      "title_zh": "基于AI的交易监控工具测试与调优",
      "title_en": "Testing and tuning for AI-based transaction monitoring tools",
      "covered_units": [
        {
          "unit_id": "v7u_N004481",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "基于规则的交易监控系统持续测试与调优",
      "target_title": "基于AI的交易监控工具测试与调优",
