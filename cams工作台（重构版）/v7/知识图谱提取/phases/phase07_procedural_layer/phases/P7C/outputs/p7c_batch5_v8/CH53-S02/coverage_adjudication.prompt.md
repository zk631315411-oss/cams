...
section_title: `Technology for Customer Onboarding > Case example: Improving technology for customer onboarding`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "OneFrance面部识别验证缺陷",
      "title_en": "Facial recognition verification deficiency at OneFrance",
      "covered_units": [
        {
          "unit_id": "v7u_N004025",
          "unit_type": "fact",
    ...
    {
      "title_zh": "部分匹配导致的姓名筛查误报与漏报",
      "title_en": "Name screening false positives and negatives due to partial matching",
      "covered_units": [
        {
          "unit_id": "v7u_N004030",
          "unit_type": "case",
  ...
  "covered_relations": [
    {
      "source_title": "OneFrance面部识别验证缺陷",
      "target_title": "部分匹配导致的姓名筛查误报与漏报",
...
ZH: 案例：法国数字银行OneFrance计划扩张，聘请顾问审查其金融犯罪防控准入技术

[v7u_N004021|4021] Marie is an expert in digital banking, regulatory technology, and compliance. She assesses the bank’s electronic KYC processes and notices various deficiencies.
ZH: Marie评估银行的电子了解你的客户流程并发现缺陷

[v7u_N004022|4022] As part of OneFrance’s onboarding process, customers must take a selfie and submit it on the app to be verified against documents they have.
ZH: 客户需在应用程序上提交自拍照以验证身份

[v7u_N004023|4023] During the process, the geolocation of the customers is recorded to ensure they are within the EU when opening an account.
ZH: 开户时记录客户地理位置以确保其在欧盟境内

[v7u_N004024|4024] The bank also screens all the new customers’ names against the required sanctions lists during onboarding.
ZH: 银行在开户时对所有新客户姓名进行制裁名单筛查

[v7u_N004025|4025] Marie notes that currently the system only verifies 80% of customers through facial recognition technology.
ZH: 当前系统仅通过面部识别技术验证80%的客户

[v7u_N004026|4026] This is due to the inadequacy of the system the bank purchased from a vendor.
ZH: 低验证率源于银行从供应商处购买的系统不完善

[v7u_N004027|4027] The system does not incorporate strong liveness checks and is not properly integrated with the document processing system that extracts ID pictures from identity books and passports.
ZH: 系统缺乏活体检测且未与证件处理系统集成

[v7u_N004028|4028] The system cannot reliably match selfies customers take during the onboarding process to ID pictures.
ZH: 系统无法可靠地将客户自拍照与证件照片匹配

[v7u_N004029|4029] This leads to a team of analysts manually checking unverified customers, increasing onboarding time.
ZH: 未验证客户需分析师手动检查，增加开户时间

[v7u_N004030|4030] Marie also identifies that during the screening process, one specific common French name keeps matching against the European sanctions list, generating false positives that analysts must address.
ZH: 常见法国名字与欧盟制裁名单匹配产生误报

[v7u_N004031|4031] After further investigation, she notes that the system uses partial match logic to identify possible hits and does not allow deviations in names.
ZH: 系统使用部分匹配逻辑且不允许姓名偏差

[v7u_N004032|4032] The system keeps matching “Henri” against “Henrik,” which is indicated on the list.
ZH: 误报示例：'Henri'与名单上的'Henrik'匹配

[v7u_N004033|4033] Similarly, the system seems to be missing matches when the name is slightly different from its appearance on watch lists.
ZH: 系统在姓名与观察名单略有差异时遗漏匹配
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "系统无法可靠匹配自拍照与证件照片导致分析师手动检查未验证客户",
      "decision": "p7c_card",
      "card_id": "p7card_CH53-S02_001",
      "reason": "基础KG仅能列出缺陷与后果事实，无法表达前者导致后者的有向因果关系，该程序性链路超出基础KG表达范围。"
    },
    {
      ...
      "proposition": "姓名筛查产生误报导致分析师必须处理误报",
      "decision": "p7c_card",
      "card_id": "p7card_CH53-S02_002",
      "reason": "基础KG可将误报列为风险指标，但未表达分析师必须处理的应对义务，该有向应对链条为P7C增量。"
    },
    {
      ...
      "proposition": "Marie评估电子KYC流程发现面部识别缺陷、姓名筛查误报和漏报",
      "decision": "p7c_card",
      "card_id": "p7card_CH53-S02_003",
      "reason": "基础KG可分别列出各缺陷事实，但无法表达它们是由具体评估动作产出的结论，该评估-产出结构为增量。"
    },
    {
      ...
      "proposition": "案例背景：OneFrance银行雇佣Marie审查入职技术",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯背景介绍，无程序性有向结构，基础KG可承接。"
    },
    {
      ...
      "proposition": "OneFrance入职流程包括客户自拍提交、地理位置记录和制裁名单筛查",
      "decision": "kg_only",
      "card_id": null,
      "reason": "均为过程步骤描述，无触发、分支或独立结果，基础KG可表达为一般程序事实。"
    },
    {
      ...
      "proposition": "面部识别系统不完善的原因：缺乏活体检测，未与证件处理系统集成",
      "decision": "kg_only",
      "card_id": null,
      "reason": "原因解释，无有向应对结构，基础KG可表达为事实与关联。"
    },
    {
      ...
      "proposition": "系统使用部分匹配逻辑且不允许姓名偏差，导致'Henri'与'Henrik'匹配产生误报",
      "decision": "kg_only",
      "card_id": null,
      "reason": "误报机制解释，无独立应对动作，基础KG可表达为风险指标与原因。"
    }
  ],
  "cards": [
    {
      ...
      "title": "系统无法可靠匹配导致分析师手动检查未验证客户",
      "flow_nodes": [
        {
          "node_id": "N001",
          "node_category": "entry",
          "node_type": "E3_state_threshold",
          "label": "OneFrance系统无法可靠匹配客户自拍照与证件照片",
          "evidence_unit_ids": [
            "v7u_N004028"
          ],
      ...
      "flow_edges": [
        {
          ...
          "source_quote": "The system cannot reliably match selfies ... This leads to a team of analysts manually checking unverified customers..."
        }
      ],
      "source_unit_ids": [
        "v7u_N004028",
      ...
      "review_notes": "增量命题：系统无法可靠匹配自拍照与证件照片 --PRECEDES--> 分析师手动检查未验证客户；KG不足：基础KG可能列出这些事实，但未表达前者导致后者的有向因果关系；选项判断：可帮助确认手动检查是由系统匹配失败触发的应对措施；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH53-S02_002",
      "section_id": "CH53-S02",
      "card_nature": "execution",
      "title": "姓名筛查误报导致分析师必须处理误报",
      "flow_nodes": [
        {
          "node_id": "N003",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "姓名筛查产生误报（常见法国名字与制裁名单匹配）",
          "evidence_unit_ids": [
            "v7u_N004030"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "source_quote": "one specific common French name keeps matching ... generating false positives that analysts must address"
        }
      ],
      "source_unit_ids": [
        "v7u_N004030"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：姓名筛查误报 --PRECEDES--> 分析师必须处理误报；KG不足：基础KG可能将误报作为风险指标，但未表达分析师必须处理的应对义务；选项判断：可确认分析师是处理误报的主体，且处理是必须的；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH53-S02_003",
      "section_id": "CH53-S02",
      "card_nature": "assessment",
      "title": "Marie评估OneFrance电子KYC流程发现多项缺陷",
      "flow_nodes": [
        {
          "node_id": "N005",
          "node_category": "process",
          "node_type": "P1_assessment",
          "label": "Marie评估OneFrance的电子KYC流程",
          "evidence_unit_ids": [
            "v7u_N004021"
          ],
          "evidence_strength": "explicit"
        },
        {
          ...
          "label": "发现面部识别仅验证80%客户且系统无法可靠匹配自拍照与证件照片",
          "evidence_unit_ids": [
            "v7u_N004025",
            "v7u_N004028"
          ],
        ...
        },
        {
          ...
          "node_category": "exit",
          "node_type": "X1_classification",
          "label": "发现姓名筛查中常见法国名字持续产生误报且分析师必须处理",
          "evidence_unit_ids": [
            "v7u_N004030"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "source_quote": "She assesses ... notices various deficiencies ... currently the system only verifies 80% ... The system cannot reliably match..."
        },
        {
          "edge_id": "E004",
          "edge_type": "PRODUCES",
          ...
          "derivation": "explicit_text",
          "source_quote": "Marie also identifies that ... generating false positives..."
        },
        {
          "edge_id": "E005",
          "edge_type": "PRODUCES",
          ...
          "derivation": "explicit_text",
          "source_quote": "Similarly, the system seems to be missing matches..."
        }
      ],
      "source_unit_ids": [
        "v7u_N004021",
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：Marie评估电子KYC流程 --PRODUCES--> 发现三项具体缺陷；KG不足：基础KG可以分别列出这些缺陷事实，但无法表达它们是Marie评估产出的结论，也无法体现评估过程产生发现的局部有向关系；选项判断：可确认顾问审查的结果，以及识别出的具体问题；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
