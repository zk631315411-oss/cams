...
[
  {
    ...
    "proposition": "监管要求审查所有权结构时必须识别客户的最终受益所有人（UBO）。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "识别客户的UBO",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "proposition": "机构应采用风险为本方法设定受益所有权阈值；对于高风险客户阈值可低至10%，更高风险客户可低至5%。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "设定阈值",
      "outcomes_or_paths": [
        "普通客户按默认阈值",
        "高风险客户阈值10%",
        "更高风险客户阈值5%"
  ...
  },
  {
    ...
    "proposition": "根据25%的受益所有权阈值，综合直接和间接持股，达到阈值者认定为UBO，未达到者不认定为UBO。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "计算总持股比例并与阈值比较",
      "outcomes_or_paths": [
        "达到或超过阈值：认定为UBO",
        "低于阈值：不认定为UBO"
      ]
