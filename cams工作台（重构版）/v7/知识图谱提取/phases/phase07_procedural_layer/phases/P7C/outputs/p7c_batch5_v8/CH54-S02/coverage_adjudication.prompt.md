...
section_title: `Technology for KYC > Electronic KYC`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "电子了解你的客户定义",
      "title_en": "Electronic KYC Definition",
      "covered_units": [
        {
          "unit_id": "v7u_N004049",
    ...
    {
      "title_zh": "电子了解你的客户所用技术",
      "title_en": "Technologies Used in Electronic KYC",
      "covered_units": [
        {
          "unit_id": "v7u_N004051",
          "unit_type": "fact",
    ...
    {
      "title_zh": "电子了解你的客户的优势",
      "title_en": "Benefits of Electronic KYC",
      "covered_units": [
        {
          "unit_id": "v7u_N004052",
          "unit_type": "fact",
    ...
    {
      "title_zh": "国家身份数据库与电子了解你的客户及蜜罐风险",
      "title_en": "National Identity Databases for eKYC and Honeypot Risk",
      "covered_units": [
        {
          "unit_id": "v7u_N004058",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "电子了解你的客户定义",
      "target_title": "电子了解你的客户所用技术",
      "relation_type": "prepares"
    },
    {
      "source_title": "电子了解你的客户定义",
      "target_title": "电子了解你的客户的优势",
      "relation_type": "prepares"
    },
    {
      "source_title": "电子了解你的客户所用技术",
      "target_title": "电子了解你的客户的优势",
      "relation_type": "prepares"
    },
    {
      "source_title": "电子了解你的客户所用技术",
      "target_title": "国家身份数据库与电子了解你的客户及蜜罐风险",
      "relation_type": "prepares"
    },
    {
      "source_title": "国家身份数据库与电子了解你的客户及蜜罐风险",
      "target_title": "电子了解你的客户定义",
...
```text
[v7u_N004048|4048] As the world evolves and adopts more technology-driven solutions, financial institutions need to adjust their ways of working, including onboarding new customers.
ZH: 随着世界采用更多技术驱动方案，金融机构需要调整工作方式，包括客户开户。

[v7u_N004049|4049] Electronic KYC plays a key role in fulfilling that need, by allowing a digital process for verifying the identity of customers and meeting KYC requirements electronically.
ZH: 电子了解你的客户通过数字流程验证客户身份，满足了解你的客户要求。

[v7u_N004050|4050] It replaces traditional paper-based methods with digital verification, enabling organizations to remotely confirm an individual’s identity.
ZH: 电子了解你的客户取代传统纸质方法，实现远程身份确认。

[v7u_N004051|4051] Technologies such as geolocation verification tools, smart device intelligence that can detect anomalies on one device, AI, and machine learning have enabled the creation of fast and secure electronic KYC processes. Behavioral and profile monitoring and open-source intelligence have helped advance electronic KYC by allowing financial institutions to implement perpetual KYC processes.
ZH: 地理定位、智能设备异常检测、AI和机器学习等技术实现了快速安全的电子了解你的客户和持续了解你的客户。

[v7u_N004052|4052] Electronic KYC can significantly improve the detection and mitigation of financial crime risk and ensure compliance with regulatory requirements.
ZH: 电子了解你的客户可显著改善金融犯罪风险检测与缓解，确保合规。

[v7u_N004053|4053] It provides faster and more streamlined customer onboarding by completing the processes within hours or even minutes compared with weeks for traditional manual processes.
ZH: 电子了解你的客户可在数小时或数分钟内完成客户开户，而传统手动流程需要数周。

[v7u_N004054|4054] Electronic KYC increases the efficiency of teams and lowers costs by reducing the need for manual intervention involving hard copy documentation, allowing teams to focus on higher-risk customers and areas.
ZH: 电子了解你的客户提高团队效率、降低成本，使团队能专注于高风险客户。

[v7u_N004055|4055] It minimizes human errors that might occur within the onboarding process and ensures that customers’ information is up to date.
ZH: 电子了解你的客户减少开户过程中的人为错误，确保客户信息最新。

[v7u_N004056|4056] Digital records provide clear audit trails, making it easier to demonstrate compliance during regulatory inspections.
ZH: 数字记录提供清晰的审计轨迹，便于在监管检查中证明合规。

[v7u_N004057|4057] Electronic KYC also enhances security with verification methods such as biometrics, which helps prevent and detect illicit activities such as identity fraud.
ZH: 电子了解你的客户通过生物识别等验证方法增强安全性，有助于预防和检测身份欺诈。

[v7u_N004058|4058] Many countries such as India, Singapore, and Hong Kong have streamlined eKYC processes even more by implementing national identity databases.
ZH: 印度、新加坡、香港等许多国家/地区通过实施国家身份数据库简化了e了解你的客户流程。

[v7u_N004059|4059] Governments use these centralized systems to store and manage the personally identifiable information (PII) of their citizens.
ZH: 政府使用集中式系统存储和管理公民的个人身份信息（PII）。

[v7u_N004060|4060] These databases typically include data such as names, addresses, dates of birth, biometric information, and unique identification numbers.
ZH: 国家身份数据库通常包含姓名、地址、出生日期、生物识别信息和唯一识别号。

[v7u_N004061|4061] Financial institutions are linked to these databases, ensuring a smoother and more secure onboarding process.
ZH: 金融机构连接数据库以实现更顺畅安全的客户准入

[v7u_N004062|4062] One issue with national identity databases is that they can create “honeypot” problems for governments. Centralized databases that curate valuable information are regular targets for cyberattacks.
ZH: 集中式国民身份数据库存在蜜罐问题和网络攻击风险
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "在技术驱动环境下，金融机构需要调整工作方式（包括客户开户）。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性适应需求陈述，无特定主体动作、条件或判断结构，基础KG可表达为事实。"
    },
    {
      ...
      "proposition": "电子KYC通过数字流程验证客户身份，取代传统纸质方法实现远程确认。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯定义与功能说明，无程序性有向关系，基础KG已覆盖。"
    },
    {
      ...
      "proposition": "地理定位、AI等技术支持创建快速安全的电子KYC和持续KYC流程。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "技术使能的事实描述，无明确机构动作、条件分支或独立结果，基础KG可表达为一般知识。"
    },
    {
      ...
      "proposition": "电子KYC可改善风险检测、加快开户速度、提高团队效率并降低成本。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "优势与效果列表，无具体主体判断或应对步骤，基础KG可完全表达。"
    },
    {
      ...
      "proposition": "电子KYC减少人为错误、提供审计轨迹、通过生物识别增强安全性。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "更多优势与功能说明，无程序性结构，基础KG足以承接。"
    },
    {
      ...
      "proposition": "许多国家通过国家身份数据库简化eKYC，金融机构连接数据库以实现顺畅安全准入。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "事实描述，虽涉及连接与效果，但无明确机构判断、条件分支或步骤，基础KG可表达为一般知识关系。"
    },
    {
      ...
      "proposition": "集中式国民身份数据库存在蜜罐问题和网络攻击风险。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "孤立风险指标，无有向判断或应对结构，基础KG可表达。"
    }
  ],
  "cards": [],
  "skip_reason": "当前section内容均为电子KYC的定义、技术、优势、国家身份数据库应用及蜜罐风险等事实性描述和一般知识关系，基础KG已能充分表达。经完整扫描，未发现由明确主体动作、条件分支、职责交接或独立结果构成的可用于题目选项判断的局部程序性或判断性有向结构，因此无P7C增量卡片。"
}
```
