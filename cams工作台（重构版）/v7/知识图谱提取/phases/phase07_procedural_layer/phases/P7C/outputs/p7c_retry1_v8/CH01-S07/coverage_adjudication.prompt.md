...
section_title: `Money Laundering and Financial Crime > • Trade-based money laundering (TBML):`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "贸易洗钱（TBML）方法",
      "title_en": "Trade-based money laundering (TBML) methods",
      "covered_units": [
        {
          "unit_id": "v7u_N000039",
    ...
    {
      "title_zh": "市场洗钱（MBML）方法",
      "title_en": "Market-based money laundering (MBML) methods",
      "covered_units": [
        {
          "unit_id": "v7u_N000042",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "贸易洗钱（TBML）方法",
      "target_title": "市场洗钱（MBML）方法",
...
```text
[v7u_N000039|39] Methods include over-invoicing, under-invoicing, multiple invoicing, and phantom shipments to obscure the source of funds.
ZH: 贸易洗钱方法包括高/低开发票、多重发票和虚假货运

[v7u_N000040|40] Criminals manipulate trade invoices, customs declarations, and pricing mechanisms to move illicit funds.
ZH: 犯罪分子操纵贸易发票、海关申报和定价机制转移非法资金

[v7u_N000041|41] Market-based money laundering (MBML):
ZH: 基于市场的洗钱（MB洗钱）作为洗钱类型之一

[v7u_N000042|42] Financial instruments create complex transaction chains that mask fund origins.
ZH: 金融工具通过复杂交易链掩盖资金起源

[v7u_N000043|43] Criminals exploit stocks, bonds, hedge funds, derivatives, and private equity investments to layer illicit funds.
ZH: 犯罪分子利用股票、债券、对冲基金等投资工具分层非法资金
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "贸易洗钱（TBML）方法包括高/低开发票、多重发票、虚假货运，以及犯罪分子操纵贸易发票、海关申报和定价机制转移非法资金。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述洗钱方法和犯罪机制，无特定主体（如金融机构）的识别、评估、决策或应对步骤，属于基础KG可充分表达的一般事实和解释。"
    },
    {
      ...
      "proposition": "基于市场的洗钱（MBML）通过金融工具创建复杂交易链掩盖资金起源，犯罪分子利用股票、债券、对冲基金等工具分层非法资金。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "描述MBML方法及犯罪分子利用金融工具的方式，仅为一般机制和事实陈述，无机构主体、条件判断或程序性应对，基础KG已能表达。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达当前section中贸易洗钱和基于市场洗钱的定义、方法及一般犯罪机制，不存在涉及特定主体识别、评估、决策或应对的局部程序性或判断性有向结构。"
}
```
