...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "警报调查的内部信息来源",
      "title_en": "Internal information sources for alert investigation",
      "covered_units": [
        {
          "unit_id": "v7u_N003335",
    ...
    {
      "title_zh": "警报调查的外部信息来源",
      "title_en": "External information sources for alert investigation",
      "covered_units": [
        {
          "unit_id": "v7u_N003340",
          "unit_type": "classification",
    ...
    {
      "title_zh": "信息请求（RFI）流程",
      "title_en": "Request for Information (RFI) process",
      "covered_units": [
        {
          "unit_id": "v7u_N003345",
          "unit_type": "risk_indicator",
    ...
    {
      "title_zh": "警报全面审查与文档记录",
      "title_en": "Holistic alert review and documentation",
      "covered_units": [
        {
          "unit_id": "v7u_N003346",
          "unit_type": "process",
  ...
  "covered_relations": [
    {
      "source_title": "警报调查的内部信息来源",
      "target_title": "警报调查的外部信息来源",
      "relation_type": "parallels"
    },
    {
      "source_title": "警报调查的内部信息来源",
      "target_title": "信息请求（RFI）流程",
      "relation_type": "prepares"
    },
    {
      "source_title": "警报调查的外部信息来源",
      "target_title": "信息请求（RFI）流程",
      "relation_type": "prepares"
    },
    {
      "source_title": "信息请求（RFI）流程",
      "target_title": "警报全面审查与文档记录",
      "relation_type": "prepares"
    }
  ]
}
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "负责审查警报的员工应使用内外部信息做出决策",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般性义务陈述，无特定条件、独立结果或分支，基础KG可保存此规则。"
    },
    {
      ...
      "proposition": "分析师全面审查内外部信息源以决定下一步行动",
      "decision": "kg_only",
      "card_id": null,
      "reason": "一般流程步骤描述，无触发条件或独立出口，基础KG可表示此过程。"
    },
    {
      ...
      "proposition": "记录警报调查时，应记录搜索、信息和关键数据点以支持驳回或升级的决策",
      "decision": "kg_only",
      "card_id": null,
      "reason": "文档记录要求，属于一般规则，基础KG可表达，无额外增量有向结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达当前section的定义、分类、信息源列表和一般流程步骤，未发现证据支持的局部增量程序性或判断性有向结构。"
}
```
