...
section_title: `Money Laundering and Financial Crime > • Commodity-based money laundering:`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "商品洗钱",
      "title_en": "Commodity-based money laundering",
      "covered_units": [
        {
          "unit_id": "v7u_N000044",
          "unit_type": "fact",
...
```text
[v7u_N000044|44] These assets are bought with illicit funds, resold, or smuggled to avoid scrutiny.
ZH: 商品洗钱：购买资产后转售或走私以规避审查

[v7u_N000045|45] Criminals use high-value commodities such as gold, diamonds, luxury watches, and fine art to transfer value anonymously.
ZH: 犯罪分子使用黄金、钻石、奢侈品等高价商品匿名转移价值
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "犯罪分子用非法资金购买资产，然后转售或走私以规避审查。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该单元仅描述犯罪分子的洗钱手法，属于一般事实描述，不涉及机构主体、识别、评估、决策或应对等程序性或判断性有向结构，基础KG已能充分表达。"
    },
    {
      ...
      "proposition": "犯罪分子使用高价商品（黄金、钻石、奢侈品等）匿名转移价值。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该单元仅提供商品洗钱的典型例子，属于一般事实描述，没有超出基础KG表达能力的程序性或判断性结构。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达该节所有内容，当前section不存在证据支持的增量程序性或判断性有向结构。"
}
```
