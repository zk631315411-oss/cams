...
上述教材内容只能提供私人银行受益所有权风险的背景，不能单独证明选项A的具体措辞；本题的答案判断依赖题干所指2012年《私人银行原则》官方文件。

沃尔夫斯堡集团官网将本题所指文件标为2012年版本。该版前言说明，原则最初形成于2000年、2002年修订，2012年文件是一次进一步修订，并非首次发布。其第1.2.3节直接规定：出于反洗钱目的，所有账户都必须确定受益所有权；每名受益所有人的身份均应被确定，并在适当情况下予以验证。选项A所称受益所有权透明度，是对上述识别与验证要求的实质概括，因此四个选项中A最符合原始文件。需注意，A不是官方条文的逐字引述，不能把选项文字加引号当作原文。
...
本题要区分「文件版本」和「首次发布年份」：私人银行原则最初形成于2000年、2002年修订，题干所称2012年指进一步修订版。还要区分「原文」与「概括」：官方原文是所有账户必须确定受益所有权，A所说的受益所有权透明度是对该要求的实质概括，不是逐字引文。
