...
| `review_check.py` | 复核检测，输出 `review_check_report.md` 和 `review_check_summary.json` |
...
解析母版 (questions/q_*.json + explanations/*.md)
...
正式内容位于 `../output/questions/`、`../output/explanations/` 和 `../output/software_export/sections/`。旧 `explanations_export/` 不是当前解析母版。
