...
[
  {
    ...
    "proposition": "审查所有权结构时，监管要求必须识别客户最终受益所有人（UBO）。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "识别客户 UBO",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
  ...
  },
  {
    ...
    "proposition": "识别 UBO 需合计直接和间接持股，达到 25% 或以上阈值则认定为 UBO，未达到则不认定为 UBO。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "合计直接和间接持股，根据阈值判断是否认定为 UBO",
      "outcomes_or_paths": [
        "达到阈值：认定为 UBO",
        "未达到阈值：不认定为 UBO"
      ]
  ...
  },
  {
    ...
    "proposition": "机构采用风险为本方法设定受益所有权阈值；对于高风险客户，阈值可能低至10%甚至5%。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "机构设定受益所有权阈值",
      "outcomes_or_paths": [
        "一般阈值",
        "高风险客户阈值可能低至10%或5%"
      ]
  ...
  },
  {
    ...
    "proposition": "当不存在自然人受益所有人时，应识别并核实控制人或名义受益所有人，例如上市公司可将总裁或CEO作为名义受益所有人。",
    "source_quotes": [
