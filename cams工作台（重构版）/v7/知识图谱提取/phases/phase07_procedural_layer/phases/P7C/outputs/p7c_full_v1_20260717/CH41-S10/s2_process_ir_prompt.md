...
section_title: `Governance and oversight > 6. Investigations and regulatory reporting:`

section_text_with_unit_anchors:

```text
[v7u_N003002|3002] Escalation and case management: Depending on the organization’s procedures, the case may need to be escalated to the second line.
ZH: 根据组织程序，可疑案件可能需要上报至第二道防线

[v7u_N003003|3003] SAR filing: Report suspicious activities to the appropriate FIU.
ZH: 向金融情报机构提交可疑活动报告
```
...
[
  {
    ...
    "proposition": "根据组织程序，可疑案件可能需要上报至第二道防线。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "上报至第二道防线",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003002",
        "quote": "Escalation and case management: Depending on the organization’s procedures, the case may need to be escalated to the second line."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "向FIU提交可疑活动报告",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N003003",
        "quote": "SAR filing: Report suspicious activities to the appropriate FIU."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
