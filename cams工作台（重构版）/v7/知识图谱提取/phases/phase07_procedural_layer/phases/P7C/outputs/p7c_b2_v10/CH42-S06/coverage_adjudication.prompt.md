...
section_title: `Onboarding AFC controls > Customer risk assessment`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "客户风险评估定义和关键风险要素",
      "title_en": "Customer Risk Assessment (CRA) definition and key risk elements",
      "covered_units": [
        {
          "unit_id": "v7u_N003040",
...
```text
[v7u_N003040|3040] A customer risk assessment (CRA) is a compliance process that determines the financial crime risk posed by a customer. A CRA evaluates multiple risk factors to determine the appropriate level of monitoring and scrutiny required for each customer.
ZH: 客户风险评估是确定客户金融犯罪风险并决定监控级别的合规流程

[v7u_N003041|3041] Key risk elements include:
ZH: 客户风险评估的关键风险要素列表

[v7u_N003042|3042] Customer profile: Include natural person or legal person, ownership structure, nature of business, industry, and presence of PEPs.
ZH: 客户画像包括自然人或法人、所有权结构、业务性质、行业及是否存在政治敏感人物

[v7u_N003043|3043] Jurisdiction: Consider whether a customer is from or conducts business in high-risk jurisdictions, as identified in FATF grey and black lists or the lists from OFAC, the EU, and local regulators.
ZH: 司法管辖区风险：考虑客户是否来自或经营于FATF灰黑名单、OFAC、欧盟及当地监管机构所列的高风险司法管辖区

[v7u_N003044|3044] Product: Consider how the products or services the customer uses could be misused for financial crime. Examples include correspondent banking, private wealth management, cryptocurrency, and trade finance.
ZH: 产品风险：考虑客户使用的产品或服务可能被滥用于金融犯罪，如代理行、私人财富管理、加密货币和贸易融资

[v7u_N003045|3045] Delivery channel: Consider whether the customer is onboarded in person or online. Transactions conducted without face-to-face interaction tend to be higher risk.
ZH: 交付渠道风险：考虑客户是面对面还是在线开户，非面对面交易风险更高

[v7u_N003046|3046] Transactional behavior: Identify deviations from expected transaction patterns, unexplained high-volume cross-border transactions, or the use of complex payment structures.
ZH: 交易行为风险：识别偏离预期交易模式、异常大额跨境交易或复杂支付结构

[v7u_N003047|3047] Customer profile
ZH: 客户画像标签

[v7u_N003048|3048] Evaluating risks posed by customers
ZH: 评估客户风险标签

[v7u_N003049|3049] Jurisdiction
ZH: 司法管辖区标签

[v7u_N003050|3050] Products
ZH: 产品标签

[v7u_N003051|3051] Channels
ZH: 渠道标签

[v7u_N003052|3052] Transactional behavior
ZH: 交易行为标签

[v7u_N003053|3053] By implementing a robust CRA framework, financial institutions enhance financial crime detection, regulatory compliance, and risk management strategies.
ZH: 实施稳健的客户风险评估框架可增强金融犯罪检测、监管合规和风险管理策略
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "CRA评估多个风险因素以确定每客户所需的适当监控和审查水平",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该命题描述了CRA过程的定义，评估与确定之间未明示独立结果，关系是内在的目的-手段，基础KG可充分表达该定义。"
    },
    {
      ...
      "proposition": "金融机构实施稳健的CRA框架，从而增强金融犯罪检测、监管合规和风险管理策略",
      "decision": "p7c_card",
      "card_id": "p7card_CH42-S06_001",
      "reason": "实施动作与增强效果构成明确的有向因果链，且为基础KG无法表达的动作-结果动态关系，符合P7C增量。"
    }
  ],
  "cards": [
    {
      ...
      "section_id": "CH42-S06",
      "card_nature": "control",
      "title": "实施客户风险评估框架产生控制效果",
      "flow_nodes": [
        {
          "node_id": "node_1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构实施稳健的CRA框架",
          "evidence_unit_ids": [
            "v7u_N003053"
          ],
      ...
      "review_notes": "增量命题：金融机构实施稳健的CRA框架 --产生--> 增强的金融犯罪检测、监管合规和风险管理策略；KG不足：基础KG只能表达“稳健的CRA框架增强检测等”作为整体事实，无法表达实施动作与结果之间的动态有向关系；选项判断：可确认或排除关于CRA实施效果的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
