...
[
  ...
  },
  {
    ...
    "proposition": "修正案修改泄密条款，以促进监管机构、执法机构和国际同行之间的信息共享。",
    "source_quotes": [
      "Amending tipping off provisions.",
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "修改泄密条款",
      "outcomes_or_paths": [
        "促进监管机构、执法机构和国际同行之间的信息共享"
      ]
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001872",
        "quote": "Amending tipping off provisions."
      },
      {
        "unit_id": "v7u_N001882",
        "quote": "Amending tipping off provisions to facilitate greater information sharing between regulatory bodies, law enforcement agencies, and international counterparts."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选 s1c_003 承接了 AUSTRAC 增强执法权，但未承接此项关于促进信息共享的泄密条款修改。"
    }
  },
  {
    ...
    "proposition": "立法要求实体在2026年3月前遵守新义务。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "要求报告实体在2026年3月前遵守新义务",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N001874",
        "quote": "Legislation requires entities to comply with the new obligations by 2026."
      },
      {
        "unit_id": "v7u_N001884",
        "quote": "Reporting entities will be required to comply with many of the new obligations by March 2026."
      }
    ],
    "induction": null,
    "cross_unit_basis": null,
    "gap_evidence": {
      ...
      "gap_reason": "已有候选 s1c_001 要求实施合规计划，s1c_002 扩展 DNFBP 义务，但两者均未承接立法设定的具体合规截止时间要求。"
    }
  }
]
```
