...
section_title: `Understanding AFC technology > Regulatory requirements for technology`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "金融犯罪防控技术的监管环境",
      "title_en": "Regulatory landscape for AFC technology",
      "covered_units": [
        {
          "unit_id": "v7u_N003891",
          "unit_type": "rule",
    ...
    {
      "title_zh": "合规方法与人工智能要求",
      "title_en": "Compliance approach and AI requirements",
      "covered_units": [
        {
          "unit_id": "v7u_N003895",
          "unit_type": "process",
    ...
    {
      "title_zh": "监管互动与跨境合规",
      "title_en": "Regulatory engagement and cross-border compliance",
      "covered_units": [
        {
          "unit_id": "v7u_N003899",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "金融犯罪防控技术的监管环境",
      "target_title": "合规方法与人工智能要求",
      "relation_type": "prepares"
    },
    {
      "source_title": "合规方法与人工智能要求",
      "target_title": "监管互动与跨境合规",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003891|3891] Financial institutions must stay up to date with AFC regulations across multiple jurisdictions to ensure compliance and manage risks effectively.
ZH: 金融机构必须及时了解多个司法辖区的金融犯罪防控法规，以确保合规并有效管理风险。

[v7u_N003892|3892] Regulators often issue guidance notes pertaining to AFC technologies, such as the bulletin from the OCC in the US (OCC 2011-12).
ZH: 监管机构发布关于金融犯罪防控技术的指导说明，例如美国OCC公告（OCC 2011-12）。

[v7u_N003893|3893] Regulations also focus on operational resilience and emerging technologies, such as the Digital Operational Resilience Act (DORA), formerly known as Regulation 2022/554, and the EU AI Act in the EU.
ZH: 法规关注运营韧性和新兴技术，如欧盟《数字运营韧性法案》（DORA）和《人工智能法案》。

[v7u_N003894|3894] Similar regulations exist in China, the UK, Singapore, and other jurisdictions, along with some US states, including California, Colorado, Utah, and New York.
ZH: 中国、英国、新加坡及美国部分州（加州、科罗拉多、犹他、纽约）存在类似法规。

[v7u_N003895|3895] A structured approach to ensuring ongoing compliance includes continuous regulatory monitoring, proactive engagement with regulators and other stakeholders, and the strategic use of technology.
ZH: 确保持续合规的结构化方法包括持续监管监测、主动与监管机构及其他利益相关方互动，以及战略性技术运用。

[v7u_N003896|3896] Organizations should understand the principles and intent behind regulations and ensure control frameworks achieve the required outcomes.
ZH: 组织应理解法规的原则和意图，确保控制框架实现预期结果。

[v7u_N003897|3897] For example, AI models should have high explainability, meaning analysts should be able to easily understand and act on the model's decisions.
ZH: 例如，AI模型应具有高可解释性，使分析师易于理解并依据模型决策采取行动。

[v7u_N003898|3898] Also, organizations should use AI responsibly and ethically, focusing on augmenting human capabilities, respecting user rights and data privacy, and prioritizing transparency and accountability in AI systems.
ZH: 组织应负责任且合乎道德地使用AI，增强人类能力，尊重用户权利和数据隐私，优先考虑透明度和问责制。

[v7u_N003899|3899] The best practice is to consult and engage with local regulators to understand their expectations and demonstrate an organization’s understanding and explainability of the technology.
ZH: 最佳实践是咨询当地监管机构，了解其期望并展示组织对技术的理解和可解释性。

[v7u_N003900|3900] Collaboration through industry associations, AFC-focused forums, and regulatory working groups is essential for staying informed about emerging trends and best practices. This helps institutions operationalize new regulations.
ZH: 通过行业协会、金融犯罪防控论坛和监管工作组进行协作，有助于了解新兴趋势和最佳实践，落实新法规。

[v7u_N003901|3901] For multinational organizations, different jurisdictions might interpret similar regulations differently across borders. A strong compliance framework navigates these differences, aligning internal policies and procedures with all regulatory requirements and creating minimum standards across the group.
ZH: 合规框架需协调跨国监管差异，制定集团最低标准
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "金融机构必须跨司法辖区更新法规以确保合规和风险管理",
      "decision": "kg_only",
      "card_id": null,
      "reason": "义务陈述，无具体独立结果或有向条件，基础KG可保存规则内容。"
    },
    {
      ...
      "proposition": "结构化方法包括持续监管监测、主动互动和战略技术运用以确保持续合规",
      "decision": "kg_only",
      "card_id": null,
      "reason": "方法的组成列表，无有向关系，基础KG可保存组成。"
    },
    {
      ...
      "proposition": "组织应理解法规原则并确保控制框架实现结果",
      "decision": "kg_only",
      "card_id": null,
      "reason": "两个并列义务，无先后或有向关系。"
    },
    {
      ...
      "proposition": "AI模型的高可解释性使得分析师能够理解并依据决策采取行动",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S10_001",
      "reason": "高可解释性作为标准约束分析师行动，形成有向关系，超出基础KG的并列事实存储。"
    },
    {
      ...
      "proposition": "组织应负责任合乎道德地使用AI，关注增强能力等",
      "decision": "kg_only",
      "card_id": null,
      "reason": "系列原则陈述，无具体程序或有向关系。"
    },
    {
      ...
      "proposition": "最佳实践是咨询当地监管以理解期望和展示可解释性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "咨询目的是理解和展示，但理解和展示非独立结果，基础KG可保存实践知识。"
    },
    {
      ...
      "proposition": "通过协会协作保持对新兴趋势的了解，并有助于落地新法规",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S10_002",
      "reason": "协作产生保持了解的状态，形成动作-结果的有向关系；落地新法规的关系较松散由KG承接。"
    },
    {
      ...
      "proposition": "强大合规框架应对监管差异，产生政策对齐和集团最低标准",
      "decision": "p7c_card",
      "card_id": "p7card_CH51-S10_003",
      "reason": "框架应对动作产生独立配置结果，形成动作-结果有向结构。"
    }
  ],
  "cards": [
    {
      ...
      "title": "AI模型高可解释性要求使分析师能够理解并采取行动",
      "flow_nodes": [
        {
          "node_id": "N1",
      ...
      "flow_edges": [
        {
          ...
          "source_quote": "AI models should have high explainability, meaning analysts should be able to easily understand and act on the model's decisions."
        }
      ],
      "source_unit_ids": [
        "v7u_N003897"
      ...
      "review_notes": "增量命题：AI模型的高可解释性（standard）→约束→分析师应能理解并行动（process）。KG不足：基础KG可分别存储“AI应高可解释性”和“分析师应理解行动”，但无法表达前者作为后者的条件/标准。选项判断：可确认或排除关于AI可解释性与分析师行动条件关系的选项。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S10_002",
      "section_id": "CH51-S10",
      "card_nature": "execution",
      "title": "通过行业协会协作保持对新兴趋势的了解",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "金融机构通过行业协会、AFC论坛和监管工作组进行协作",
          "evidence_unit_ids": [
            "v7u_N003900"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "source_quote": "Collaboration through industry associations, AFC-focused forums, and regulatory working groups is essential for staying informed about emerging trends and best practices."
        }
      ],
      "source_unit_ids": [
        "v7u_N003900"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：协作（process）产生保持了解状态（exit）。KG不足：基础KG可存储“协作对保持了解至关重要”作为事实，但无法表达动作-结果的有向关系。选项判断：可确认协作是保持了解的手段。LLM推理：无。"
    },
    {
      "card_id": "p7card_CH51-S10_003",
      "section_id": "CH51-S10",
      "card_nature": "execution",
      "title": "强大合规框架应对监管差异以对齐政策并创建集团最低标准",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "强大的合规框架应对跨国监管差异",
          "evidence_unit_ids": [
            "v7u_N003901"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "source_quote": "A strong compliance framework navigates these differences, aligning internal policies and procedures with all regulatory requirements"
        },
        {
          "edge_id": "E2",
          "edge_type": "PRODUCES",
          ...
          "derivation": "explicit_text",
          "source_quote": "creating minimum standards across the group"
        }
      ],
      "source_unit_ids": [
        "v7u_N003901"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：合规框架应对差异（process）产生内部政策对齐（exit1）和集团最低标准（exit2）。KG不足：基础KG可存储“合规框架协调差异并制定标准”作为事实，但无法表达动作-结果的有向关系。选项判断：可确认框架应对差异的具体结果。LLM推理：无。"
    }
  ],
  "skip_reason": null
}
