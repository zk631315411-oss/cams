...
section_title: `Transaction monitoring scenario calibration testing > Technology to assist investigation`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "合规监控的技术解决方案类别",
      "title_en": "Categories of Technology Solutions for Compliance Monitoring",
      "covered_units": [
        {
          "unit_id": "v7u_N004513",
          "unit_type": "fact",
    ...
    {
      "title_zh": "调查中自动化与人工监督的平衡",
      "title_en": "Balancing Automation and Human Oversight in Investigations",
      "covered_units": [
        {
          "unit_id": "v7u_N004517",
          "unit_type": "fact",
    ...
    {
      "title_zh": "结合免费与付费工具优化调查",
      "title_en": "Combining Free and Paid Tools for Optimal Investigations",
      "covered_units": [
        {
          "unit_id": "v7u_N004521",
          "unit_type": "rule",
  ...
  "covered_relations": [
    {
      "source_title": "合规监控的技术解决方案类别",
      "target_title": "调查中自动化与人工监督的平衡",
      "relation_type": "prepares"
    },
    {
      "source_title": "调查中自动化与人工监督的平衡",
      "target_title": "结合免费与付费工具优化调查",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N004512|4512] The table below summarizes different categories of technology solutions:
ZH: 表格概述不同类别的技术解决方案

[v7u_N004513|4513] Publicly available watchlists offer basic compliance checks.
ZH: 公开可用的观察名单提供基本合规检查

[v7u_N004514|4514] Paid solutions integrate screening into case management workflows with real-time risk scoring and ongoing monitoring.
ZH: 付费解决方案将筛查集成到案件管理工作流中，提供实时风险评分和持续监控

[v7u_N004515|4515] AI-driven monitoring tools, particularly those in enterprise solutions, detect behavioral anomalies in financial transactions, flagging high-risk activities for further review.
ZH: AI驱动的监控工具检测行为异常并标记高风险活动

[v7u_N004516|4516] While free tools can support investigative efforts, paid solutions provide scalability, automation, and enhanced accuracy in risk identification.
ZH: 付费解决方案相比免费工具提供可扩展性、自动化和更高的准确性

[v7u_N004517|4517] Deciding the level of automation in an investigation requires balancing machine-driven efficiency with human oversight. For example, automated transaction monitoring systems flag unusual activity, but human analysts must review and validate alerts to avoid false positives.
ZH: 调查中需平衡自动化效率与人工监督

[v7u_N004518|4518] Automation streamlines investigations by prioritizing high-risk cases, but overreliance on machine-generated outputs can overlook contextual factors that only human judgment can assess.
ZH: 自动化可优先处理高风险案件，但过度依赖可能忽略人工判断的上下文因素

[v7u_N004519|4519] Conversely, fully manual investigations are inefficient and resource intensive.
ZH: 完全人工调查效率低下且资源密集

[v7u_N004520|4520] A balanced approach, using technology to automate repetitive tasks while maintaining expert oversight for final decisions, ensures accuracy, compliance, and effective risk mitigation.
ZH: 平衡方法：用技术自动化重复任务，同时保留专家监督最终决策

[v7u_N004521|4521] By combining free and subscription-based investigative tools, financial crime teams can optimize their workflows and enhance regulatory compliance efforts.
ZH: 结合免费和订阅调查工具优化金融犯罪团队工作流程与合规
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "表格概述技术解决方案类别",
      "decision": "kg_only",
      "card_id": null,
      "reason": "纯分类和概括，无程序性有向结构。"
    },
    {
      ...
      "proposition": "公开观察名单提供基本合规检查",
      "decision": "kg_only",
      "card_id": null,
      "reason": "工具功能说明，无明确主体动作和方向。"
    },
    {
      ...
      "proposition": "付费方案集成筛查到案件管理工作流并提供实时风险评分和持续监控",
      "decision": "kg_only",
      "card_id": null,
      "reason": "产品特性描述，无主体执行动作。"
    },
    {
      ...
      "proposition": "自动监控工具标记高风险活动后，人工分析师必须审查和验证警报",
      "decision": "p7c_card",
      "card_id": "p7card_CH57-S04_001",
      "reason": "存在标记事件触发人工审查义务的明确有向程序链。"
    },
    {
      ...
      "proposition": "免费工具可支持调查但付费方案提供可扩展性等优势",
      "decision": "kg_only",
      "card_id": null,
      "reason": "比较陈述，无过程性序列。"
    },
    {
      ...
      "proposition": "自动化优先处理高风险案件但可能忽略上下文因素",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅指出潜在风险，未形成应对或判断结构。"
    },
    {
    ...
    },
    {
      ...
      "proposition": "采用平衡方法自动化重复任务并保留专家监督确保准确性、合规和风险缓解",
      "decision": "p7c_card",
      "card_id": "p7card_CH57-S04_002",
      "reason": "方法到结果的明确有向产出关系。"
    },
    {
      ...
      "proposition": "结合免费和付费工具优化工作流程并增强合规",
      "decision": "p7c_card",
      "card_id": "p7card_CH57-S04_003",
      "reason": "动作到状态改善的有向关系。"
    }
  ],
  "cards": [
    {
      ...
      "title": "自动系统标记异常活动后人工审查义务",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "AI-driven monitoring tools flag high-risk activities / automated transaction monitoring systems flag unusual activity (AI驱动监控工具标记高风险/异常活动)",
          "evidence_unit_ids": [
            "v7u_N004515",
            "v7u_N004517"
          ],
        ...
        },
        {
          ...
          "label": "Human analysts must review and validate alerts (人工分析师必须审查并验证警报)",
          "evidence_unit_ids": [
            "v7u_N004517"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "source_quote": "\"flagging high-risk activities for further review\" (v7u_N004515); \"automated transaction monitoring systems flag unusual activity, but human analysts must review and validate alerts\" (v7u_N004517)"
        }
      ],
      "source_unit_ids": [
        "v7u_N004515",
      ...
      "review_notes": "增量命题：自动系统标记高风险/异常活动 --> 人工分析师必须审查验证警报（条件：当系统标记时）；KG不足：基础KG只能表达自动系统标记和人工审查作为独立事实，无法表达标记事件触发审查义务的有向程序关系；选项判断：可确认在自动标记后存在必须人工审查的步骤，防止自动驳回；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH57-S04_002",
      "section_id": "CH57-S04",
      "card_nature": "control",
      "title": "实施平衡的自动化与人工监督以保障调查质量",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "Institution adopts balanced approach, using technology to automate repetitive tasks while maintaining expert oversight for final decisions (机构采用平衡方法，自动化重复任务并保留专家监督最终决策)",
          "evidence_unit_ids": [
            "v7u_N004520"
          ],
          "evidence_strength": "explicit"
        },
        {
          ...
          "label": "Accuracy, compliance, and effective risk mitigation are ensured (准确性、合规性和有效风险缓解得以确保)",
          "evidence_unit_ids": [
            "v7u_N004520"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：机构实施平衡自动化与人工监督的方法 --> 产生准确性、合规性及风险缓解的确保状态；KG不足：基础KG只知平衡方法重要，未表达从方法到保障状态的有向产出；选项判断：可确认实施该行为会导致所列保障效果；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH57-S04_003",
      "section_id": "CH57-S04",
      "card_nature": "execution",
      "title": "结合免费与订阅工具以优化金融犯罪调查工作流程",
      "flow_nodes": [
        {
          "node_id": "n1",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "Financial crime teams combine free and subscription-based investigative tools (金融犯罪团队结合免费和订阅调查工具)",
          "evidence_unit_ids": [
            "v7u_N004521"
          ],
          "evidence_strength": "explicit"
        },
        {
          ...
          "node_category": "exit",
          "node_type": "X3_state_change",
          "label": "Workflows are optimized and regulatory compliance efforts are enhanced (工作流程优化，合规努力增强)",
          "evidence_unit_ids": [
            "v7u_N004521"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：金融犯罪团队结合工具 --> 导致工作流程优化和合规努力增强；KG不足：基础KG只能保存结合工具的好处，不能具体表示结合动作与产出状态之间的有向关系；选项判断：可确认结合行为能带来工作流程和合规方面的改善；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
