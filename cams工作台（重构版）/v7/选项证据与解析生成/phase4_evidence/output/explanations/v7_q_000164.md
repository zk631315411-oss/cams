...
教材将透明国际（TI）明确界定为非政府组织，并说明TI通过政策倡导、研究和循证项目推动问责及预防腐败（P172）。教材还指出，TI的腐败感知指数（CPI）能够提高认识并推动加强全球透明度的改革（P173）。这些原文表明，倡导、研究、预防项目和提高认识符合NGO参与反金融犯罪治理的工作方式。四个选项中，A、B、C分别更接近FIU、执法或检察机关以及世界银行等国际金融机构的职能，因此D是最佳答案。需要说明的是，现有v7原文针对的是反腐败、透明度和问责，并未直接写明「NGO提高公众对洗钱及其后果的认识」；对D的支持属于相关案例和制度逻辑旁证，而不是教材逐字定义。
