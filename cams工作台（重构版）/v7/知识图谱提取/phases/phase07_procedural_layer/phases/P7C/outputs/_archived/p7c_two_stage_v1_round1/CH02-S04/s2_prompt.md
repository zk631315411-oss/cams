...
<[
  {
    ...
    "proposition": "当公司面临海外销售中的贿赂和腐败指控时，可能引发根据英国反贿赂法2010的域外条款的关切。",
    "source_quotes": [
      "faced serious accusations of widespread bribery and corruption due to its overseas sales practices",
  ...
  },
  {
    ...
    "proposition": "如果一家公司具有英国关联，则英国反贿赂法2010对其适用；并且母公司需对子公司的腐败活动承担责任，无论地点。",
    "source_quotes": [
      "applies to any company with a UK connection",
  ...
  },
  {
    ...
    "proposition": "英国反贿赂法2010的域外管辖范围意味着，非英国企业的英国母公司可能因海外贿赂行为而被起诉；这强调了企业需要实施健全的合规措施。",
    "source_quotes": [
      "extraterritorial scope means that the UK parents of non-UK businesses engaging in bribery and corruption can also face prosecution",
  ...
  },
  {
    ...
    "proposition": "对ABC框架和内部控制的审查可能识别出缺陷；这些内部控制缺陷和监督不足有助于腐败活动长期未被发现。",
    "source_quotes": [
      "review that identified failures within FullTechGlobal’s ABC framework and internal controls",
  ...
  },
  {
    ...
    "proposition": "当贿赂作为上游犯罪时，非法资金会通过复杂的金融网络进行洗钱，旨在逃避监管审查和取证追踪。",
    "source_quotes": [
  ...
  },
  {
    ...
    "proposition": "如果公司被发现违反英国反贿赂法2010，将面临严厉的金融处罚、加强的监管审查和潜在的刑事责任（包括对子公司和母公司及其高管）。",
    "source_quotes": [
      "regulatory implications under the UK Bribery Act 2010 are profound",
      "faces severe financial penalties, increased scrutiny from international regulators, and potential criminal liability"
    ]
  },
  {
    ...
    "proposition": "当金融机构与全球企业客户有业务往来时，金融犯罪防控经理应当维护合规诚信并降低贿赂和腐败风险。",
    "source_quotes": [
      "AFC manager, she recognizes that her institution needs to maintain compliance integrity and mitigate bribery and corruption risks"
    ]
  }
]>
