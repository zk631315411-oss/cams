...
- **B 错误（题干对照）｜题干要素不匹配**：题干并未提及费用问题，且「减少赌博活动」在题干中是既定事实，教材未将其解释为规避费用的手段。相比之下，A项直接用教材定义的洗钱手法解释这一行为，关联更直接。
- **C 错误（题干对照）｜证据不足**：选项要求推断客户有「测试」的主观意图，这超出了题干事实能支撑的范围。教材从未将频繁存取现金、少赌博的行为定性为支付系统测试手段，A项更吻合教材对博彩业洗钱风险的定义。
