...
考点：TCSP 反洗钱风险控制：受益所有权识别、跨境保障与名义服务记录保存

核心解析：教材指出，TCSP 常提供名义服务（如代名董事/股东），并与离岸公司结构相结合，易被用于掩盖最终受益所有人身份和资金来源（P126-P127）。因此，应对洗钱风险需实施三项措施：①识别法律实体的真实目的、管理人员和最终受益所有人，这符合识别受益所有人的客户尽职调查义务（P76、P245）；②当客户指令通过另一司法管辖区的 TCSP 下达时，考虑额外保障措施，因为离岸地区可能 AML 监管薄弱、公开记录有限（P127）；③建立程序记录 TCSP 作为客户注册代表（如名义董事/秘书）的依据并保存参与记录，以防范名义结构被滥用而隐藏受益所有人，避免因缺乏公司记录尽职调查导致洗钱（P126-P127）。三者直接对准 TCSP 特有的风险领域。
...
A项错误：双重控制和质量保证属于机构内部操作层面的控制机制（P249），并非直接针对 TCSP 行业特有的名义服务和离岸结构风险。相比之下，B、D、E 更直接匹配教材描述的 TCSP 风险领域。
C项错误：向 FIU 报告可疑交易是 DNFBP 的义务（P148-149），但要求客户自行完成并提交 AML 风险自我评估表并非教材规定的 TCSP 措施，题干未支持该做法与应对洗钱风险的直接关联。
F项错误：对客户进行现场评估审查其内部控制，更像是金融机构对高风险客户采取的强化措施（P313），而非 TCSP 作为 DNFBP 自身应对洗钱风险的核心方式。相比记录自身名义服务依据和进行客户尽职调查，此做法与教材所描述的 TCSP 角色匹配度较低。
