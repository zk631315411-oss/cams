...
[
  ...
  },
  {
    ...
    "proposition": "Sophie作为AFC经理，认识到其机构需在与全球企业的业务中维护合规完整性，并降低贿赂和腐败风险。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "Sophie为AFC经理，在处理涉及FullTechGlobal等全球业务时"
      ],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "认识到机构需要维护合规完整性并降低贿赂和腐败风险",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
    ...
    "gap_evidence": {
      ...
      "gap_reason": "已有候选仅聚焦于法律后果和调查发现，未承接Sophie作为AFC经理认识到机构需要采取合规行动这一独立判断与应对意识。"
    }
  }
]
```
