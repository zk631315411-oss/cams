...
section_title: `Transaction Monitoring and Investigation > Case example: AML control failures at a UK Bank`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "NatWest反洗钱控制失败：FCA因交易监控不足罚款案例",
      "title_en": "NatWest AML control failures: FCA fine for inadequate transaction monitoring",
      "covered_units": [
        {
          "unit_id": "v7u_N003221",
          "unit_type": "case",
...
```text
[v7u_N003221|3221] In 2021, the UK’s Financial Conduct Authority (FCA) fined National Westminster Bank (NatWest) nearly £264.8 million for significant failures in its AML controls. The fine was issued for failing to adequately monitor the activity of Fowler Oldfield, a jewelry business involved in buying and selling gold.
ZH: 英国FCA因NatWest反洗钱控制严重失职对其罚款近2.648亿英镑。

[v7u_N003222|3222] Fowler Oldfield became a NatWest customer in 2011 when it was a small, family-owned company. When NatWest took on Fowler Oldfield as a customer, the bank initially thought it would not handle cash from the business.
ZH: Fowler Oldfield成为NatWest客户时预计不处理现金。

[v7u_N003223|3223] However, between November 2012 and June 2016, Fowler Oldfield deposited approximately £365 million with the bank, including £264 million in cash. In 2013, the customer began making large cash deposits, continuing this practice for the duration of the relationship.
ZH: Fowler Oldfield存入约3.65亿英镑，其中2.64亿为现金，与预期不符。

[v7u_N003224|3224] NatWest failed to monitor Fowler Oldfield’s activity on a risk-sensitive basis. Weaknesses in NatWest’s automated transaction monitoring included:
ZH: NatWest未基于风险敏感原则监控Fowler Oldfield活动，自动交易监控存在弱点。

[v7u_N003225|3225] The bank’s system mislabeled cash deposits as check deposits, which prevented these transactions from being monitored with more stringent cash-specific monitoring rules. The “Security Blanket” monitoring rule failed to detect suspicious activity because of mislabeling.
ZH: 系统将现金存款误标为支票存款，导致现金监控规则失效。

[v7u_N003226|3226] For most of the relationship, NatWest had no check-specific monitoring rules for high-risk customers, allowing millions of pounds in cash transactions to go unmonitored.
ZH: NatWest长期缺乏针对高风险客户的支票监控规则，大量现金交易未被监控。

[v7u_N003227|3227] At times, the bank turned off monitoring alerts because too many alerts were being generated.
ZH: 银行曾因警报过多而关闭监控警报。

[v7u_N003228|3228] Although bank staff raised and investigated several transaction monitoring alert reviews to the AML investigations team, none of the investigations prompted changes in Fowler Oldfield’s behavior and business model.
ZH: 调查未促使Fowler Oldfield改变行为或业务模式。

[v7u_N003229|3229] The investigations addressed repeated concerns that were fragmented because the teams worked across multiple offices and did not share information.
ZH: 调查因团队分散且缺乏信息共享而碎片化。

[v7u_N003230|3230] Independent assessments had previously identified concerns, including issues with customer risk ratings and risk assessments, lack of subject matter expertise within the first line of defense, and insufficient differential monitoring for high-risk customers.
ZH: 独立评估发现客户风险评级、风险评估、一线专业知识和差异化监控等控制弱点。

[v7u_N003231|3231] Although NatWest was not complicit in money laundering, the court emphasized that its failures were instrumental in facilitating illicit transactions. This case marked the FCA's first criminal prosecution for AML violations and highlighted the need for robust transaction monitoring systems and adherence to risk-sensitive ongoing monitoring protocols.
ZH: NatWest虽未共谋洗钱，但其失职助长了非法交易，此案为FCA首例反洗钱刑事起诉。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "客户实际大量现金存款行为与银行预期不符，应触发风险敏感监控调整，但银行未调整",
      "decision": "kg_only",
      "card_id": null,
      "reason": "原文仅描述客户行为变化，未明确说明该变化应触发何种程序性动作，基础KG已可保存该事实背景"
    },
    {
      ...
      "proposition": "系统误标现金为支票 → 导致现金监控规则不适用，交易未被有效监控",
      "decision": "kg_only",
      "card_id": null,
      "reason": "该因果链属于基础KG已覆盖的风险指标解释，KG可充分表达此控制弱点机制"
    },
    {
      ...
      "proposition": "缺乏针对高风险客户的支票监控规则 → 大量现金交易未被监控",
      "decision": "kg_only",
      "card_id": null,
      "reason": "与cand_002同理，为基础KG可表达的风险指标解释，无额外程序性判断结构"
    },
    {
      ...
      "proposition": "警报过多（状态/条件） → 银行主动关闭监控警报（具体决策与执行动作）",
      "decision": "p7c_card",
      "card_id": "p7card_CH46-S02_001",
      "reason": "存在明确的条件触发主体动作的有向链，且为基础KG无法充分表达的局部决策结构，可辅助判断关于监控警报处置的选项"
    },
    {
      ...
      "proposition": "员工提出并调查监测警报并上报AML调查团队 → 调查未促使行为改变",
      "decision": "kg_only",
      "card_id": null,
      "reason": "事件序列简单，无明确条件或判断分支，基础KG可保存该事实及其直接后果"
    },
    {
      ...
      "proposition": "团队分散与信息未共享 → 导致调查碎片化",
      "decision": "kg_only",
      "card_id": null,
      "reason": "为解释性因果关系，基础KG可充分描述"
    },
    {
      ...
      "proposition": "独立评估 → 发现多项控制弱点",
      "decision": "kg_only",
      "card_id": null,
      "reason": "属于一般性发现陈述，基础KG可保存"
    },
    {
      ...
      "proposition": "法院认定银行失职助长洗钱，并作出首例刑事起诉",
      "decision": "kg_only",
      "card_id": null,
      "reason": "案例法律后果，基础KG已可完整表达"
    }
  ],
  "cards": [
    {
      ...
      "title": "银行因警报过多而关闭监控警报",
      "flow_nodes": [
        {
          "node_id": "N1",
          "node_category": "entry",
          "node_type": "E3_state_threshold",
          "label": "警报过多 (too many alerts were being generated)",
          "evidence_unit_ids": [
            "v7u_N003227"
          ],
        ...
        },
        {
          ...
          "label": "银行关闭监控警报 (bank turned off monitoring alerts)",
          "evidence_unit_ids": [
            "v7u_N003227"
          ],
          "evidence_strength": "explicit"
      ...
      "flow_edges": [
        {
          ...
          "condition": "因为警报过多 (because too many alerts were being generated)",
          "source_quote": "At times, the bank turned off monitoring alerts because too many alerts were being generated."
        }
      ],
      "source_unit_ids": [
        "v7u_N003227"
      ...
      "review_notes": "增量命题：警报过多（状态）--触发--> 银行执行关闭警报动作；KG不足：基础KG只能将“银行因警报过多关闭警报”作为整体事实保存，无法表达条件阈值触发主体决策的有向结构；选项判断：可确认或排除关于监控警报关闭原因及决策主体的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
