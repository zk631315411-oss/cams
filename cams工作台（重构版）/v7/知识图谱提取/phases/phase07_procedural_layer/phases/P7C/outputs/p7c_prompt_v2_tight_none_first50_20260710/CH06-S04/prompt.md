...
```json
{
  ...
  "core_points": [
    {
      "core_point_id": "cp_CH06_S04_001",
      "title_zh": "控制银行产品金融犯罪风险的关键行动",
      "title_en": "Key actions to control financial crime risks in banking products",
      "anchor_unit_ids": [
        "v7u_N000406",
        "v7u_N000407",
        "v7u_N000408",
...
```text
[v7u_N000405|405] To understand and control financial crime risks associated with banking products, you should:
ZH: 关键要点列表引导：为理解和控制银行产品相关的金融犯罪风险应采取的行动

[v7u_N000406|406] Conduct a thorough risk assessment of your organization’s banking products and services.
ZH: 对组织的银行产品和服务进行彻底的风险评估

[v7u_N000407|407] Assess the systems and controls currently in place to determine if they are adequate for the level and type of risk your organization faces.
ZH: 评估现有系统和控制措施是否足以应对组织面临的风险水平和类型

[v7u_N000408|408] Learn from past compliance failures to ensure you avoid similar ones in the future.
ZH: 从过去的合规失败中学习，避免未来重蹈覆辙

[v7u_N000409|409] Pursue continuing training so you can stay up to date on best practices in banking compliance.
ZH: 持续接受培训以了解银行合规最佳实践的最新动态
```
