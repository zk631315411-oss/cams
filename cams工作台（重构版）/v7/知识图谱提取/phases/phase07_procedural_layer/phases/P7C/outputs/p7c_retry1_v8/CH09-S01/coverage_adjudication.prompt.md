...
section_title: `Corporate and investment banking risks > Corporate and investment banking risks`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "企业与投资银行洗钱总体脆弱性",
      "title_en": "Overall vulnerability of corporate and investment banks to money laundering",
      "covered_units": [
        {
          "unit_id": "v7u_N000661",
          "unit_type": "fact",
    ...
    {
      "title_zh": "企业贷款洗钱风险",
      "title_en": "Corporate lending money laundering risks",
      "covered_units": [
        {
          "unit_id": "v7u_N000662",
    ...
    {
      "title_zh": "并购洗钱风险与尽职调查",
      "title_en": "M&A money laundering risks and due diligence",
      "covered_units": [
        {
          "unit_id": "v7u_N000664",
    ...
    {
      "title_zh": "市场操纵与内幕交易形式",
      "title_en": "Market manipulation and insider trading forms",
      "covered_units": [
        {
          "unit_id": "v7u_N000668",
          "unit_type": "fact",
  ...
  "covered_relations": [
    {
      "source_title": "企业与投资银行洗钱总体脆弱性",
      "target_title": "企业贷款洗钱风险",
      "relation_type": "contains"
    },
    {
      "source_title": "企业与投资银行洗钱总体脆弱性",
      "target_title": "并购洗钱风险与尽职调查",
      "relation_type": "contains"
    },
    {
      "source_title": "企业与投资银行洗钱总体脆弱性",
      "target_title": "市场操纵与内幕交易形式",
      "relation_type": "contains"
    }
  ]
}
...
```text
[v7u_N000661|661] Corporate and investment banks engage in a wide range of activities that are susceptible to money laundering and other financial crimes. The volume and value of transactions, coupled with complex financial instruments and global operations, create numerous opportunities for illicit activities to go undetected.
ZH: 企业与投资银行业务因交易量大、结构复杂，易被用于洗钱等金融犯罪。

[v7u_N000662|662] Money laundering risks in corporate lending include difficulties in identifying beneficial owners due to complex corporate structures, including shell companies and several layers of ownership.
ZH: 企业贷款中，复杂所有权结构（如壳公司）使识别实际受益人困难，增加洗钱风险。

[v7u_N000663|663] Corporate lending often involves third parties such as guarantors, intermediaries, and contractors, where it might be difficult to verify the legitimacy of these parties and their involvement in the transaction.
ZH: 企业贷款涉及第三方（担保人、中介等），验证其合法性困难，增加洗钱风险。

[v7u_N000664|664] Mergers and acquisitions (M&A) involve the consolidation of companies or assets, often involving significant sums of money and complex financial arrangements.
ZH: 并购涉及公司或资产整合，通常伴随大额资金和复杂财务安排。

[v7u_N000665|665] Money laundering risks can be increased with M&A transactions where due diligence processes are inadequate over counterparties.
ZH: 并购交易中若对交易对手尽职调查不足，洗钱风险会增加。

[v7u_N000666|666] This includes being able to verify the legitimacy of the business and its financial statements, its ownership structure, and financial health.
ZH: 并购尽职调查需验证业务合法性、财务报表、所有权结构和财务健康状况。

[v7u_N000667|667] Investment banking activities and brokerage are also susceptible to various forms of market manipulation and insider trading, which can be used to disguise the movement of illicit funds. Examples include:
ZH: 投资银行与经纪业务易受市场操纵和内幕交易影响，可用于掩饰非法资金流动。

[v7u_N000668|668] Front-running: Trading securities based on advance knowledge of pending orders from customers. It allows traders to profit from market movements before the orders are executed, leading to unfair gains.
ZH: 抢先交易：基于客户待处理订单的预先信息进行交易以获利。

[v7u_N000669|669] Tailgating: Placing trades immediately after large customer orders to profit from the expected market movement.
ZH: 跟单交易：在大额客户订单后立即交易以从预期市场波动中获利。

[v7u_N000670|670] Churning: Excessive trading of a customer's account to generate commissions for the broker, resulting in increased transaction volume, making it difficult to detect illicit activities.
ZH: 频繁交易：过度交易客户账户以赚取佣金，增加交易量，掩盖非法活动。

[v7u_N000671|671] Spoofing: Placing fake orders to manipulate the market price of securities, creating the illusion of supply and demand, allowing traders to profit from the resulting price movements.
ZH: 虚假订单：下达虚假订单操纵市场价格，制造供需假象以获利。

[v7u_N000672|672] Insider trading: Based on nonpublic, material information about a company which undermines market integrity and can be used to launder illicit gains.
ZH: 内幕交易：基于非公开重大信息交易，破坏市场诚信，可用于洗钱。

[v7u_N000673|673] Here are a few higher risks associated with corporate and investment banking.
ZH: 以下是与企业与投资银行业务相关的一些较高风险。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "企业与投资银行业务因交易量大、结构复杂，整体易被用于洗钱等金融犯罪。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅描述业务脆弱性及一般因果，无特定主体动作、判断或程序性步骤，基础KG已可表达。"
    },
    {
      ...
      "proposition": "复杂所有权结构（如壳公司）导致受益所有人识别困难，从而增加洗钱风险。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "风险指标及因果说明，未涉及机构的具体识别、评估或应对动作，基础KG已可表达。"
    },
    {
      ...
      "proposition": "企业贷款涉及第三方（担保人、中介等）且验证其合法性困难，增加洗钱风险。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "风险指标及一般困难说明，无程序性有向结构，基础KG已可表达。"
    },
    {
      ...
      "proposition": "并购交易中若对交易对手尽职调查不足，洗钱风险会增加。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "条件与风险后果的因果表述，未形成具体主体执行判断或应对的局部流程，基础KG已可表达。"
    },
    {
      ...
      "proposition": "并购尽职调查要求能够验证业务合法性、财务报表、所有权结构和财务健康状况。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "仅列出尽职调查的组成要素，无明确主体动作执行及产生独立结果，不构成程序性有向结构，基础KG可表达为事实列表。"
    },
    {
      ...
      "proposition": "投资银行与经纪业务易受市场操纵和内幕交易影响，手法包括抢先交易、跟单、频繁交易、虚假订单、内幕交易。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "犯罪手法及一般市场操纵形式的描述，无机构识别、判断或应对流程，基础KG可表达为案例说明和分类知识。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达当前section的所有内容，或不存在证据支持的增量程序性或判断性有向结构。"
}
```
