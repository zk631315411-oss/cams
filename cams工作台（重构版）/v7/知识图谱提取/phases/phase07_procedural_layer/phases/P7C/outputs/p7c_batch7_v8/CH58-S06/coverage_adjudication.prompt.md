...
section_title: `Data as an input for solutions > Internal observed data`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "内部观察数据：定义、来源与合规应用",
      "title_en": "Internal Observed Data: Definition, Sources, and Compliance Use",
      "covered_units": [
        {
          "unit_id": "v7u_N004697",
...
```text
[v7u_N004697|4697] Internal observed data refers to transactional or behavioral data that an organization’s internal systems generate or capture and process.
ZH: 内部观察数据是指组织内部系统生成或捕获的交易或行为数据。

[v7u_N004698|4698] It has multiple sources, including transaction records, investigations, relationship managers, and operations staff.
ZH: 内部观察数据的来源包括交易记录、调查、客户经理和运营人员。

[v7u_N004699|4699] The data can be objective or based on opinion. It can also be based on the inability of staff to contact a customer.
ZH: 内部观察数据可以是客观的或基于意见的，也可能基于员工无法联系客户。

[v7u_N004700|4700] Observed data can take the form of transaction data, flags or checkboxes in customer service records, or narrative.
ZH: 观察数据的形式包括交易数据、标志或复选框以及叙述性描述。

[v7u_N004701|4701] Organizations should convert observed data into a data element to incorporate it into a compliance system.
ZH: 机构应将观察到的数据转换为数据元素以纳入合规系统

[v7u_N004702|4702] For example, if an investigator finds that a customer is conducting transactions in a pattern that differs from the expected behavior based on the amount, location, industry, and stated expectations, the investigator assigns a flag for required review to temporarily increase the risk rating of the customer. This triggers a review by a relationship manager.
ZH: 示例：调查员发现客户交易模式异常时标记并临时提高风险评级

[v7u_N004703|4703] An example of observed data is data resulting from an investigation.
ZH: 调查结果也是观察数据的一个例子

[v7u_N004704|4704] When an investigation finds no evidence or suspicion of financial crime, the organization might adjust the customer’s risk profile to a reduced risk rating for ongoing monitoring and screening. The organization should frequently reassess the revised rating to ensure it remains appropriate.
ZH: 调查无发现时机构可调低客户风险评级并定期重新评估

[v7u_N004705|4705] Internal observed data is typically data a regulated entity assigns or attributes to a customer or group of customers. This is in contrast to internal static data, which an organization may either collect from or assign to a customer.
ZH: 内部观察数据与内部静态数据的区别：前者是机构赋予客户的数据

[v7u_N004706|4706] Observed data is not independently verified or validated. It is time-based, which means the data is only true at the time of observation.
ZH: 观察数据的特点：未经独立验证且具有时效性

[v7u_N004707|4707] Organizations should be careful when using observed data in a compliance system due to this subjective and time-based nature.
ZH: 机构在使用观察数据时应谨慎，因其主观且有时效性

[v7u_N004708|4708] Organizations compare observed data with static data.
ZH: 机构将观察数据与静态数据进行比较

[v7u_N004709|4709] For example, a customer has an address in one country, which is static data, but the monitoring system indicates all transactions occur in a different country, which is observed data. Similarly, a retail customer claims to be a salaried employee, but ongoing account monitoring shows a transaction pattern resembling a small business.
ZH: 示例：客户地址与交易地点不符，或声称受薪但交易模式像小企业

[v7u_N004710|4710] In both examples, the customer risk rating might require adjustment.
ZH: 上述差异可能导致客户风险评级需要调整
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "机构应将观察到的数据转换为数据元素以纳入合规系统",
      "decision": "p7c_card",
      "card_id": "p7card_CH58-S06_001",
      "reason": "规则明确了主体（机构）、动作（转换数据）和目标（纳入合规系统），构成有向义务关系，超出基础KG的简单规则保存。"
    },
    {
      ...
      "proposition": "当调查员发现交易模式异常时，调查员标记并临时提高风险评级，触发关系经理复核",
      "decision": "p7c_card",
      "card_id": "p7card_CH58-S06_002",
      "reason": "案例中包含条件事件-响应动作-后续触发程序链，构成局部程序性有向结构。"
    },
    {
      ...
      "proposition": "当调查未发现金融犯罪证据时，机构可调低客户风险评级，并应定期重新评估调整后的评级",
      "decision": "p7c_card",
      "card_id": "p7card_CH58-S06_003",
      "reason": "案例中包含条件导向的动作和后续监控义务，形成有向判断与调整链。"
    },
    {
      ...
      "proposition": "机构将观察数据与静态数据进行比较",
      "decision": "p7c_card",
      "card_id": "p7card_CH58-S06_004",
      "reason": "明确了主体和具体比较动作，并关联两种数据类型，属于可帮选项判断的局部有向关系。"
    },
    {
      ...
      "proposition": "机构在使用观察数据时应谨慎，因其主观且有时效性",
      "decision": "kg_only",
      "card_id": null,
      "reason": "这是总体谨慎原则，无具体步骤或程序方向，基础KG可表达该建议。"
    },
    {
      ...
      "proposition": "通过比较发现静态数据与观察数据不一致时，客户风险评级可能需要调整",
      "decision": "kg_only",
      "card_id": null,
      "reason": "案例仅说明可能需调整，未给出具体执行路径或程序，基础KG可表达该可能性。"
    }
  ],
  "cards": [
    {
      ...
      "title": "将观察数据转换为数据元素纳入合规系统",
      "flow_nodes": [
        {
          "node_id": "P_001_convert",
          "node_category": "process",
          "node_type": "P2_execution",
          "label": "机构应将观察到的数据转换为数据元素以纳入合规系统",
          "evidence_unit_ids": [
            "v7u_N004701"
          ],
        ...
        {
          "node_id": "input_001_observed_data",
      ...
      "flow_edges": [
        {
          ...
          "source": "P_001_convert",
          "target": "input_001_observed_data",
          "evidence_unit_ids": [
            "v7u_N004701"
          ],
      ...
      "review_notes": "增量命题：机构 --应执行--> 将观察数据转换为数据元素以纳入合规系统（条件：无）；KG不足：基础KG只能保存该规则文本，无法表达转换动作与纳入系统的有向关系；选项判断：可确认机构有转换义务及目的，排除相反选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH58-S06_002",
      "section_id": "CH58-S06",
      "card_nature": "execution",
      "title": "调查发现异常交易模式触发风险评级调整与复核",
      "flow_nodes": [
        {
          "node_id": "E_002_discovery",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "调查员发现客户交易模式异常（偏离预期行为）",
          "evidence_unit_ids": [
            "v7u_N004702"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：调查员发现交易异常（事件）--PRECEDES--> 调查员标记并临时提高风险评级（处理） --PRECEDES--> 关系经理复核（后续行动）；KG不足：基础KG只能把该案例作为事实整体，无法表达内部条件-动作-触发程序；选项判断：可确认异常发现导致标记和提级，并进一步触发复核的顺序和职责；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH58-S06_003",
      "section_id": "CH58-S06",
      "card_nature": "execution",
      "title": "调查无发现时调低风险评级并定期重新评估",
      "flow_nodes": [
        {
          "node_id": "E_003_no_findings",
          "node_category": "entry",
          "node_type": "E1_event_signal",
          "label": "调查未发现金融犯罪证据或嫌疑",
          "evidence_unit_ids": [
            "v7u_N004704"
          ],
          "evidence_strength": "explicit"
        ...
        {
          "node_id": "P_003_reassess",
          "node_category": "process",
          "node_type": "P7_monitoring",
          "label": "机构应定期重新评估调整后的风险评级以确保其适当",
          "evidence_unit_ids": [
            "v7u_N004704"
          ],
          "evidence_strength": "explicit"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：调查未发现犯罪（事件/条件）--PRECEDES--> 机构调低风险评级（处理）--PRECEDES--> 机构定期重新评估调整后评级（监控）；KG不足：基础KG可表述调整规则，但无法表达条件触发、动作和后续定期监控义务的有向时序；选项判断：可确认无嫌疑调查导致风险评级降低，且后续有持续重新评估要求；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH58-S06_004",
      "section_id": "CH58-S06",
      ...
      "flow_edges": [
        {
          "edge_id": "e_004_01",
          "edge_type": "REFERENCES",
          "source": "P_004_compare",
          "target": "input_004_observed",
          "evidence_unit_ids": [
            "v7u_N004708"
          ],
          "derivation": "explicit_text"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：机构 --执行比较--> 观察数据（参照）与静态数据（参照）；KG不足：基础KG可能保存比较规则，但无法表达比较动作主动关联这两种数据源的方向性；选项判断：可确认机构主动进行这种比较，而非自动发生；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
