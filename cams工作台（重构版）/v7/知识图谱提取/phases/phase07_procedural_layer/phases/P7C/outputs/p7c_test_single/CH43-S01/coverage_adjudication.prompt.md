...
section_title: `Additional onboarding controls for high-risk scenarios`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "基于风险的准入监管要求",
      "title_en": "Regulatory requirement for risk-based onboarding",
      "covered_units": [
        {
          "unit_id": "v7u_N003099",
          "unit_type": "rule",
    ...
    {
      "title_zh": "高风险客户分类因素",
      "title_en": "High-risk customer classification factors",
      "covered_units": [
        {
          "unit_id": "v7u_N003101",
    ...
    {
      "title_zh": "高风险客户限制与控制措施",
      "title_en": "Restrictions and controls for high-risk customers",
      "covered_units": [
        {
          "unit_id": "v7u_N003106",
          "unit_type": "classification",
  ...
  "covered_relations": [
    {
      "source_title": "基于风险的准入监管要求",
      "target_title": "高风险客户分类因素",
      "relation_type": "prepares"
    },
    {
      "source_title": "高风险客户分类因素",
      "target_title": "高风险客户限制与控制措施",
      "relation_type": "prepares"
    }
  ]
}
...
```text
[v7u_N003099|3099] Regulatory frameworks such as FATF Recommendations, EU AML Directives, and FinCEN regulations require a risk-based approach to onboarding, ensuring that higher-risk customers undergo additional scrutiny before gaining full access to financial services.
ZH: FATF建议、欧盟反洗钱指令等监管框架要求对高风险客户采用基于风险的方法进行准入。

[v7u_N003100|3100] Customers might be classified as high-risk based upon:
ZH: 客户可能基于以下因素被归类为高风险。

[v7u_N003101|3101] Geographic risk: Operating in or transacting with sanctioned jurisdictions or high-risk countries identified by OFAC, EU, or other regulators
ZH: 地理风险：与受制裁司法管辖区或高风险国家交易

[v7u_N003102|3102] Industry risk: Engaging in cash-intensive or high-risk businesses such as money services, cryptocurrency exchanges, gambling, arms trading, and luxury goods
ZH: 行业风险：现金密集型或高风险行业，如货币服务、加密货币交易所、赌博、军火交易和奢侈品

[v7u_N003103|3103] PEPs: Individuals with heightened bribery and corruption exposure due to public office roles
ZH: 政治敏感人物因公职角色面临更高的贿赂和腐败风险

[v7u_N003104|3104] Complex ownership structures: Entities with offshore holdings, nominee directors, or unclear UBO
ZH: 复杂所有权结构：拥有离岸持股、名义董事或最终受益所有人不明确的实体

[v7u_N003105|3105] Adverse media: Customers linked to adverse media reports, undergoing legal proceedings, regulatory fines, or financial crime investigations
ZH: 负面媒体：客户与负面报道、法律诉讼、监管罚款或金融犯罪调查相关

[v7u_N003106|3106] Financial institutions might apply temporary or permanent restrictions. Temporary controls might be applied until EDD is completed, such as limited account functionality. Permanent controls would be applied continuously for customers that have been labeled high-risk.
ZH: 对高风险客户可采取临时或永久限制措施

[v7u_N003107|3107] Examples of these restrictions include:
ZH: 列举高风险客户限制措施的例子

[v7u_N003108|3108] An additional source of funds and wealth verification that requires detailed documentation of financial sources before transacting further.
ZH: 额外资金来源和财富验证，要求提供详细财务来源文件

[v7u_N003109|3109] Transaction and product restrictions, such as limiting high-risk products, services, and transaction volumes.
ZH: 交易和产品限制，如限制高风险产品、服务和交易量

[v7u_N003110|3110] Senior management approval, such as mandating compliance committee or board approval before account activation.
ZH: 高级管理层批准，如账户激活前需合规委员会或董事会批准

[v7u_N003111|3111] Extended review and monitoring periods to include longer compliance review timelines and heightened transaction monitoring.
ZH: 延长审查和监控期，包括更长的合规审查时间和加强交易监控

[v7u_N003112|3112] Regular audits and compliance meetings scheduled between the customer and financial institution to oversee and ensure the customer’s internal controls, systems, and reporting of compliance issues are adequate and effective.
ZH: 定期审计和合规会议，监督客户内部控制、系统和合规报告的有效性

[v7u_N003113|3113] By integrating risk-based onboarding controls, financial institutions enhance compliance, reduce regulatory exposure, and safeguard financial integrity.
ZH: 基于风险的准入控制有助于增强合规、降低监管风险并维护金融诚信
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "监管框架要求金融机构对高风险客户执行额外准入审查",
      "decision": "p7c_card",
      "card_id": "p7card_CH43-S01_001",
      "reason": "基础KG保存了规则但未表达标准约束动作的有向关系"
    },
    {
      ...
      "proposition": "根据高风险标签和EDD完成状态，金融机构分别应用临时或永久限制",
      "decision": "p7c_card",
      "card_id": "p7card_CH43-S01_002",
      "reason": "基础KG列举了措施但未表达条件化的分支应用结构"
    }
  ],
  "cards": [
    {
      ...
      "section_id": "CH43-S01",
      "card_nature": "control",
      "title": "监管框架要求的高风险客户额外审查",
      "flow_nodes": [
        {
          "node_id": "std_001",
          "node_category": "auxiliary",
          "node_type": "standard",
          "label": "监管框架（FATF建议、欧盟反洗钱指令、FinCEN法规）",
          "evidence_unit_ids": [
            "v7u_N003099"
          ],
      ...
      "review_notes": "增量命题：监管框架（标准） --约束--> 金融机构必须对高风险客户执行额外审查；KG不足：基础KG只能保存监管规则的事实，无法表达标准向具体主体动作传导的有向要求；选项判断：可确认或排除监管要求是否强制执行额外审查的选项；LLM推理：无。"
    },
    {
      "card_id": "p7card_CH43-S01_002",
      "section_id": "CH43-S01",
      "card_nature": "control",
      "title": "高风险客户的临时与永久限制措施应用",
      "flow_nodes": [
        {
          "node_id": "ent_001",
          "node_category": "entry",
      ...
      "flow_edges": [
        {
          ...
          "derivation": "explicit_text",
          "condition": "EDD未完成（Temporary controls might be applied until EDD is completed）"
        },
        {
          "edge_id": "e002_perm",
          "edge_type": "PRECEDES",
          ...
          "derivation": "explicit_text",
          "condition": "客户已被标记为高风险（Permanent controls would be applied continuously for customers that have been labeled high-risk）"
        }
      ],
      "source_unit_ids": [
        "v7u_N003106"
      ...
      "candidate_status": "candidate",
      "review_notes": "增量命题：高风险客户状态 --根据EDD完成状态--> 金融机构应用临时限制（EDD未完成）或永久限制（已标记高风险）；KG不足：基础KG列举了限制措施但未表达根据客户状态与条件选择不同限制类型的有向逻辑；选项判断：可确认或排除临时限制适用条件（如EDD完成前）以及永久限制针对高风险客户的选项；LLM推理：无。"
    }
  ],
  "skip_reason": null
}
