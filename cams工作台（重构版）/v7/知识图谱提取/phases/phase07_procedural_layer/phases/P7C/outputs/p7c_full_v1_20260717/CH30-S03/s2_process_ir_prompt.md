...
section_title: `Using reports, guidance notes, and policy papers in your AML/CFT controls > Key takeaways`

section_text_with_unit_anchors:

```text
[v7u_N002180|2180] Be proactive in reviewing red flags and indicators in reports, guidance notes, and policy papers.
ZH: 主动审查报告、指导说明和政策文件中的红旗信号信号与指标。

[v7u_N002181|2181] Review red flags against existing controls, policies, and procedures.
ZH: 对照现有控制措施、政策和程序审查红旗信号信号。

[v7u_N002182|2182] Plan and communicate implementation of change in response to reports, guidance notes, and policy papers.
ZH: 根据报告、指引和政策文件规划并沟通变革实施。
```
...
[
  {
    ...
    "proposition": "主动审查报告、指导说明和政策文件中的红旗信号与指标。",
    "source_quotes": [
    ...
    "candidate_frame": {
      "trigger_or_context": [
        "存在报告、指导说明和政策文件中的红旗信号与指标"
      ],
      "basis_or_condition": [],
      "focal_handling_or_judgment": "主动审查红旗信号与指标",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002180",
        "quote": "Be proactive in reviewing red flags and indicators in reports, guidance notes, and policy papers."
      }
    ],
    "induction": null,
  ...
  },
  {
    ...
    "proposition": "对照现有控制措施、政策和程序审查红旗信号。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "focal_handling_or_judgment": "审查红旗信号",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002181",
        "quote": "Review red flags against existing controls, policies, and procedures."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
  },
  {
    ...
    "proposition": "根据报告、指引和政策文件规划并沟通变革实施。",
    "source_quotes": [
    ...
    "candidate_frame": {
      ...
      "basis_or_condition": [],
      "focal_handling_or_judgment": "规划并沟通变革实施",
      "outcomes_or_paths": []
    },
    "evidence_spans": [
      {
        "unit_id": "v7u_N002182",
        "quote": "Plan and communicate implementation of change in response to reports, guidance notes, and policy papers."
      }
    ],
    "induction": null,
    "cross_unit_basis": null
