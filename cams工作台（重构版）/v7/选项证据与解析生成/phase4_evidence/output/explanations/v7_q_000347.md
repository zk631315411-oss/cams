...
教材指出评估反金融犯罪新技术有四个关键考量：**可扩展性、灵活架构、集成与协作**（P389）。其中，可扩展性指能适应**有机增长、并购及新产品服务引发的交易量增长**，避免频繁系统更替（P389、P432）。集成则要求确保与**遗留技术及核心银行系统兼容**，并简化工作流（P378、P390）。本题询问选择反金融犯罪工具时的优先因素，选项 D「兼容性」和 E「可扩展性」正好落入教材列出的这些核心评估维度，因此为正确答案。
