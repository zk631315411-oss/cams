...
section_title: `Cooperation involving the private sector > Key takeaways`

section_text_with_unit_anchors:

```text
[v7u_N002325|2325] Public-private partnerships can be used to:
ZH: 公私合作伙伴关系的用途列表引导句

[v7u_N002326|2326] Enable collaboration between the public and private sectors in fighting financial crime.
ZH: 公私部门合作打击金融犯罪

[v7u_N002327|2327] Support law enforcement investigations by sharing information.
ZH: 通过信息共享支持执法调查

[v7u_N002328|2328] Provide intelligence and analysis that leads to disruption of financial crime.
ZH: 提供情报和分析以打击金融犯罪
```
