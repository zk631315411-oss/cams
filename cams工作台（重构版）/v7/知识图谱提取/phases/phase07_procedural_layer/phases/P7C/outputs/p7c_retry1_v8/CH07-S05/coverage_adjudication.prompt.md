...
section_title: `Money laundering risks associated with retail and commercial banking > Credit unions and building societies risks`
...
```json
{
  ...
  "covered_topics": [
    {
      "title_zh": "信用合作社与建房互助协会的性质与风险",
      "title_en": "Nature and Risks of Credit Unions and Building Societies",
      "covered_units": [
        {
          "unit_id": "v7u_N000568",
...
```text
[v7u_N000568|568] Credit unions and building societies are financial institutions that operate on a membership basis. Unlike banks that serve customers, credit unions and building societies have members who are both the owners and customers of the institution. This member-centric structure fosters a sense of community and mutual benefit.
ZH: 信用合作社与建房互助协会是以会员为基础的金融机构，会员既是所有者也是客户。

[v7u_N000569|569] Credit unions are typically nonprofit entities whose members share a common bond such as employment, residency, or association membership.
ZH: 信用合作社通常为非营利实体，会员基于共同纽带如就业、居住地或协会成员身份。

[v7u_N000570|570] Conversely, building societies tend to serve a wider range of customers within a particular geographical region.
ZH: 建房互助协会通常服务于特定地理区域内的更广泛客户群。

[v7u_N000571|571] FATF classifies credit unions and building societies as financial institutions. This classification subjects them to similar regulatory frameworks and AFC obligations as other financial institutions.
ZH: FATF将信用合作社和建房互助协会归类为金融机构，使其承担类似的金融犯罪防控义务。

[v7u_N000572|572] Depending on their size and scope of operations, some credit unions and building societies might offer a range of financial products and services similar to those provided by retail banks. These can include savings accounts, loans, home ownership finance, and payment services. As a result, the money laundering risks they face can be comparable to those encountered by retail banks.
ZH: 部分信用合作社和建房互助协会提供与零售银行类似的产品和服务，面临相当的洗钱风险。

[v7u_N000573|573] The United Kingdom’s Joint Money Laundering Steering Group (JMLSG) states in its sectoral guidance that credit unions potentially pose lower money laundering and terrorist financing risks, because they typically have a restricted or localized customer base and offer fewer products and services, with more limitations, than larger retail banks.
ZH: 英国J洗钱SG指南指出，信用合作社因客户基础受限、产品服务有限，洗钱风险可能较低。

[v7u_N000574|574] However, the guidance notes that, while their limited functionality and flexibility make them lower risk for money laundering, these restrictions might not fully deter potential terrorist financiers.
ZH: 但指南指出，信用合作社功能有限虽降低洗钱风险，却可能无法完全阻止恐怖融资。
```
  ...
  "coverage_audit": [
    {
      ...
      "proposition": "FATF将信用合作社和建房互助协会归类为金融机构，因此它们必须遵守类似的反金融犯罪义务。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "分类-后果规则，基础KG可保存FATF分类以及金融机构必须承担AFC义务的事实，关系为直接因果，无程序性或判断性有向结构增量。"
    },
    {
      ...
      "proposition": "由于客户基础受限和产品有限，信用合作社可能具有较低洗钱/恐怖融资风险。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "风险归因陈述，基础KG可保存风险指标因素与风险水平的关系。"
    },
    {
      ...
      "proposition": "信用合作社的限制可能无法完全阻止恐怖融资者，因此风险仍可能存在。",
      "decision": "kg_only",
      "card_id": null,
      "reason": "反面的风险观点，属于孤立风险指标补充，基础KG可表达。"
    }
  ],
  "cards": [],
  "skip_reason": "基础KG已能充分表达当前section的所有定义、分类、事实和风险观点，不存在证据支持的增量程序性或判断性有向结构。"
}
```
