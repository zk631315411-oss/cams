...
section_title: `Money Laundering Risks in Financial Services > Concentration accounts`
...
```json
{
  ...
  "core_points": [
    {
      "core_point_id": "cp_CH06_S11_001",
      "title_zh": "集中账户：定义、用途和洗钱风险",
      "title_en": "Concentration Accounts: Definition, Purpose, and Money Laundering Risk",
      "anchor_unit_ids": [
        "v7u_N000498",
        "v7u_N000500"
      ],
...
```text
[v7u_N000498|498] A concentration account is a type of account used by financial institutions to aggregate funds from various sources into a central account. It is often referred to as a settlement, sweep, suspense, or collection account.
ZH: 集中账户的定义：金融机构用于归集资金的中央账户，也称结算、归集、暂记或收款账户

[v7u_N000499|499] This centralization streamlines the management of funds, enabling institutions to optimize cash flow, reduce the number of transactions, and simplify account reconciliations.
ZH: 集中账户通过资金归集优化现金流、减少交易、简化对账

[v7u_N000500|500] While concentration accounts serve legitimate purposes, they are also vulnerable to misuse by money launderers and other criminals. The main risk arises from the high volume of transactions and the pooling of funds, which can obscure the origins and destinations of money. This makes it easier for illicit funds to be mixed with legitimate funds, facilitating money laundering activities.
ZH: 集中账户因交易量大、资金混合，易被洗钱分子利用以掩盖资金来源和去向
```
